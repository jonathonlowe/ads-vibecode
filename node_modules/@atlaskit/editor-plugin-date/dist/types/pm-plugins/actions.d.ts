...
export declare const closeDatePickerWithAnalytics: ({ date, pluginInjectionApi, }: {
    ...
    pluginInjectionApi?: import("@atlaskit/editor-common/types").EditorInjectionAPI<"date", {
        ...
        }, undefined>, import("@atlaskit/editor-common/types").OptionalPlugin<import("@atlaskit/editor-common/types").NextEditorPluginFunctionOptionalConfigDefinition<"annotation", {
