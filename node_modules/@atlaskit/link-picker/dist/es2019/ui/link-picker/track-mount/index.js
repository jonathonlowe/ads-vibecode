...
export function TrackMount() {
  ...
  useLayoutEffect(() => {
    ...
    createAnalyticsEvent(createEventPayload('ui.inlineDialog.viewed.linkPicker', {})).fire(ANALYTICS_CHANNEL);
    return () => {
      // Anything in here is fired on component unmount.
      createAnalyticsEvent(createEventPayload('ui.inlineDialog.closed.linkPicker', {})).fire(ANALYTICS_CHANNEL);
    };
  }, [createAnalyticsEvent]);
  return null;
}