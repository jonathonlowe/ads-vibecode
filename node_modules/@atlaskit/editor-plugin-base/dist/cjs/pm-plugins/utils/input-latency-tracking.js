...
var InputLatencyTracker = exports.default = /*#__PURE__*/function () {
  ...
  return (0, _createClass2.default)(InputLatencyTracker, [{
    key: "start",
    value: function start() {
      ...
      if (this.samples.length + 1 === this.samplingRate) {
        ...
        (_this$onSampleStart = this.onSampleStart) === null || _this$onSampleStart === void 0 || _this$onSampleStart.call(this);
      }
      var end = function end() {
        ...
        var isSlow = false;
        var time = (0, _getTimeSince.getTimeSince)(currentStart);
        _this.push(time);
        if (time > _this.slowThreshold) {
          var _this$onSlowInput;
          (_this$onSlowInput = _this.onSlowInput) === null || _this$onSlowInput === void 0 || _this$onSlowInput.call(_this, time);
          isSlow = true;
        }
        if (_this.samples.length === _this.samplingRate) {
          var _this$onSampleEnd;
          _this.flush();
          (_this$onSampleEnd = _this.onSampleEnd) === null || _this$onSampleEnd === void 0 || _this$onSampleEnd.call(_this, time, {
            isSlow: isSlow,
    ...
    value: function dispatch() {
      ...
      (_this$dispatchSample = this.dispatchSample) === null || _this$dispatchSample === void 0 || _this$dispatchSample.call(this, this.getLast(), this.severity(this.getLast()));
      // cache
      var median = this.getMedian();
      (_this$dispatchAverage = this.dispatchAverage) === null || _this$dispatchAverage === void 0 || _this$dispatchAverage.call(this, {
        mean: this.getMean(),
        median: median,
    ...
    value: function severity(time) {
      return (0, _analytics.getAnalyticsEventSeverity)(time, this.normalThreshold, this.degradedThreshold);
    }
  }, {
    key: "getLast",
