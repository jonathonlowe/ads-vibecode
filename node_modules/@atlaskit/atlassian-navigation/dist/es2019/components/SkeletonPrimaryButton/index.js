...
const VAR_PRIMARY_BUTTON_BEFORE_HIGHLIGHTED_BACKGROUND_COLOR = '--primary-button-before-highlighted-background-color';
const VAR_PRIMARY_BUTTON_AFTER_DROPDOWN_BORDER_COLOR = '--primary-button-after-dropdown-border-color';
const primaryButtonSkeletonStyles = css({
  margin: `0 ${"var(--ds-space-075, 6px)"}`,
...
export const SkeletonPrimaryButton = ({
  ...
  const dynamicStyles = stripEmptyProperties({
    ...
    [VAR_PRIMARY_BUTTON_AFTER_DROPDOWN_BORDER_COLOR]: isHighlighted ? primaryButton.default.borderColor : primaryButton.default.color
  });
  return jsx("div", {
    role: "listitem",
