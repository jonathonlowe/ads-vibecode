...
var _default = exports.default = function _default(event, logger) {
  var sources = (0, _extractDataFromEvent.getSources)(event, _analyticsNamespacedContext.RECENT_WORK_CONTEXT);
  var source = (0, _last.default)(sources) || _analyticsGasTypes.DEFAULT_SOURCE;
  var extraAttributes = (0, _extractDataFromEvent.getExtraAttributes)(event, _analyticsNamespacedContext.RECENT_WORK_CONTEXT);
  var components = (0, _extractDataFromEvent.getComponents)(event, _analyticsNamespacedContext.RECENT_WORK_CONTEXT);
  var packages = (0, _extractDataFromEvent.getPackageInfo)(event, _analyticsNamespacedContext.RECENT_WORK_CONTEXT);
  var _ref = (0, _last.default)((0, _extractDataFromEvent.getPackageInfo)(event, _analyticsNamespacedContext.RECENT_WORK_CONTEXT)) || {},
  ...
  tags.add(_types.FabricChannel.recentWork);
  if (event.payload) {
    switch (eventType) {
