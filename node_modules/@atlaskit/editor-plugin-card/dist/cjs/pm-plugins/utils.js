...
var selectedCardAppearance = exports.selectedCardAppearance = function selectedCardAppearance(state) {
  if (state.selection instanceof _state.NodeSelection) {
    return appearanceForNodeType(state.selection.node.type);
  }
};
var titleUrlPairFromNode = exports.titleUrlPairFromNode = function titleUrlPairFromNode(node) {
 ...
 */
var mergeCardInfo = exports.mergeCardInfo = function mergeCardInfo(titleUrlPair, info) {
  return {
    title: info && info.title || titleUrlPair.title,
    url: info && info.url || titleUrlPair.url
  };
};
var displayInfoForCard = exports.displayInfoForCard = function displayInfoForCard(node, info) {
  return mergeCardInfo(titleUrlPairFromNode(node), info);
};
var findCardInfo = exports.findCardInfo = function findCardInfo(state) {
