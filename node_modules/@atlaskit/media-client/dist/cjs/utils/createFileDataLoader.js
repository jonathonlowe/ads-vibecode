...
exports.createBatchLoadingFunc = createBatchLoadingFunc;
exports.createFileDataloader = createFileDataloader;
exports.getItemsFromKeys = void 0;
...
var getItemsFromKeys = exports.getItemsFromKeys = function getItemsFromKeys(dataloaderKeys, fileItems) {
...
function createFileDataloader(mediaStore) {
  return new _dataloader.default(createBatchLoadingFunc(mediaStore), {
