...
var messages = exports.messages = (0, _reactIntlNext.defineMessages)({
  ...
  deprecatedBothParentReplacementMessage: {
    ...
    defaultMessage: '{receivedFirst} and {receivedSecond} will soon be replaced with {parentReplacement}. <link>Update to {parentReplacement}</link> to prepare for these changes.',
    description: 'Warning message for both Epic Link and Parent Link deprecation, with link to docs'
  },
  defaultWarning: {
