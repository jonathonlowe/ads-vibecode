...
var errorMessages = exports.errorMessages = (0, _reactIntlNext.defineMessages)({
  ...
  illegalEscape: {
    ...
    defaultMessage: "''{received}'' is an illegal JQL escape sequence. The valid escape sequences are \\', \\\", \\t, \\n, \\r, \\\\, '\\ ' and \\uXXXX.",
  ...
  illegalEscapeBlank: {
    ...
    defaultMessage: "The escape sequence has not been completed. The valid escape sequences are \\', \\\", \\t, \\n, \\r, \\\\, '\\ ' and \\uXXXX.",
    description: 'When there are no valid tokens following an escape character.'
  },
  illegalChar: {
