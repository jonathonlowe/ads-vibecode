...
function blobToBase64(blob) {
  return new Promise(function (resolve, reject) {
    ...
    reader.onerror = function (e) {
      return reject(new _errors.MediaSVGError('blob-to-datauri', e instanceof Error ? e : undefined));
    };
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return mediaClient.mediaStore.getFileBinary(id, collectionName).catch(function (e) {
            throw new _errors.MediaSVGError('binary-fetch', e instanceof Error ? e : undefined);
          });
        case 3:
          blob = _context2.sent;
          _context2.next = 6;
