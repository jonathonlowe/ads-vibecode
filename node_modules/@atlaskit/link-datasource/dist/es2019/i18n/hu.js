...
export default {
  ...
  'linkDataSource.issue-line-table.error-403-description': 'A tétel szerkesztéséhez megfelelő jogosultságokra van szükséged.',
  ...
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': 'Keresési találatok számának beágyazott okoslinkként való megjelenítése',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Keresd meg kulcsszó alapján a beszúrni kívánt ügyeket.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Keresd meg kulcsszó alapján a beszúrni kívánt oldalakat.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'JQL (Jira Query Language) használata az ügyek keresésére.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} ügy} other {{searchCount,number} ügy}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} ügy} other {{searchCount,number} ügy}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} tétel} other {{searchCount,number} tétel}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} találat} other {{searchCount,number} találat}}',
