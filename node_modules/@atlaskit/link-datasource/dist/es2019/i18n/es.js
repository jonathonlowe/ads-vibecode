...
export default {
  ...
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.learnMoreLink': 'Obtén más información sobre cómo realizar búsquedas con AQL.',
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchDescription': 'Empieza a escribir o utiliza AQL para buscar.',
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchTitle': 'Buscar objetos',
  'linkDataSource.assets.configmodal.insertIssuesButtonText': '{objectsCount, plural, one {Insertar objeto} other {Insertar objetos}}',
  ...
  'linkDataSource.column-picker.no-all-items-shown-message.line-2': 'Vuelve a intentarlo con palabras clave más específicas.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText': 'Conecta tu cuenta de {providerName} para colaborar en el trabajo a través de los productos de Atlassian.',
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Necesitas los permisos adecuados para editar este elemento.',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh': 'Insertar actividades de Jira desde',
  'linkDataSource.jira-issues.configmodal.placeholder.issues-issue-term-refresh': '### actividades',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': 'Mostrar el número de resultados de búsqueda como un enlace inteligente insertado',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkLabel': 'Enlace insertado',
  'linkDataSource.jira-issues.configmodal.viewModeListDescription': 'Mostrar los resultados de búsqueda en forma de lista',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Busca por palabras clave para insertar actividades.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Busca por palabras clave para insertar páginas.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Utiliza JQL (Jira Query Language) para buscar actividades.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} incidencia} other {{searchCount,number} incidencias}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} actividad} other {{searchCount,number} actividades}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} elemento} other {{searchCount,number} elementos}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} resultado} other {{searchCount,number} resultados}}',
