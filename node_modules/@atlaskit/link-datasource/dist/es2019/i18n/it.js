...
export default {
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Devi disporre delle autorizzazioni giuste per modificare questo elemento.',
  ...
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': 'Visualizza il numero di risultati della ricerca come link intelligente in linea',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Cerca per parola chiave i ticket da inserire.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Cerca mediante parole chiave le pagine da inserire.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Usa JQL (Jira Query Language) per cercare i ticket.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} ticket} other {{searchCount,number} ticket}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} ticket} other {{searchCount,number} ticket}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} elemento} other {{searchCount,number} elementi}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} risultato} other {{searchCount,number} risultati}}',
