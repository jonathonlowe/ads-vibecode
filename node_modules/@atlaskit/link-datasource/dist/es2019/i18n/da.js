...
export default {
  ...
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.learnMoreLink': 'Lær mere om søgning med AQL.',
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchDescription': 'Begynd at indtaste, eller brug AQL for at søge.',
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchTitle': 'Søg efter objekter',
  'linkDataSource.assets.configmodal.insertIssuesButtonText': '{objectsCount, plural, one {Indsæt objekt} other {Indsæt objekter}}',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText': 'Tilknyt din {providerName}-konto for at samarbejde om arbejde på tværs af Atlassian-produkter.',
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Du skal have de rette tilladelser til at redigere dette element.',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Brug søgeord til at søge efter sager, der skal indsættes.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Brug søgeord til at søge efter sider, der skal indsættes.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Brug JQL (Jira Query Language) til at søge efter sager.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} sag} other {{searchCount,number} sager}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} sag} other {{searchCount,number} sager}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} emne} other {{searchCount,number} emner}}',
