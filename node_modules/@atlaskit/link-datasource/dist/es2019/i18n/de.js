...
export default {
  ...
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.learnMoreLink': 'Weitere Informationen zur Suche mit AQL',
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchDescription': 'Um zu suchen, beginnen Sie mit der Eingabe, oder verwenden Sie AQL.',
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchTitle': 'Objekte suchen',
  'linkDataSource.assets.configmodal.insertIssuesButtonText': '{objectsCount, plural, one {Objekt einfügen} other {Objekte einfügen}}',
  ...
  'linkDataSource.checkConnection': 'Überprüfen Sie Ihre Verbindung und aktualisieren Sie dann die Seite oder versuchen Sie es später erneut.',
  ...
  'linkDataSource.column-picker.no-all-items-shown-message.line-2': 'Versuchen Sie es erneut mit konkreteren Stichwörtern.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText': 'Verbinden Sie Ihr {providerName}-Konto, um an verschiedenen Atlassian-Produkten mitzuarbeiten.',
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Sie benötigen die richtigen Berechtigungen, um dieses Element bearbeiten zu können.',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh': 'Jira-Vorgänge von folgender Site einfügen:',
  'linkDataSource.jira-issues.configmodal.placeholder.issues-issue-term-refresh': '### Vorgänge',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': 'Zeigen Sie die Anzahl der Suchergebnisse als intelligenten Inline-Link an.',
  ...
  'linkDataSource.jira-issues.searchDescription-basic': 'Suchen Sie nach Vorgängen, indem Sie ein Schlüsselwort eingeben.',
  'linkDataSource.jira-issues.searchDescription-jql': 'Suchen Sie mithilfe von JQL (Jira-Abfragesprache) nach Vorgängen.',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Suchen Sie nach Vorgängen zum Einfügen, indem Sie ein Schlüsselwort eingeben.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Suchen Sie nach Seiten zum Einfügen, indem Sie ein Stichwort eingeben.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Suchen Sie mithilfe von JQL (Jira-Abfragesprache) nach Vorgängen.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} Vorgang} other {{searchCount,number} Vorgänge}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} Vorgang} other {{searchCount,number} Vorgänge}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} Element} other {{searchCount,number} Elemente}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} Ergebnis} other {{searchCount,number} Ergebnisse}}',
