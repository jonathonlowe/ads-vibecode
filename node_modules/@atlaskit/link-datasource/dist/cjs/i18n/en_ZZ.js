...
var _default = exports.default = {
  ...
  'linkDataSource.jira-issues.configmodal.basicTextSearchPlaceholder-issue-term-refresh': '⁣⁢Search for work items by keyword؜⁬⁬؜⁮‌⁬⁮⁡‌؜؜⁫⁯‍⁭⁠⁯⁭؜⁫⁮⁠⁣⁤',
  ...
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': '⁣⁢Display the number of search results as an inline Smart Link‍⁬⁠⁬؜⁠؜‍⁬⁮⁬‍‌⁯⁡⁮⁬⁣⁤',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': '⁣⁢Search by keyword for work items to insert.‌⁫⁭⁮‍⁯⁭⁬⁪⁬⁮‍⁭⁯⁯⁡⁯⁮‌⁠⁬⁫⁮⁬⁣⁤',
  ...
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': '⁣⁢Use JQL (Jira Query Language) to search for work items.‍⁭⁪‌⁡⁫⁠⁯⁠؜⁡⁮⁭⁬‌⁮؜‌⁪⁫⁣⁤',
  ...
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {⁣⁢{searchCount,number} work item⁭⁬⁠⁫⁪⁠‍؜⁮‍⁯⁬⁬⁡‍⁡⁮⁬⁣⁤} other {⁣⁢{searchCount,number} work items⁭⁬⁠⁫⁪⁠‍؜⁮‍⁯⁬⁬⁡‍⁡⁮⁬⁣⁤}}',
  ...
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {⁣⁢{searchCount,number} result⁪⁠⁭⁫⁬⁠⁯⁫⁫⁫‌⁯⁠‍⁭⁠⁭‌⁭⁪‌‍؜⁣⁤} other {⁣⁢{searchCount,number} results⁪⁠⁭⁫⁬⁠⁯⁫⁫⁫‌⁯⁠‍⁭⁠⁭‌⁭⁪‌‍؜⁣⁤}}',
