...
var _default = exports.default = {
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Tarvitset oikeat käyttöoikeudet tämän kohteen muokkaamiseen.',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh': 'Lisää Jira-työtehtäviä sivulta',
  'linkDataSource.jira-issues.configmodal.placeholder.issues-issue-term-refresh': 'Työtehtävien määrä',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': 'Näytä hakutulosten lukumäärä tekstiin sitoutuvana Smart Linkinä',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Etsi lisättäviä työtehtäviä avainsanan mukaan.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Etsi lisättäviä sivuja avainsanan mukaan.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Käytä JQL:ää (Jira Query Language) työtehtävien hakemiseen.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} asia} other {{searchCount,number} asiaa}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} työtehtävä} other {{searchCount,number} työtehtävää}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} kohde} other {{searchCount,number} kohdetta}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} tulos} other {{searchCount,number} tulosta}}',
