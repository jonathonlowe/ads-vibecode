...
var _default = exports.default = {
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh': '次のサイトから Jira 作業項目を挿入する',
  'linkDataSource.jira-issues.configmodal.placeholder.issues-issue-term-refresh': '### 件の作業項目',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': '検索結果の件数をインライン スマート リンクとして表示します',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': '挿入する作業項目をキーワードで検索します。',
  'linkDataSource.modal-initial-state.searchDescription-confluence': '挿入するページをキーワードで検索します。',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'JQL (Jira クエリ言語) を使用して作業項目を検索します。',
  ...
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, other {{searchCount,number} 件の作業項目}}',
