...
var _default = exports.default = {
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Você precisa das permissões corretas para editar esse item.',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesButtonText-issue-term-refresh': 'Inserir tickets',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Pesquise com palavra-chave por tickets a serem inseridos.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Pesquise por palavra-chave as páginas a serem inseridas.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Use a JQL (Linguagem de Consulta do JIRA) para pesquisar por tickets.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} item} other {{searchCount,number} itens}}',
  ...
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} item} other {{searchCount,number} itens}}',
