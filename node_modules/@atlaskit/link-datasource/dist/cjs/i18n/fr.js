...
var _default = exports.default = {
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Vous avez besoin des autorisations adéquates pour modifier cette tâche.',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh': 'Insérer des tickets Jira à partir de',
  'linkDataSource.jira-issues.configmodal.placeholder.issues-issue-term-refresh': '### tickets',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkDescription': 'Affichez le nombre de résultats de recherche sous forme de lien intelligent contextuel',
  'linkDataSource.jira-issues.configmodal.viewModeInlineLinkLabel': 'Lien contextuel',
  'linkDataSource.jira-issues.configmodal.viewModeListDescription': 'Affichez les résultats de recherche sous forme de liste',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Recherchez des tickets à insérer par mot clé.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Recherchez des pages à insérer par mot clé.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Utilisez JQL (Jira Query Language) pour rechercher des tickets.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} ticket} other {{searchCount,number} tickets}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} ticket} other {{searchCount,number} tickets}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} tâche} other {{searchCount,number} tâches}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} résultat} other {{searchCount,number} résultats}}',
