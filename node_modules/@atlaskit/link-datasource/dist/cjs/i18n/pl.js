...
var _default = exports.default = {
  ...
  'linkDataSource.configmodal.basicTextSearchPlaceholder-issue-term-refresh': 'Wyszukaj zgłoszenia według słów kluczowych',
  ...
  'linkDataSource.issue-line-table.error-403-description': 'Do edycji tego elementu potrzebne są odpowiednie uprawnienia.',
  ...
  'linkDataSource.jira-issues.configmodal.basicTextSearchPlaceholder-issue-term-refresh': 'Wyszukaj zgłoszenia według słów kluczowych',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh': 'Wstaw zgłoszenia Jira z witryny',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Wyszukaj zgłoszenia do wstawienia według słowa kluczowego.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Wyszukaj strony do wstawienia według słowa kluczowego.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Użyj zapytań w języku JQL (Jira Query Language), aby wyszukiwać zgłoszenia.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} zgłoszenie} few {{searchCount,number} zgłoszenia} many {{searchCount,number} zgłoszeń} other {{searchCount,number} zgłoszenia}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} zgłoszenie} few {{searchCount,number} zgłoszenie} many {{searchCount,number} zgłoszeń} other {{searchCount,number} zgłoszenia}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} element} few {{searchCount,number} elementy} many {{searchCount,number} elementów} other {{searchCount,number} elementu}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} wynik} few {{searchCount,number} wyniki} many {{searchCount,number} wyników} other {{searchCount,number} wyniku}}',
