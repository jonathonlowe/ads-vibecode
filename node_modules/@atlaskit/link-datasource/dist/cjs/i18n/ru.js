...
var _default = exports.default = {
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic-issue-term-refresh': 'Ищите задачи для вставки по ключевым словам.',
  'linkDataSource.modal-initial-state.searchDescription-confluence': 'Ищите страницы для вставки по ключевым словам.',
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh': 'Используйте JQL (Jira Query Language) для поиска задач.',
  ...
  'linkDataSource.search.configmodal.issueCountText': '{searchCount, plural, one {{searchCount,number} задача} few {{searchCount,number} задачи} many {{searchCount,number} задач} other {{searchCount,number} задачи}}',
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh': '{searchCount, plural, one {{searchCount,number} задача} few {{searchCount,number} задачи} many {{searchCount,number} задач} other {{searchCount,number} задачи}}',
  'linkDataSource.search.configmodal.itemCountText': '{searchCount, plural, one {{searchCount,number} элемент} few {{searchCount,number} элемента} many {{searchCount,number} элементов} other {{searchCount,number} элемента}}',
  'linkDataSource.search.configmodal.resultCountText': '{searchCount, plural, one {{searchCount,number} результат} few {{searchCount,number} результата} many {{searchCount,number} результатов} other {{searchCount,number} результата}}',
