...
export const changeColor = (color, editorAnalyticsApi, inputMethod) => (state, dispatch) => {
  const {
    textColor
  } = state.schema.marks;
  if (textColor) {
    ...
    const withColorAnalytics = createWithColorAnalytics(color, activeColor, (pluginState === null || pluginState === void 0 ? void 0 : pluginState.palette) || [], editorAnalyticsApi, inputMethod);
