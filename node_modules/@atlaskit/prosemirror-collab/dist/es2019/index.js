 ...
 */
export function getDocBeforeUnconfirmedSteps(state) {
  var _collabKey$getState;
  const tr = state.tr;
  const {
    version,
    unconfirmed
  } = (_collabKey$getState = collabKey.getState(state)) !== null && _collabKey$getState !== void 0 ? _collabKey$getState : {};
 ...
 */
export function syncFromAnotherSource(state, version,
  ...
  return {
    ...
    get origins() {
      return (
        ...
        // Ignored via go/ees005
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        this._origins = collabState === null || collabState === void 0 ? void 0 : collabState.unconfirmed.map(s => s.origin))
      );
    }
  };
}
