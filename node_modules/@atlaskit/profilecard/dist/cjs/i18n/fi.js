...
var _default = exports.default = {
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': 'Haluatko varmasti poistaa tämän asiakaspalvelijan? Tätä toimintoa ei voi peruuttaa.',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use': 'Asiakaspalvelija on tällä hetkellä käytössä. Yritä myöhemmin uudelleen.',
  'profilecard.agent-profile.delete-agent-error.agent-not-found': 'Kyseistä asiakaspalvelijaa ei löytynyt.',
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'Et voi poistaa asiakaspalvelijoita, joita et ole itse luonut. Ota yhteys asiakaspalvelijan omistajaan.',
