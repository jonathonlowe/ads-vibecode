...
var _default = exports.default = {
  'profilecard.agent-profile-card.delete-agent-error-flag-description': 'Er is iets misgegaan bij het verwijderen van de agent. Probeer het over enkele ogenblikken opnieuw.',
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': 'Weet je zeker dat je deze agent wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use': 'Agent wordt momenteel gebruikt. Probeer het later opnieuw.',
  'profilecard.agent-profile.delete-agent-error.agent-not-found': 'We konden die agent niet vinden.',
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'Je kunt geen agents verwijderen die je niet zelf hebt aangemaakt. Neem contact op met de agenteigenaar.',
