...
var _default = exports.default = {
  'profilecard.agent-profile-card.delete-agent-error-flag-description': 'Algo deu errado ao excluir o agente. Tente de novo em alguns instantes.',
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': 'Tem certeza de que quer excluir este agente? A ação não pode ser desfeita.',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use': 'O agente está em uso no momento. Tente de novo mais tarde.',
  'profilecard.agent-profile.delete-agent-error.agent-not-found': 'Não foi possível encontrar esse agente.',
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'Você não pode excluir agentes criados por outras pessoas. Entre em contato com o proprietário do agente.',
