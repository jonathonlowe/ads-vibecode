...
var _default = exports.default = {
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': 'Möchten Sie diesen Agenten wirklich löschen? Der Vorgang kann nicht rückgängig gemacht werden.',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use': 'Der Agent wird derzeit verwendet. Versuchen Sie es später erneut.',
  'profilecard.agent-profile.delete-agent-error.agent-not-found': 'Dieser Agent wurde nicht gefunden.',
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'Sie können keine Agenten löschen, die Sie nicht selbst erstellt haben. Bitte kontaktieren Sie den Besitzer des Agenten.',
