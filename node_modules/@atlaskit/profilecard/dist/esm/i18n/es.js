...
export default {
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': '¿Seguro que quieres eliminar este agente? Esta acción no se puede deshacer.',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use': 'El agente está actualmente en uso. Vuelve a intentarlo más tarde.',
  'profilecard.agent-profile.delete-agent-error.agent-not-found': 'No se ha podido localizar ese agente.',
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'No puedes eliminar agentes que tú no has creado. Ponte en contacto con el propietario del agente.',
