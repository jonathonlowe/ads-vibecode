...
//Russian
export default {
  'profilecard.agent-profile-card.delete-agent-error-flag-description': 'При удалении агента произошла ошибка. Повторите попытку через некоторое время.',
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': 'Действительно удалить этого агента? Это действие нельзя отменить.',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use': 'В настоящее время агент используется. Повторите попытку позже.',
  'profilecard.agent-profile.delete-agent-error.agent-not-found': 'Не удалось найти агента.',
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'Вы не можете удалять агентов, созданных другими пользователями. Обратитесь к владельцу агента.',
