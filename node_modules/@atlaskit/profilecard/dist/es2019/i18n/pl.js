...
//Polish (Poland)
export default {
  'profilecard.agent-profile-card.delete-agent-error-flag-description': 'Coś poszło nie tak podczas usuwania agenta. Spróbuj ponownie za chwilę.',
  ...
  'profilecard.agent-profile.delete-agent-confirm-body': 'Na pewno chcesz usunąć tego agenta? Tej czynności nie można cofnąć.',
  ...
  'profilecard.agent-profile.delete-agent-error.incorrect-owner': 'Nie możesz usuwać agentów nieutworzonych przez Ciebie. Skontaktuj się z właścicielem agenta.',
