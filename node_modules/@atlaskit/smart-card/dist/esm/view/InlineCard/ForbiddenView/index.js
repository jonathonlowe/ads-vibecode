...
export var InlineCardForbiddenView = function InlineCardForbiddenView(_ref) {
  ...
  var _React$useState = React.useState(!!(requestAccessContext !== null && requestAccessContext !== void 0 && requestAccessContext.callToActionMessageKey)),
  ...
  var renderForbiddenAccessMessage = React.useCallback(function () {
    ...
    return /*#__PURE__*/React.createElement(FormattedMessage, messages.invalid_permissions, function (formattedMessage) {
