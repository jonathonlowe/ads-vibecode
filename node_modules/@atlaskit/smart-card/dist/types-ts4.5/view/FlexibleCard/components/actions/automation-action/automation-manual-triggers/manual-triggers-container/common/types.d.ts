...
export type UserInputValue = UserInputBooleanValue | UserInputDropdownValue | UserInputNumberValue | UserInputStringValue | UserInputParagraphValue;
...
export type InvocationResult = 'SUCCESS' | 'INVALID_LICENSE' | 'INVALID_PERMISSIONS' | 'INVALID_RULE_OR_ISSUE';
...
export declare const CORE_PROJECT = "business";
export declare const SOFTWARE_PROJECT = "software";
