...
var _default = exports.default = {
  ...
  'fabric.linking.ai_summary_error_exceeding_context_length_error': 'Atlassian Intelligence kan inte generera en sammanfattning åt dig just nu eftersom det finns för mycket innehåll att sammanfatta.',
  'fabric.linking.ai_summary_error_generic': 'Atlassian Intelligence (AI) svarar inte. Försök igen senare eller <a>kontrollera status för AI</a>.',
  'fabric.linking.ai_summary_error_hipaa_content_detected': 'Atlassian Intelligence kunde inte behandla din förfrågan eftersom innehållet innehåller länkar till HIPAA-begränsat innehåll.',
  ...
  'fabric.linking.connect_account_description': 'Vi kommer att öppna en ny sida som hjälper dig att ansluta till ditt {name}-konto',
  'fabric.linking.connect_link_account': 'Anslut till förhandsgranskning',
  'fabric.linking.connect_link_account_card_view': 'Anslut',
  'fabric.linking.connect_link_account_card_view_description': 'Anslut ditt {context}-konto om du vill visa en förhandsgranskning av den här länken.',
  ...
  'fabric.linking.connect_unauthorised_account_description': 'Anslut ditt {context}-konto för att samarbeta kring projekt i flera Atlassian-produkter.',
  'fabric.linking.connect_unauthorised_account_description_no_provider': 'Anslut ditt konto för att samarbeta kring projekt i flera Atlassian-produkter.',
  ...
  'fabric.linking.direct_access_description': 'Ditt team använder {product} för att samarbeta och du kan börja använda det direkt!',
  ...
  'fabric.linking.request_access_pending_description': 'Din begäran om åtkomst till {hostname} väntar på godkännande från administratören.',
  ...
  'fabric.linking.request_access_to_view-issue-term-refresh': 'Be om åtkomst till {context} för att visa arbetsuppgiften',
  'fabric.linking.request_denied': 'Din åtkomstförfrågan har nekats',
  'fabric.linking.request_denied_description': 'Din administratör godkände inte din begäran om att visa {product}-sidor från {hostname}.',
  ...
  'fabric.linking.status_change_permission_error-issue-term-refresh': 'Du har inte behörighet att ändra arbetets status.',
  ...
  'fabric.linking.unauthorised_account_description': 'Du försöker att förhandsgranska en länk till en privat {context}-sida. Vi rekommenderar att du granskar webbadressen eller kontaktar sidans ägare.',
  'fabric.linking.unauthorised_account_description_no_provider': 'Du försöker att förhandsgranska en länk till en privat sida. Vi rekommenderar att du granskar webbadressen eller kontaktar sidans ägare.',
