...
var _default = exports.default = {
  ...
  'fabric.linking.ai_summary_action_description': 'Bu bağlantının içeriğini Atlassian Intelligence kullanarak özetleyin.',
  ...
  'fabric.linking.ai_summary_error_exceeding_context_length_error': 'Atlassian Intelligence, özetlenecek çok fazla içerik olduğundan şu anda bir özet oluşturamıyor.',
  'fabric.linking.ai_summary_error_generic': 'Atlassian Intelligence (AI) yanıt vermiyor. Daha sonra yeniden deneyin veya <a>AI durumunu kontrol edin</a>.',
  'fabric.linking.ai_summary_error_hipaa_content_detected': 'Atlassian Intelligence, içeriğiniz HIPAA kısıtlı içeriklere giden bağlantılar içerdiğinden talebinizi işleyemedi.',
  ...
  'fabric.linking.connect_account_description': '{name} hesabınıza bağlanmanıza yardımcı olmak için yeni bir sayfa açacağız',
  ...
  'fabric.linking.connect_unauthorised_account_description': 'Atlassian ürünlerindeki çalışmalarda iş birliği yapmak için {context} hesabınızı bağlayın.',
  'fabric.linking.connect_unauthorised_account_description_no_provider': 'Atlassian ürünlerindeki çalışmalarda iş birliği yapmak için hesabınızı bağlayın.',
  ...
  'fabric.linking.direct_access_description': 'Takımınız iş birliği yapmak için {product} kullanıyor ve siz de hemen kullanmaya başlayabilirsiniz!',
  ...
  'fabric.linking.request_access_to_view-issue-term-refresh': 'Bu bileti görüntülemek için {context} ürününe erişim talep edin',
  'fabric.linking.request_denied': 'Erişim talebiniz reddedildi',
  'fabric.linking.request_denied_description': 'Yöneticiniz {hostname} üzerinde {product} sayfalarını görüntüleme talebinizi onaylamadı.',
  ...
  'fabric.linking.unauthorised_account_description': "Özel bir {context} sayfasına olan bir bağlantıyı önizlemeye çalışıyorsunuz. URL'yi incelemenizi veya sayfa sahibiyle iletişime geçmenizi öneririz.",
  'fabric.linking.unauthorised_account_description_no_provider': "Özel bir sayfaya olan bir bağlantıyı önizlemeye çalışıyorsunuz. URL'yi incelemenizi veya sayfa sahibiyle iletişime geçmenizi öneririz.",
