...
export default {
  ...
  'automation-menu.modal.empty.automations.admin.description': '수동 트리거를 사용하여 모든 사용자 또는 지정한 사용자가 원클릭 자동화로 적용할 수 있는 선택 항목 메뉴를 채우세요.',
  ...
  'fabric.linking.ai_summary_error_exceeding_context_length_error': '요약할 콘텐츠가 너무 많아서 Atlassian Intelligence가 지금 요약을 생성할 수 없습니다.',
  'fabric.linking.ai_summary_error_generic': 'Atlassian Intelligence(AI)가 응답하지 않습니다. 나중에 다시 시도하거나 <a>AI 상태를 확인</a>하세요.',
  'fabric.linking.ai_summary_error_hipaa_content_detected': '콘텐츠에 HIPAA 제한 콘텐츠 링크가 포함되어 있으므로 Atlassian Intelligence에서 요청을 처리할 수 없습니다.',
  ...
  'fabric.linking.related_links_modal_error_message': '최근 링크를 로드하는 동안 문제가 발생했습니다. 연결 상태를 확인하거나 페이지를 새로 고쳐 다시 시도하세요.',
  ...
  'fabric.linking.related_links_modal_unavailable_description': 'Atlassian은 업데이트된 페이지 또는 기타 콘텐츠 유형의 관련 링크를 지속적으로 검토 및 추가합니다',
  ...
  'fabric.linking.request_access_to_view-issue-term-refresh': '이 업무 항목을 보려면 {context}에 대한 액세스를 요청하세요',
