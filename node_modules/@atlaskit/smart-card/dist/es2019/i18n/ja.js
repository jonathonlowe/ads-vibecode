...
export default {
  ...
  'automation-menu.modal.empty.automations.admin.description': '手動トリガーをメニューの選択肢として使用すると、ワンクリックの自動化としてユーザー (特定のユーザーを指定することもできる) が適用できるようになります。',
  'automation-menu.modal.empty.automations.user.description': '管理者が手動でトリガーされる自動化をまだ設定していません。',
  ...
  'fabric.linking.ai_summary_action_description': 'Atlassian Intelligence を使用して、このリンクのコンテンツを要約します',
  'fabric.linking.ai_summary_error_acceptable_use_violation': 'この要約の結果は、<a>アトラシアンの利用規定</a>に反するため、表示できません。',
  'fabric.linking.ai_summary_error_exceeding_context_length_error': '要約する内容が多すぎるため、現在 Atlassian Intelligence は要約を生成できません。',
  'fabric.linking.ai_summary_error_generic': 'Atlassian Intelligence (AI) が応答していません。後でもう一度お試しになるか、<a>AI のステータスを確認してください</a>。',
  'fabric.linking.ai_summary_error_hipaa_content_detected': 'HIPAA の制限対象となるコンテンツへのリンクが含まれているため、Atlassian Intelligence はリクエストを処理できませんでした。 ',
  ...
  'fabric.linking.related_links_modal_error_message': '最近のリンクを読み込もうとして問題が発生しました。接続を確認するか、更新してやり直してください。',
  ...
  'fabric.linking.status_change_permission_error-issue-term-refresh': 'この作業項目をトランジションする権限がありません。',
