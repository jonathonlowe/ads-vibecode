...
._19it1i39{border:var(--ds-space-025,2px) solid transparent}
...
._1itk34ia{background-image:linear-gradient(to right,var(--ds-skeleton,#ebecf0) 10%,var(--ds-skeleton-subtle,#f4f5f7) 30%,var(--ds-skeleton,#ebecf0) 50%)}
