...
var UploadServiceImpl = exports.UploadServiceImpl = /*#__PURE__*/function () {
  ...
  return (0, _createClass2.default)(UploadServiceImpl, [{
    ...
    value: function createUploadController() {
      return new _mediaClient.UploadController();
    }
  }, {
    key: "addFiles",
    ...
    value: function emitPreviews(cancellableFileUploads) {
      ...
      cancellableFileUploads.forEach(function (cancellableFileUpload) {
        ...
        if (!(0, _mediaCommon.isMimeTypeSupportedByBrowser)(type)) {
        ...
        if (mediaType === 'image') {
          ...
          (0, _getPreviewFromBlob.getPreviewFromBlob)(mediaType, file).then(function (preview) {
            _this4.emit('file-preview-update', {
              file: mediaFile,
              preview: preview
            });
    ...
    value: function getMediaTypeFromFile(file) {
      var type = file.type;
      return (0, _mediaCommon.getMediaTypeFromMimeType)(type);
    }
  }, {
