...
//German (Germany)
export default {
  'fabric.media.abuse_modal_body': 'Zu Ihrer Sicherheit scannt unser System automatisch alle hochgeladenen Dateien. Die Datei, die Sie herunterladen möchten, enthält möglicherweise schädliche Inhalte.',
  ...
  'fabric.media.connect_account_description': 'Es wird eine neue Seite geöffnet, auf der Sie Ihr {name}-Konto verbinden können.',
  'fabric.media.connect_link_account': 'Verknüpfen und Vorschau ansehen',
  'fabric.media.connect_link_account_card_view': 'Verbinden',
  'fabric.media.connect_link_account_card_view_description': 'Verbinden Sie Ihr {context}-Konto, um eine Vorschau dieses Links anzuzeigen.',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'Es kann keine Vorschau für verschlüsselte oder passwortgeschützte Dateien erstellt werden.',
  ...
  'fabric.media.download_disabled_security_policy': 'Der Download wird durch die Sicherheitsrichtlinien Ihrer Organisation blockiert.',
  ...
  'fabric.media.drag_and_drop_your_files_and_folders': 'Dateien und Ordner per Drag-and-Drop irgendwohin verschieben oder',
  ...
  'fabric.media.invalid_permissions_description': 'Bitte senden Sie eine Zugriffsanfrage oder versuchen Sie, die Vorschau über ein anderes Konto anzusehen.',
  ...
  'fabric.media.not_found_description': 'Der Link konnte nicht gefunden werden. Überprüfen Sie die URL und versuchen Sie die Bearbeitung oder das Einfügen erneut.',
  ...
  'fabric.media.request_access_description': 'Sie müssen Zugriff auf {context} anfordern, um diese Vorschau anzeigen zu können.',
  ...
  'fabric.media.request_denied_description': 'Ihre Zugriffsanfrage wurde abgelehnt. Wenden Sie sich an Ihren Administrator, falls Sie noch Zugriff benötigen.',
  ...
  'fabric.media.select_an_avatar': 'Standardprofilbild auswählen',
  ...
  'fabric.media.video_seeker_assistive_text_time_value': '{currentTimeHours} {currentTimeMinutes} {currentTimeSeconds} von {videoTotalHours} {videoTotalMinutes} {videoTotalSeconds}',
  ...
  'fabric.media.webgl_warning_description': 'Ihr Browser unterstützt WebGL nicht. Verwenden Sie zum Kommentieren von Bildern einen WebGL-fähigen Browser.',
