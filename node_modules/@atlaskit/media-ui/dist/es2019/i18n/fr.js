...
//French (France)
export default {
  'fabric.media.abuse_modal_body': 'Pour votre sécurité, notre système analyse automatiquement tous les fichiers importés. Le fichier que vous êtes sur le point de télécharger comporte potentiellement du contenu malveillant',
  ...
  'fabric.media.connect_account_description': 'Nous ouvrirons une nouvelle page pour vous aider à vous connecter à votre compte {name}',
  'fabric.media.connect_link_account': "Connecter à l'aperçu",
  'fabric.media.connect_link_account_card_view': 'Connecter',
  'fabric.media.connect_link_account_card_view_description': 'Pour afficher un aperçu de ce lien, connectez votre compte {context}.',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'Impossible de prévisualiser les fichiers chiffrés ou protégés par un mot de passe.',
  ...
  'fabric.media.download_disabled_security_policy': 'Le téléchargement est bloqué par la politique de sécurité de votre organisation.',
  ...
  'fabric.media.invalid_permissions_description': "Vous devrez demander l'accès ou essayer un autre compte pour afficher cet aperçu.",
  ...
  'fabric.media.request_denied_description': "Votre demande d'accès a été refusée. Contactez l'administrateur de site pour demander l'accès.",
  ...
  'fabric.media.webgl_warning_description': 'Votre navigateur ne prend pas en charge WebGL. Utilisez un navigateur compatible WebGL pour annoter les images.',
