...
//Thai (Thailand)
export default {
  'fabric.media.abuse_modal_body': 'เพื่อความปลอดภัย ระบบของเราจะสแกนไฟล์ที่อัปโหลดทั้งหมดโดยอัตโนมัติ ไฟล์ที่คุณกำลังจะดาวน์โหลดอาจมีเนื้อหาที่เป็นอันตราย',
  ...
  'fabric.media.connect_account_description': 'เราจะเปิดหน้าเพจใหม่เพื่อช่วยให้คุณสามารถเชื่อมต่อบัญชี {name} ของคุณได้',
  'fabric.media.connect_link_account': 'เชื่อมต่อเพื่อดูตัวอย่าง',
  'fabric.media.connect_link_account_card_view': 'เชื่อมต่อ',
  'fabric.media.connect_link_account_card_view_description': 'เพื่อแสดงตัวอย่างของลิงก์นี้ โปรดติดต่อบัญชี {context} ของคุณ',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'เราไม่สามารถแสดงตัวอย่างไฟล์ที่เข้ารหัสหรือไฟล์ที่มีรหัสป้องกันไว้ได้',
  ...
  'fabric.media.enter_password': 'ป้อนรหัสผ่าน',
  ...
  'fabric.media.failed_to_upload': 'ไม่สามารถอัปโหลดได้',
  'fabric.media.file_is_selected': 'เลือกไฟล์ {name} แล้ว',
  'fabric.media.forbidden_description': 'คุณไม่มีสิทธิ์เข้าถึงตัวอย่างนี้ โปรดติดต่อผู้ดูแลระบบเว็บไซต์หากคุณต้องการสิทธิ์การเข้าถึง',
  ...
  'fabric.media.incorrect_password': 'รหัสผ่านไม่ถูกต้อง โปรดลองอีกครั้ง',
  'fabric.media.insert_files': '{0, plural, other {แทรกไฟล์ {0} ไฟล์}}',
  'fabric.media.invalid_permissions': 'ลิงก์ที่จำกัด',
  'fabric.media.invalid_permissions_description': 'คุณอาจจำเป็นต้องร้องขอสิทธิ์การเข้าถึงหรือลองบัญชีอื่นเพื่อดูการแสดงตัวอย่างนี้',
  ...
  'fabric.media.open_file_in_viewer': 'เปิด {name}',
  'fabric.media.or': 'หรือ',
  'fabric.media.or_select_default_avatars': 'อัปโหลดรูปภาพหรือเลือกจากตัวเลือกเริ่มต้นบางรายการ',
  'fabric.media.password': 'รหัสผ่าน',
  'fabric.media.password_protected_pdf': 'ไฟล์นี้ได้รับการป้องกันด้วยรหัสผ่าน',
  ...
  'fabric.media.request_denied_description': 'คำขอการเข้าถึงของคุณถูกปฏิเสธ โปรดติดต่อผู้ดูแลระบบเว็บไซต์หากคุณยังต้องการสิทธิ์การเข้าถึง',
  ...
  'fabric.media.select_an_avatar': 'เลือกรูปแทนตัวเริ่มต้น',
  ...
  'fabric.media.video_seeker_assistive_text_time_value': '{currentTimeHours} {currentTimeMinutes} {currentTimeSeconds} จาก {videoTotalHours} {videoTotalMinutes} {videoTotalSeconds}',
  ...
  'fabric.media.webgl_warning_description': 'เบราว์เซอร์ของคุณไม่รองรับ WebGL ใช้เบราว์เซอร์ที่เปิดใช้งาน WebGL ในการทำหมายเหตุประกอบรูปภาพ',
