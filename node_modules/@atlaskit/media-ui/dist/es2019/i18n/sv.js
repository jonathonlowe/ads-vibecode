...
//Swedish
export default {
  'fabric.media.abuse_modal_body': 'Vårt system söker automatiskt igenom alla uppladdade filer för din säkerhet. Filen du är på väg att ladda ner innehåller potentiellt skadligt innehåll',
  ...
  'fabric.media.connect_account_description': 'Vi kommer att öppna en ny sida som hjälper dig att ansluta till ditt {name}-konto',
  'fabric.media.connect_link_account': 'Anslut till förhandsgranskning',
  'fabric.media.connect_link_account_card_view': 'Anslut',
  'fabric.media.connect_link_account_card_view_description': 'Anslut ditt {context}-konto om du vill visa en förhandsgranskning av den här länken.',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'Du kan inte förhandsgranska krypterade eller lösenordsskyddade filer.',
  ...
  'fabric.media.forbidden_description': 'Du har inte behörighet för den här förhandsgranskningen. Kontakta webbplatsadministratören om du behöver åtkomst.',
  ...
  'fabric.media.invalid_permissions_description': 'Du måste begära åtkomst eller försöka med ett annat konto för att visa förhandsgranskningen.',
  ...
  'fabric.media.not_found_description': 'Vi kunde inte hitta länken. Kontrollera URL-adressen och försök att redigera eller klistra in igen.',
  ...
  'fabric.media.request_denied_description': 'Din åtkomstförfrågan har nekats. Kontakta webbplatsadministratören om du fortfarande behöver åtkomst.',
  ...
  'fabric.media.webgl_warning_description': 'Din webbläsare stöder inte WebGL. Använd en webbläsare som har stöd för WebGL för att kommentera bilder.',
