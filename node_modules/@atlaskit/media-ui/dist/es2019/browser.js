...
export function isWebkitSupported(mockedNavigator) {
  const navigatorUsed = mockedNavigator !== undefined ? mockedNavigator : navigator;
  ...
  if (webkitSupported === undefined) {
    if (typeof navigatorUsed !== 'undefined') {
      ...
      const ie11up = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigatorUsed.userAgent);
      const opera = /Opera/.test(navigatorUsed.platform) || /OPR/.test(navigatorUsed.platform);
