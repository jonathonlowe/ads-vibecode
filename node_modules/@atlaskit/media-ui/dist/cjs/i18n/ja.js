...
var _default = exports.default = {
  'fabric.media.abuse_modal_body': 'セキュリティ保護のため、弊社のシステムではアップロードされたすべてのファイルを自動的にスキャンしています。ダウンロードしようとしているファイルには、悪意のあるコンテンツが含まれている可能性があります',
  ...
  'fabric.media.connect_link_account_card_view_description': 'このリンクのプレビューを表示するには {context} アカウントを接続してください。',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': '暗号化されたファイルやパスワードで保護されたファイルはプレビューできません。',
  ...
  'fabric.media.download_disabled_security_policy': 'ダウンロードは、組織のセキュリティ ポリシーに基づいてブロックされました。',
  'fabric.media.drag_and_drop_images_here': 'ここに画像をドラッグ & ドロップ',
  'fabric.media.drag_and_drop_your_files': 'ファイルを任意の場所にドラッグ & ドロップする、または',
  'fabric.media.drag_and_drop_your_files_and_folders': 'ファイルとフォルダーを任意の場所または次の場所にドラッグ & ドロップ: ',
  ...
  'fabric.media.forbidden_description': 'このプレビューにアクセスできません。アクセスが必要な場合はサイト管理者にお問い合わせください。',
  ...
  'fabric.media.image_size_too_large_error': '画像が大きすぎます。画像サイズは {MAX_SIZE_MB}Mb 以下である必要があります。',
  ...
  'fabric.media.invalid_permissions_description': 'このプレビューを表示するには、アクセスをリクエストするか別のアカウントで試してください。',
  ...
  'fabric.media.not_found_description': 'リンクが見つかりませんでした。URL を確認して編集するか、もう一度貼り付けてください。',
  ...
  'fabric.media.request_denied_description': 'アクセス リクエストが拒否されました。アクセスが必要な場合はサイト管理者にお問い合わせください。',
  ...
  'fabric.media.webgl_warning_description': 'お使いのブラウザーは WebGL に対応していません。画像に注釈をつけるには WebGL 対応ブラウザーをご利用ください。',
