...
var _default = exports.default = {
  'fabric.media.abuse_modal_body': 'Tietoturvasyistä järjestelmämme tarkistaa automaattisesti kaikki ladatut tiedostot. Tiedosto, jota olet lataamassa, saattaa sisältää haitallista sisältöä',
  ...
  'fabric.media.connect_account_description': 'Avaamme uuden sivun, jotta voimme auttaa sinua yhdistämään {name} -tilisi',
  'fabric.media.connect_link_account': 'Yhdistä esikatseluun',
  'fabric.media.connect_link_account_card_view': 'Yhdistä',
  'fabric.media.connect_link_account_card_view_description': 'Jotta voit esikatsella tätä linkkiä, yhdistä {context}-tilisi.',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'Salattuja tai salasanalla suojattuja tiedostoja ei voi esikatsella.',
  ...
  'fabric.media.invalid_permissions_description': 'Pyydä käyttöoikeus tai käytä toista tiliä, jos haluat nähdä tämän esikatselun.',
  ...
  'fabric.media.request_access_description': 'Pyydä sovelluksen {context} käyttöoikeutta tämän esikatselun katsomista varten.',
  ...
  'fabric.media.request_denied_description': 'Käyttöoikeuspyyntösi evättiin. Ota yhteyttä sivustosi ylläpitäjään, jos silti tarvitset käyttöoikeuden.',
  ...
  'fabric.media.webgl_warning_description': 'Selaimesi ei tue WebGL:ää. Käytä WebGL:ää tukevaa selainta, jos haluat tehdä merkintöjä kuviin.',
