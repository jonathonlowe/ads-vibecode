...
var _default = exports.default = {
  'fabric.media.abuse_modal_body': 'Güvenliğiniz için sistemimiz yüklenen tüm dosyaları otomatik olarak tarar. İndirmek üzere olduğunuz dosya kötü amaçlı içerik içerebilir',
  ...
  'fabric.media.connect_account_description': '{name} hesabınıza bağlanmanıza yardımcı olmak için yeni bir sayfa açacağız',
  'fabric.media.connect_link_account': 'Önizlemeye bağlanın',
  'fabric.media.connect_link_account_card_view': 'Bağla',
  'fabric.media.connect_link_account_card_view_description': 'Bu bağlantının bir önizlemesini görmek için {context} hesabınızı bağlayın.',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'Şifrelenmiş veya parola korumalı dosyaların önizlemesini gösteremiyoruz.',
  ...
  'fabric.media.download_disabled_security_policy': 'İndirme işlemi, organizasyonunuzun güvenlik politikası tarafından engellendi.',
  ...
  'fabric.media.drag_and_drop_your_files_and_folders': 'Dosya ve klasörlerinizi herhangi bir yere sürükleyip bırakın veya',
  ...
  'fabric.media.enter_password': 'Parola girin',
  ...
  'fabric.media.failed_to_upload': 'Yüklenemedi',
  'fabric.media.file_is_selected': '{name} adlı dosya seçildi',
  'fabric.media.forbidden_description': 'Bu önizlemeye erişiminiz yok. Erişim gerekliyse site yöneticisiyle iletişime geçin.',
  ...
  'fabric.media.incorrect_password': 'Yanlış parola. Lütfen yeniden deneyin.',
  ...
  'fabric.media.invalid_permissions_description': 'Bu önizlemeyi görüntülemek için erişim izni talep etmeniz veya farklı bir hesap kullanmanız gerekir.',
  ...
  'fabric.media.not_found_description': "Bağlantıyı bulamadık. URL'yi kontrol edin ve düzenlemeyi veya yeniden yapıştırmayı deneyin.",
  'fabric.media.not_found_title': 'Hay aksi! Bu bağlantıyı bulamadık!',
  'fabric.media.open_file_in_viewer': '{name} öğesini aç',
  'fabric.media.or': 'veya',
  'fabric.media.or_select_default_avatars': 'Bir fotoğraf yükleyin veya varsayılan seçeneklerden birini belirleyin',
  'fabric.media.password': 'Parola',
  'fabric.media.password_protected_pdf': 'Bu dosya parola korumalıdır.',
  ...
  'fabric.media.request_denied_description': 'Erişim talebiniz reddedildi. Hâlâ erişim gerekliyse site yöneticisiyle iletişime geçin.',
  ...
  'fabric.media.select_an_avatar': 'Varsayılan bir profil resmi seçin',
  ...
  'fabric.media.webgl_warning_description': "Tarayıcınız WebGL'yi desteklemiyor. Görsellere not eklemek için WebGL etkinleştirilmiş bir tarayıcı kullanın.",
