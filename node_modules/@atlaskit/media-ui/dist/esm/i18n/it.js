...
//Italian (Italy)
export default {
  'fabric.media.abuse_modal_body': 'Per la tua sicurezza, il nostro sistema esegue automaticamente la scansione di tutti i file caricati. Il file che stai per scaricare potrebbe contenere elementi dannosi',
  ...
  'fabric.media.connect_account_description': 'Apriremo una nuova pagina per aiutarti a collegare il tuo account {name}',
  'fabric.media.connect_link_account': 'Connetti ad anteprima',
  'fabric.media.connect_link_account_card_view': 'Collega',
  'fabric.media.connect_link_account_card_view_description': "Per visualizzare un'anteprima di questo link, connetti il tuo account {context}.",
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': 'Non possiamo visualizzare in anteprima file crittografati o protetti da password.',
  ...
  'fabric.media.download_disabled_security_policy': 'Il download è stato bloccato dalla policy di sicurezza della tua organizzazione.',
  ...
  'fabric.media.forbidden_description': "Non hai accesso a questa anteprima. Contatta l'amministratore del sito se devi accedere.",
  ...
  'fabric.media.invalid_permissions_description': "Per visualizzare quest'anteprima devi richiedere l'accesso o provare con un altro account.",
  ...
  'fabric.media.not_found_description': "Non è stato possibile trovare il link. Controlla l'URL e prova a modificarlo o a incollarlo di nuovo.",
  ...
  'fabric.media.request_denied_description': "La tua richiesta di accesso è stata rifiutata. Contatta l'amministratore del sito se devi accedere.",
  ...
  'fabric.media.webgl_warning_description': 'Il tuo browser non supporta WebGL. Per annotare le immagini usa un browser compatibile con WebGL.',
