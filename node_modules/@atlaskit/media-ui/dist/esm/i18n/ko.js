...
//Korean
export default {
  'fabric.media.abuse_modal_body': '보안을 위해 당사 시스템은 업로드된 모든 파일을 자동으로 검사합니다. 다운로드하려는 파일에 악성 콘텐츠가 포함되어 있을 수 있습니다',
  ...
  'fabric.media.connect_link_account_card_view_description': '이 링크의 미리 보기를 표시하려면 {context} 계정을 연결하세요.',
  ...
  'fabric.media.couldnt_generate_encrypted_entry_preview': '암호화되었거나 비밀번호로 보호되는 파일은 미리 볼 수 없습니다.',
  ...
  'fabric.media.forbidden_description': '이 미리 보기에 액세스할 수 없습니다. 액세스가 필요한 경우 사이트 관리자에게 문의하세요.',
  ...
  'fabric.media.invalid_permissions_description': '이 미리 보기를 확인하려면 액세스를 요청하거나 다른 계정으로 시도해야 합니다.',
  ...
  'fabric.media.request_denied_description': '액세스 요청이 거부되었습니다. 계속해서 액세스가 필요한 경우 사이트 관리자에게 문의하세요.',
  ...
  'fabric.media.webgl_warning_description': '사용하시는 브라우저가 WebGL을 지원하지 않습니다. 이미지를 주석으로 달려면 WebGL을 사용할 수 있는 브라우저를 사용하십시오.',
