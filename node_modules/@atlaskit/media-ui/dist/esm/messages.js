...
export var messages = defineMessages({
  ...
  changeView: {
    ...
    description: 'In the context of a file, it allows the user to select a different way of displaying the file either as inline or a card'
  },
  playbackSpeed: {
  ...
  sizeOptions: {
    ...
    description: 'A dropdown with buttons that allow to convert an image to an inline or to an image or original size'
  },
  fileDisplayOptions: {
    id: 'fabric.media.file.display_options',
    defaultMessage: 'Display options',
    description: 'A dropdown with buttons that allow to convert between an inline file or a thumbnail file'
  },
  ...
  file_doc_is_selected: {
    ...
    description: '{name} it is the parameter, which saying alt text or file name of uploaded document'
  },
  file_archive_is_selected: {
    id: 'fabric.media.file_is_selected',
    defaultMessage: 'Archive {name} is selected',
    description: '{name} it is the parameter, which saying alt text or file name of uploaded archive'
  },
  ...
  video_seeker_assistive_text_time_value: {
    ...
    description: 'Video time seeker information for screen reader users - final format example: 1 hour 12 minutes 13 seconds of 1 hours 16 minutes 1 second. Units are already translated via Intl.NumberFormat'
  },
