...
var _timedPromise = require("../util/timed-promise");
 ...
 */
var supportsUploadFeature = exports.supportsUploadFeature = function supportsUploadFeature(emojiProvider) {
...
var EmojiResource = exports.EmojiResource = /*#__PURE__*/function (_ref) {
  function EmojiResource(config) {
    ...
    (0, _defineProperty2.default)(_this, "activeLoaders", 0);
    (0, _defineProperty2.default)(_this, "initialLoaders", 0);
    (0, _defineProperty2.default)(_this, "retries", new Map());
    (0, _defineProperty2.default)(_this, "isInitialised", false);
    (0, _defineProperty2.default)(_this, "fetchOnDemand", false);
    (0, _defineProperty2.default)(_this, "getOptimisticImageURL", function (emojiId) {
      if (_this.emojiProviderConfig.optimisticImageApi) {
        return _this.emojiProviderConfig.optimisticImageApi.getUrl(emojiId);
      }
      return;
    });
    (0, _defineProperty2.default)(_this, "isRepositoryAvailable", function (repository) {
      return !!repository;
    });
  ...
  return (0, _createClass2.default)(EmojiResource, [{
    ...
    value: function initEmojiRepository(emojiResponses) {
      ...
      this.emojiRepository = new _EmojiRepository.default(emojis);
    }
  }, {
        ...
        if (emojis.length) {
          ...
          if ((0, _typeHelpers.isPromise)(done)) {
            return done.then(function () {
              ...
              (0, _logger.default)('Failed to prime siteEmojiResource');
            });
          } else {
            (0, _logger.default)('Already primed siteEmojiResource');
          }
        } else {
    ...
    value: function recordSelection(emoji) {
      ...
      if (recordConfig) {
        ...
        return _utilServiceSupport.utils.requestService(recordConfig, {
...
var UploadingEmojiResource = exports.default = /*#__PURE__*/function (_EmojiResource2) {
  ...
  (0, _inherits2.default)(UploadingEmojiResource, _EmojiResource2);
  return (0, _createClass2.default)(UploadingEmojiResource, [{
    ...
    value: function uploadCustomEmoji(upload) {
      ...
      return this.isUploadSupported().then(function (supported) {
        ...
        return (0, _timedPromise.promiseWithTimeout)(uploadPromise, timeout, 'uploadCustomEmoji timed out');
      });
    }
  }, {
