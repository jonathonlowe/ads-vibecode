...
var MediaImageLoader = exports.default = /*#__PURE__*/function () {
  function MediaImageLoader(tokenManager, options) {
    (0, _classCallCheck2.default)(this, MediaImageLoader);
    (0, _defineProperty2.default)(this, "mediaImageQueue", []);
    (0, _defineProperty2.default)(this, "activeProcessing", 0);
  ...
  return (0, _createClass2.default)(MediaImageLoader, [{
    key: "loadMediaImage",
    ...
    value: function requestMediaEmoji(url, token, retryOnAuthError) {
      ...
      return (0, _image.imageAcceptHeader)().then(function (acceptHeader) {
