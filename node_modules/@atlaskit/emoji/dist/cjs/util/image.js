...
var getNaturalImageSize = exports.getNaturalImageSize = function getNaturalImageSize(dataURL) {
...
var parseImage = exports.parseImage = function parseImage(dataURL) {
  return new Promise(function (resolve, reject) {
    var img = new Image();
    img.onload = function () {
      return resolve({
...
var hasFileExceededSize = exports.hasFileExceededSize = function hasFileExceededSize(file) {
 ...
 */
var isWebpSupported;
var checkWebpSupport = exports.checkWebpSupport = function checkWebpSupport() {
...
var imageAcceptHeader = exports.imageAcceptHeader = function imageAcceptHeader() {
