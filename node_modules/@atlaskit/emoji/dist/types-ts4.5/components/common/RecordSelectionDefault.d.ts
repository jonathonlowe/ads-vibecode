 ...
 */
export declare const createRecordSelectionDefault: <T>(provider: EmojiProvider, onSelect?: OnEmojiEvent<T>, fireAnalytics?: ((producer: EmojiInsertionAnalytic) => void) | undefined) => OnEmojiEvent<T>;
