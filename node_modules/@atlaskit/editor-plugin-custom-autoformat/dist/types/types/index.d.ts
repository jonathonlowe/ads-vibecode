...
export type Reducer<ActionType> = (state: CustomAutoformatState, action: ActionType) => CustomAutoformatState;
...
export type CustomAutoformatAction = CustomAutoformatMatched | CustomAutoformatResolved | CustomAutoformatFinish | CustomAutoformatSetProvider;
