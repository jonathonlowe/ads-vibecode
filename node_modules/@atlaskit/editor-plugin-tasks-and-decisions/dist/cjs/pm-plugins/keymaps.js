...
var joinTaskDecisionFollowing = function joinTaskDecisionFollowing(state, dispatch) {
  ...
  if (!(0, _utils.isEmptySelectionAtEnd)(state) || !(0, _helpers.isInsideTaskOrDecisionItem)(state) || !dispatch) {
    return false;
  }
  ...
  var parentList = (0, _utils2.findParentNodeOfTypeClosestToPos)($next, [taskList, taskItem, decisionList, decisionItem]);
  if (!parentList) {
...
var shouldLetTabThroughInTable = function shouldLetTabThroughInTable(state) {
  ...
  var cell = (0, _utils2.findParentNodeOfType)([tableCell, tableHeader])(state.selection);
...
var cmdOptEnter = (0, _utils.filterCommand)(_helpers.isInsideTaskOrDecisionItem, function (state, dispatch) {
  var selection = state.selection,
    schema = state.schema;
  var taskItem = schema.nodes.taskItem;
  var $from = selection.$from;
...
function keymapPlugin(schema, api, allowNestedTasks, consumeTabs) {
  ...
  var indentHandlers = {
    ...
    Tab: (0, _utils.filterCommand)([_helpers.isInsideTaskOrDecisionItem, function (state) {
      return !shouldLetTabThroughInTable(state);
    }], function (state, dispatch) {
      var _api$analytics2;
