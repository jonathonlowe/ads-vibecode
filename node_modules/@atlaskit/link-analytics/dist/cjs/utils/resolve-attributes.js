...
exports.resolveAttributes = void 0;
var _regenerator = _interopRequireDefault(require("@babel/runtime/regenerator"));
var _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));
var _slicedToArray2 = _interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));
var _asyncToGenerator2 = _interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator"));
var _typeof2 = _interopRequireDefault(require("@babel/runtime/helpers/typeof"));
var _getResolvedAttributes = require("./get-resolved-attributes");
...
var hasMessage = function hasMessage(err) {
  return !!((0, _typeof2.default)(err) === 'object' && err && 'message' in err);
};
var hasType = function hasType(err) {
  return !!((0, _typeof2.default)(err) === 'object' && err && 'type' in err);
};
var getLinkData = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref, client, store) {
 ...
 */
var resolveAttributes = exports.resolveAttributes = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(linkDetails, client, store) {
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _yield$getLinkData2 = (0, _slicedToArray2.default)(_yield$getLinkData, 2);
          linkData = _yield$getLinkData2[0];
          status = _yield$getLinkData2[1];
          return _context2.abrupt("return", _objectSpread({}, (0, _getResolvedAttributes.getResolvedAttributes)(linkDetails, linkData, status)));
        case 7:
        case "end":
