  ...
  return (0, _createClass2.default)(SmartUserPickerWithoutAnalytics, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if ((this.state.sessionId !== prevState.sessionId || this.state.query !== prevState.query) && (this.state.query !== '' || !this.props.bootstrapOptions)) {
        ...
        if (![_ufo.UFOExperienceState.FAILED.id, _ufo.UFOExperienceState.SUCCEEDED.id, _ufo.UFOExperienceState.ABORTED.id].includes(this.optionsShownUfoExperienceInstance.state.id)) {
