...
export function createInputRulePlugin(pluginName, rules, options = {}) {
  const onInputEvent = options === null || options === void 0 ? void 0 : options.onInputEvent;
  const onBeforeRegexMatch = options === null || options === void 0 ? void 0 : options.onBeforeRegexMatch;
  const allowInsertTextOnDocument = Boolean(options === null || options === void 0 ? void 0 : options.allowInsertTextOnDocument);
