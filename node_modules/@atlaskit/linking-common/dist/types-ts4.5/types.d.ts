...
export type CardActionType = 'pending' | 'resolving' | 'resolved' | 'errored' | 'fallback' | 'reloading' | 'metadata';
export type CardType = 'pending' | 'resolving' | 'resolved' | 'errored' | 'fallback' | 'unauthorized' | 'forbidden' | 'not_found';
...
export type ProductType = 'CONFLUENCE' | 'ATLAS' | 'BITBUCKET' | 'TRELLO' | 'JSW' | 'JWM' | 'JSM' | 'JPD' | 'ELEVATE';
