...
import { mockedAvailableSitesResult, mockedAvailableSitesResultWithGatewayBaseUrl } from './available-sites-result';
var fetchAvailableSiteEndpoint = /\/gateway\/api\/available-sites/;
export var mockAvailableSites = function mockAvailableSites(responseData) {
 ...
 */
export var mockAvailableSitesForGatewayUrl = function mockAvailableSitesForGatewayUrl(gatewayBaseUrl) {
  fetchMock.post("".concat(gatewayBaseUrl, "/gateway/api/available-sites"), mockedAvailableSitesResultWithGatewayBaseUrl, {
    delay: 10,
    overwriteRoutes: true
  });
};
export var mockAvailableSitesWithError = function mockAvailableSitesWithError() {
