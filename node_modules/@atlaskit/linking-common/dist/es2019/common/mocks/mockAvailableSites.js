...
export const mockAvailableSites = responseData => {
 ...
 */
export const mockAvailableSitesForGatewayUrl = gatewayBaseUrl => {
  fetchMock.post(`${gatewayBaseUrl}/gateway/api/available-sites`, mockedAvailableSitesResultWithGatewayBaseUrl, {
    delay: 10,
    overwriteRoutes: true
  });
};
