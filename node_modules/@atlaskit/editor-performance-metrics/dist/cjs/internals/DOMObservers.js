...
exports.DOMObservers = void 0;
var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));
var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));
var _createBrowserObservers = require("./createBrowserObservers");
...
var DOMObservers = exports.DOMObservers = /*#__PURE__*/function () {
  function DOMObservers(_ref) {
    var _this = this;
    var onDOMContentChange = _ref.onDOMContentChange,
      onChange = _ref.onChange,
      timeline = _ref.timeline;
    (0, _classCallCheck2.default)(this, DOMObservers);
    this.mapVisibleNodeRects = new WeakMap();
    this.timeline = timeline;
    this.intersection = (0, _createBrowserObservers.createIntersectionObserver)({
    ...
    this.mutations = (0, _createBrowserObservers.createMutationObserver)({
    ...
    this.performance = (0, _createBrowserObservers.createPerformanceObserver)({
  ...
  return (0, _createClass2.default)(DOMObservers, [{
    key: "observe",
