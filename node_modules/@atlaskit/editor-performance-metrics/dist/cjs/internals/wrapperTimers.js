 ...
 * cleanup();
 */
var wrapperTimers = exports.wrapperTimers = function wrapperTimers(_ref) {
  ...
  var setTimeoutProxy = new Proxy(globalContext.setTimeout, {
    apply: function apply(target, thisArg, args) {
      ...
      timerId = target.apply(thisArg, [callbackProxy].concat((0, _toConsumableArray2.default)(args.slice(1))));
