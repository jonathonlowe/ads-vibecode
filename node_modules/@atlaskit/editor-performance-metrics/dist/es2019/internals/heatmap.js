...
export function transformHeatmap({
  ...
  const localHeatmap = heatmap.map;
  for (let row = roundedTop; row < roundedBottom; row++) {
    for (let col = roundedLeft; col < roundedRight; col++) {
      if (localHeatmap[row] === undefined || localHeatmap[row][col] === undefined) {
        ...
        const isSameDimensions = isRectInside(entry.rect, previousEntry === null || previousEntry === void 0 ? void 0 : previousEntry.rect) && isRectInside(previousEntry === null || previousEntry === void 0 ? void 0 : previousEntry.rect, entry.rect);
        const isSameElementName = entry.elementName === (previousEntry === null || previousEntry === void 0 ? void 0 : previousEntry.elementName);
...
export async function createHeatmapFromEvents(events, initialHeatmap) {
  const nextHeatmap = {
    ...initialHeatmap,
