...
export class TimelineController {
  ...
  getEventsPerType(type) {
    const r = this.eventsPerType.get(type) || [];
    return r;
  }
  onIdleBufferFlush(cb) {
  ...
  onceAllSubscribersCleaned(callback) {
    this.allSubscribersCleanedCallback = callback;
  }
  checkAllSubscribersCleared() {
  ...
  callOnNextIdleCallbacks(buffer) {
