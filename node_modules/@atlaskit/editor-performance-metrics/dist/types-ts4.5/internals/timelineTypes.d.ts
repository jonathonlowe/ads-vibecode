...
export type BasicEventTimestamp<name extends string, data = Record<string, string | number | undefined | null>> = {
    type: name;
    startTime: DOMHighResTimeStamp;
    data: data;
};
export type ElementChangedEvent = BasicEventTimestamp<'element:changed', {
...
export type AbortUserInteractionEvent = BasicEventTimestamp<'abort:user-interaction', {
    source: string;
}>;
...
export type IntersectionObserverVisibleNodesEvent = BasicEventTimestamp<'IntersectionObserver:VisibleNodes'>;
export type PerformanceFirstPaintEvent = BasicEventTimestamp<'performance:first-paint'>;
export type PerformanceFirstContentfulPaintEvent = BasicEventTimestamp<'performance:first-contentful-paint'>;
export type PerformanceLayoutShiftEvent = BasicEventTimestamp<'performance:layout-shift'>;
export type UserEvent = BasicEventTimestamp<`user-event:${UserEventCategory}`, {
    category: UserEventCategory;
    elementName: string;
    eventName: string;
    duration: number;
}>;
export type IdleTimeEvent = BasicEventTimestamp<'idle-time', {
    duration: number;
}>;
export type HoldIdleTimeoutEvent = BasicEventTimestamp<'hold-idle:timeout', {
    holdedAt: DOMHighResTimeStamp;
    uuid: string;
}>;
export type HoldIdleEventSources = 'setTimeout' | 'Promise' | 'fetch';
export type HoldIdleStartEvent = BasicEventTimestamp<'hold-idle:start', {
    source: HoldIdleEventSources;
    uuid: string;
}>;
export type HoldIdleEndEvent = BasicEventTimestamp<'hold-idle:end', {
    source: HoldIdleEventSources;
    duration: number;
    uuid: string;
}>;
export type TimelineEvent = ElementChangedEvent | AbortUserInteractionEvent | DOMMutationFinishedEvent | PerformanceLongTaskEvent | IntersectionObserverVisibleNodesEvent | PerformanceFirstPaintEvent | PerformanceFirstContentfulPaintEvent | PerformanceLayoutShiftEvent | IdleTimeEvent | UserEvent | HoldIdleTimeoutEvent | HoldIdleStartEvent | HoldIdleEndEvent;
export type ExtractEventNames<T> = T extends {
    type: infer U;
} ? U : never;
...
export type ExtractEventTypes<T, N extends string> = T extends {
    type: N;
} ? T : never;
