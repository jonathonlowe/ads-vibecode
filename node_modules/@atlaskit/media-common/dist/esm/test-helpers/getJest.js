...
var mockStub = function mockStub() {
  return Object.assign(function () {}, {
    ...
    mockImplementation: function mockImplementation(value) {},
    mockResolvedValue: function mockResolvedValue(value) {}
  });
};
var mockJest = function mockJest() {
  // eslint-disable-next-line no-console
  console.warn('Using mock jest. Please remove references to @atlaskit/media-client/test-helpers in non-test code.');
  return {
...
export var getJest = function getJest() {
