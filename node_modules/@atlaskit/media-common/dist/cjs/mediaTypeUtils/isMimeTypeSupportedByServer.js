...
var isImageMimeTypeSupportedByServer = exports.isImageMimeTypeSupportedByServer = function isImageMimeTypeSupportedByServer(mimeType) {
...
var isDocumentMimeTypeSupportedByServer = exports.isDocumentMimeTypeSupportedByServer = function isDocumentMimeTypeSupportedByServer(mimeType) {
  return [
  // Adobe PDF
...
var isAudioMimeTypeSupportedByServer = exports.isAudioMimeTypeSupportedByServer = function isAudioMimeTypeSupportedByServer(mimeType) {
...
var isVideoMimeTypeSupportedByServer = exports.isVideoMimeTypeSupportedByServer = function isVideoMimeTypeSupportedByServer(mimeType) {
...
var isUnknownMimeTypeSupportedByServer = exports.isUnknownMimeTypeSupportedByServer = function isUnknownMimeTypeSupportedByServer(mimeType) {
  return ['binary/octet-stream'].indexOf(mimeType.toLowerCase()) > -1;
};
var isMimeTypeSupportedByServer = exports.isMimeTypeSupportedByServer = function isMimeTypeSupportedByServer(mimeType) {
