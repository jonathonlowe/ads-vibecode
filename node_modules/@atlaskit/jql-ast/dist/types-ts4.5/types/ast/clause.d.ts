import { type CLAUSE_OPERATOR_NOT, type CLAUSE_TYPE_COMPOUND, type CLAUSE_TYPE_NOT, type CLAUSE_TYPE_TERMINAL, type NODE_TYPE_CLAUSE } from '../../constants';
 ...
 */
export interface CompoundClause extends AstNode<ParentOfClause & AstNode>, Removable, Replaceable<Clause>, ParentOfClause {
 ...
 */
export interface TerminalClause extends AstNode<ParentOfClause & AstNode>, Removable, Replaceable<Clause> {
    type: typeof NODE_TYPE_CLAUSE;
 ...
 */
export interface NotClause extends AstNode<ParentOfClause & AstNode>, Removable, Replaceable<Clause>, ParentOfClause {
    type: typeof NODE_TYPE_CLAUSE;
