...
export class OperatorVisitor extends JastBuildingVisitor {
  constructor(...args) {
    super(...args);
  ...
  visitJqlComparisonOperator(ctx) {
    const text = this.tokens.getText(ctx);
