 ...
 */
export const valueOperand = value => valueOperandInternal(value, sanitiseJqlString(value));
 ...
 */
export const valueOperandByText = text => valueOperandInternal(normaliseJqlString(text), text);
export const valueOperandInternal = (value, text, position = null) => ({
