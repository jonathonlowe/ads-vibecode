 ...
 */
export const argument = value => argumentInternal(value, sanitiseJqlString(value));
 ...
 */
export const argumentByText = text => argumentInternal(normaliseJqlString(text), text);
export const argumentInternal = (value, text, position = null) => ({
  text,
  value,
  position,
