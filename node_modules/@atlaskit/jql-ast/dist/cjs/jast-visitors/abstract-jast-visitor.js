...
exports.AbstractJastVisitor = void 0;
...
var AbstractJastVisitor = exports.AbstractJastVisitor = /*#__PURE__*/function () {
  function AbstractJastVisitor() {
    (0, _classCallCheck2.default)(this, AbstractJastVisitor);
  }
  (0, _createClass2.default)(AbstractJastVisitor, [{
    key: "visit",
    value:
    /**
    ...
    value: function visitChildren(node) {
      ...
      for (var i = 0; i < children.length; i++) {
        ...
        var childResult = children[i].accept(this);
