...
type AIProactiveApiPurgedAEP = OperationalAEP<ACTION.API_PURGED, ACTION_SUBJECT.EDITOR_PLUGIN_AI, ACTION_SUBJECT_ID.PROACTIVE_SUGGESTION, {
    reason: string;
    totalParts: number;
    totalPurgedParts: number;
}>;
type AIProactiveApiErrorAEP = OperationalAEP<ACTION.API_ERROR, ACTION_SUBJECT.EDITOR_PLUGIN_AI, ACTION_SUBJECT_ID.PROACTIVE_SUGGESTION, {
    error: string;
    reason: string;
    statusCode: number;
}>;
