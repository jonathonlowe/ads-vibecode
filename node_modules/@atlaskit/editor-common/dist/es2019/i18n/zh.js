...
export default {
  ...
  'fabric.editor.ai.config.item.enhance.improveWriting.description': '改进清晰度、条理性和语气，以提高吸引力并使其更易于理解',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': '无法获取回复。您的提示或回复超出了此请求的限制。请关闭该对话框，然后重试。',
  ...
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Atlassian Intelligence 目前没有任何建议。您可随意尝试其他提示或内容。',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': '通过增强的搜索、筛选和配置插入来自 Jira Cloud 的 Jira 工作项。',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {未找到与您的搜索条件相匹配的内容。} other {默认有 {count} 条建议。}}',
  ...
  'fabric.editor.toolbarAppears': '工具栏会显示',
