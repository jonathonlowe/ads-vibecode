...
export default {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'Створення вмісту для вставки в оновлення',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Створення відповіді на основі завдань, подібних до тих, над якими ви працюєте',
  'fabric.editor.ai.config.item.draftReply.title': 'Рекомендована відповідь',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.description': 'Виправлення орфографічних і граматичних помилок',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Орфографія та граматика',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': 'Виправлення орфографічних і граматичних помилок',
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Покращення зрозумілості, структури й тону тексту для його оптимального сприйняття',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Виберіть серед варіантів, наведених нижче (підказки в Elevate зараз вимкнено)',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Переклад тексту, з яким ви працюєте, китайською (спрощеною) мовою',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Мова перекладу: китайська (спрощена)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Переклад тексту, з яким ви працюєте, китайською (традиційною) мовою',
  ...
  'fabric.editor.ai.config.item.translateTo.dutch.description': 'Переклад тексту, з яким ви працюєте, голландською мовою',
  'fabric.editor.ai.config.item.translateTo.dutch.title': 'Мова перекладу: голландська',
  'fabric.editor.ai.config.item.translateTo.english.description': 'Переклад тексту, з яким ви працюєте, англійською мовою',
  ...
  'fabric.editor.ai.config.item.translateTo.french.description': 'Переклад тексту, з яким ви працюєте, французькою мовою',
  ...
  'fabric.editor.ai.config.item.translateTo.hungarian.description': 'Переклад тексту, з яким ви працюєте, угорською мовою',
  'fabric.editor.ai.config.item.translateTo.hungarian.title': 'Мова перекладу: угорська',
  'fabric.editor.ai.config.item.translateTo.italian.description': 'Переклад тексту, з яким ви працюєте, італійською мовою',
  'fabric.editor.ai.config.item.translateTo.italian.title': 'Мова перекладу: італійська',
  'fabric.editor.ai.config.item.translateTo.japanese.description': 'Переклад тексту, з яким ви працюєте, японською мовою',
  'fabric.editor.ai.config.item.translateTo.japanese.title': 'Мова перекладу: японська',
  'fabric.editor.ai.config.item.translateTo.korean.description': 'Переклад тексту, з яким ви працюєте, корейською мовою',
  'fabric.editor.ai.config.item.translateTo.korean.title': 'Мова перекладу: корейська',
  'fabric.editor.ai.config.item.translateTo.norwegian.description': 'Переклад тексту, з яким ви працюєте, норвезькою мовою',
  ...
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Переклад тексту, з яким ви працюєте, португальською (бразильською) мовою',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.title': 'Мова перекладу: португальська (бразильська)',
  'fabric.editor.ai.config.item.translateTo.russian.description': 'Переклад тексту, з яким ви працюєте, російською мовою',
  'fabric.editor.ai.config.item.translateTo.russian.title': 'Мова перекладу: російська',
  'fabric.editor.ai.config.item.translateTo.spanish.description': 'Переклад тексту, над яким ви працюєте, на іспанську мову',
  'fabric.editor.ai.config.item.translateTo.spanish.title': 'Перекласти на іспанську',
  'fabric.editor.ai.config.item.translateTo.swedish.description': 'Переклад тексту, з яким ви працюєте, шведською мовою',
  ...
  'fabric.editor.ai.config.item.translateTo.turkish.description': 'Переклад тексту, з яким ви працюєте, турецькою мовою',
  'fabric.editor.ai.config.item.translateTo.turkish.title': 'Мова перекладу: турецька',
  'fabric.editor.ai.config.item.translateTo.ukrainian.description': 'Переклад тексту, з яким ви працюєте, українською мовою',
  'fabric.editor.ai.config.item.translateTo.ukrainian.title': 'Мова перекладу: українська',
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Переклад тексту, з яким ви працюєте, в’єтнамською мовою',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Не вдалося завантажити відповідь. Ваші введені дані або відповідь перевищили обмеження для цього запиту. Закрийте діалогове вікно й повторіть спробу.',
  'fabric.editor.ai.experience-application.unhandledErrorMessage': 'Сталася помилка. Закрийте діалогове вікно й повторіть спробу.',
  ...
  'fabric.editor.ai.experience.messageTemplateNextBestTask': 'Пошук: зачекайте хвилинку, поки ми шукаємо відповідний вміст у Jira.',
  'fabric.editor.ai.experience.messageTemplatePageHydration': 'Пошук: зачекайте хвилинку, поки ми шукаємо відповідний вміст на сторінці.',
  'fabric.editor.ai.experience.noResultsSuggestion': 'Немає результатів',
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Зараз Atlassian Intelligence не має пропозицій. Спробуйте використати інший запит або вміст.',
  ...
  'fabric.editor.configPanel.errorBoundary.note': 'Ми повідомили команду. Ви можете відредагувати й опублікувати цю сторінку або ж переглянути докладну інформацію в консолі помилок.',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Вставте елементи завдання Jira з Jira Cloud із розширеним пошуком, фільтрацією та конфігурацією.',
  ...
  'fabric.editor.floatingToolbar.confirmModalConnectedUnit': '{amount, plural, =0 {{name}} one {{name} (і ще {amount,number} пов’язаний елемент)} few {{name} (і ще {amount,number} пов’язані елементи)} many {{name} (і ще {amount,number} пов’язаних елементів)} other {{name} (і ще {amount,number} пов’язаного елементу)}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'На жаль, ми не можемо додати це посилання на зображення. Завантажте зображення, а потім перетягніть на сторінку.',
  'fabric.editor.media.insert.fromUrlWarning': 'Це зображення може не відображатися для інших через обмеження щодо його джерела. Спробуйте натомість передати файл.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Помилка передавання файлу. Перевірте правильність шляху до файлу або наявність підключення до мережі.',
