...
export default {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'アップデートに挿入するコンテンツを生成します',
  ...
  'fabric.editor.ai.config.item.changeTone.professionalTone.description': 'コンテンツのトーンを職務的なものに変更します',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'あなたが取り組んでいる課題に類似する課題に基づいて返信の下書きを作成します',
  ...
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'エンゲージメントと理解を促進するため、明瞭さ、構成、トーンを改善します',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': '以下から選択してください (自由形式の生成は現在 Elevate で無効になっています)',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': '作業中のテキストを中国語 (簡体字) に翻訳します',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': '中国語 (簡体字) に翻訳',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': '作業中のテキストを中国語 (繁体字) に翻訳します',
  ...
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': '作業中のテキストをポルトガル語 (ブラジル) に翻訳します',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': '応答を取得できませんでした。プロンプトまたは応答が、このリクエストの制限を超えていました。ダイアログを閉じて、もう一度お試しください。',
  'fabric.editor.ai.experience-application.unhandledErrorMessage': '問題が発生しました。ダイアログを閉じて、もう一度お試しください。',
  ...
  'fabric.editor.ai.experience.responseTooSimilarMessage': '現時点で Atlassian Intelligence からの提案はありません。別のプロンプトまたはコンテンツをお気軽にお試しください。',
  ...
  'fabric.editor.ai.experience.suggestionGroupHeading.useRovoAgentsCount': 'Rovo エージェント ({numberOfAgents} 個) を使用',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': '強化された検索、フィルタリング、構成を使用して、Jira Cloud から Jira 作業項目を挿入します。',
