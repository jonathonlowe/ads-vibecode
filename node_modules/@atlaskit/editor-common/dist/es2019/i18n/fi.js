...
export default {
  ...
  'fabric.editor.ai.config.item.convertToTable.description': 'Muotoilee sisällön uudelleen otsikoilla varustetuksi taulukoksi.',
  'fabric.editor.ai.config.item.convertToTable.title': 'Muunna taulukoksi',
  'fabric.editor.ai.config.item.draftReply.description': 'Luonnostelee vastauksen työstämäsi asian kanssa samankaltaisten asioiden perusteella',
  ...
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Kirjoitusasu ja kielioppi',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': 'Korjaa kirjoitusasu ja kielioppi',
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Parantaa sisällön selkeyttä, rakennetta ja sävyä, jotta se olisi helpompi ymmärtää',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Valitse alta (vapaa luonti on poistettu käytöstä Elevatessa tällä hetkellä)',
  'fabric.editor.ai.config.item.generateContent.promptHint': 'Kirjoita AI:n avulla tai valitse alta',
  'fabric.editor.ai.config.item.improveDescription.default.description': 'Järjestele asian kuvaus uudelleen asiatyypin perusteella',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Kääntää työstämäsi tekstin kiinaksi (yksinkertaistettu).',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Käännä kiinaksi (yksinkertaistettu)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Kääntää työstämäsi tekstin kiinaksi (perinteinen).',
  ...
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Kääntää työstämäsi tekstin portugaliksi (Brasilia).',
  ...
  'fabric.editor.ai.experience-application.documentInsertError': 'Vastauksen lisääminen ei onnistu. Sulje ikkuna ja yritä uudelleen.',
  'fabric.editor.ai.experience-application.error-boundary.markdownErrorMessage': 'Esikatselun luominen ei onnistu. Sulje ikkuna ja yritä uudelleen.',
  'fabric.editor.ai.experience-application.rateLimitEnforced': 'Atlassian Intelligencelle (AI) vastaanotettiin liian monta pyyntöä. Yritä uudelleen muutaman minuutin kuluttua tai lue <link>AI:n liikakäytöstä</link>',
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Vastausta ei saatu. Kehotteesi tai vastauksesi ylitti tämän pyynnön rajan. Sulje ikkuna ja yritä uudelleen.',
  ...
  'fabric.editor.ai.experience.aupViolationMessage': 'Kehotteesi tai sisältösi eivät välttämättä ole hyväksyttävän käytön käytäntömme mukaisia. Tarkista molemmat ja lue tarvittaessa <link>käyttösääntömme</link>. Jos ongelma jatkuu, kokeile toista kehotetta tai sisältöä.',
  ...
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Atlassian Intelligencellä ei ole tällä hetkellä ehdotuksia. Voit kokeilla vapaasti toista kehotetta tai sisältöä.',
  ...
  'fabric.editor.ai.screens.preview.convoAIBeta': 'Sisällönluontipyynnöt, joissa viitataan URL-osoitteisiin, ovat beetavaiheessa.',
  ...
  'fabric.editor.columns.advanced.layout.description': '{numberOfColumns, plural, one {Lisää {numberOfColumns} yhtä suuri sarake} other {Lisää {numberOfColumns} yhtä suurta saraketta}}',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Lisää Jira-työtehtäviä Jira Cloudista parannetulla haulla, suodatuksella ja määrityksellä.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Ei hakutuloksia.} one {{count} ehdotus käytettävissä oletusarvoisesti.} other {{count} ehdotusta käytettävissä oletusarvoisesti.}}',
  'fabric.editor.elementbrowser.searchbar.assistive.text.result': '{count, plural, =0 {Ei hakutuloksia.} one {{count} ehdotus käytettävissä kirjoitettua tekstiä varten.} other {{count} ehdotusta käytettävissä kirjoitettua tekstiä varten.}}',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Tiedoston lähetysvirhe. Tarkista tiedostopolku tai verkko.',
