...
export default {
  ...
  'fabric.editor.configPanel.errorBoundary.note': 'Vi har meddelat teamet. Du kan fortfarande redigera och publicera sidan eller kontrollera felkonsolen för mer information.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Ingenting matchar din sökning.} one {{count} förslag tillgängligt som standard.} other {{count} förslag tillgängliga som standard.}}',
  ...
  'fabric.editor.floatingToolbar.confirmModalConnectedUnit': '{amount, plural, =0 {{name}} one {{name} (+1 anslutet element)} other {{name} (+{amount,number} anslutna element)}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'Vi kan tyvärr inte lägga till den här bildlänken. Ladda ner bilden och dra och släpp den på sidan.',
  'fabric.editor.media.insert.fromUrlWarning': 'Bilden kanske inte är synlig för andra på grund av källbegränsningar. Överväg att ladda upp filen istället.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Fel vid filuppladdning. Kontrollera filsökvägen eller nätverket.',
