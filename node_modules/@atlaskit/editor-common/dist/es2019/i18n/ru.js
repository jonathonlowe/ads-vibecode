...
export default {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'Генерирует контент для вставки в обновление',
  ...
  'fabric.editor.ai.config.item.changeTone.professionalTone.description': 'Изменяет стиль контента на профессиональный.',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Составляет ответ на основе задач, похожих на ту, над которой вы работаете.',
  'fabric.editor.ai.config.item.draftReply.title': 'Составить ответ',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.description': 'Исправляет орфографические и грамматические ошибки.',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Орфография и грамматика',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': 'Исправить орфографию и грамматику',
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Улучшает четкость, структуру и стиль текста, чтобы сделать его более интересным и понятным.',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Выберите из списка ниже (свободная генерация в Elevate в настоящее время отключена).',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Перевод текста, над которым вы работаете, на китайский язык (упрощенный вариант)',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Перевести на китайский (упрощенный)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Перевод текста, над которым вы работаете, на китайский язык (традиционный)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.title': 'Перевести на китайский (традиционный)',
  'fabric.editor.ai.config.item.translateTo.czech.description': 'Перевод текста, над которым вы работаете, на чешский язык',
  'fabric.editor.ai.config.item.translateTo.czech.title': 'Перевести на чешский',
  'fabric.editor.ai.config.item.translateTo.danish.description': 'Перевод текста, над которым вы работаете, на датский язык',
  'fabric.editor.ai.config.item.translateTo.danish.title': 'Перевести на датский',
  'fabric.editor.ai.config.item.translateTo.dutch.description': 'Перевод текста, над которым вы работаете, на голландский язык',
  'fabric.editor.ai.config.item.translateTo.dutch.title': 'Перевести на голландский',
  'fabric.editor.ai.config.item.translateTo.english.description': 'Перевод текста, над которым вы работаете, на английский язык',
  'fabric.editor.ai.config.item.translateTo.english.title': 'Перевести на английский',
  'fabric.editor.ai.config.item.translateTo.finnish.description': 'Перевод текста, над которым вы работаете, на финский язык',
  'fabric.editor.ai.config.item.translateTo.finnish.title': 'Перевести на финский',
  'fabric.editor.ai.config.item.translateTo.french.description': 'Перевод текста, над которым вы работаете, на французский язык',
  'fabric.editor.ai.config.item.translateTo.french.title': 'Перевести на французский',
  'fabric.editor.ai.config.item.translateTo.german.description': 'Перевод текста, над которым вы работаете, на немецкий язык',
  'fabric.editor.ai.config.item.translateTo.german.title': 'Перевести на немецкий',
  'fabric.editor.ai.config.item.translateTo.hungarian.description': 'Перевод текста, над которым вы работаете, на венгерский язык',
  'fabric.editor.ai.config.item.translateTo.hungarian.title': 'Перевести на венгерский',
  'fabric.editor.ai.config.item.translateTo.italian.description': 'Перевод текста, над которым вы работаете, на итальянский язык',
  'fabric.editor.ai.config.item.translateTo.italian.title': 'Перевести на итальянский',
  'fabric.editor.ai.config.item.translateTo.japanese.description': 'Перевод текста, над которым вы работаете, на японский язык',
  'fabric.editor.ai.config.item.translateTo.japanese.title': 'Перевести на японский',
  'fabric.editor.ai.config.item.translateTo.korean.description': 'Перевод текста, над которым вы работаете, на корейский язык',
  'fabric.editor.ai.config.item.translateTo.korean.title': 'Перевести на корейский',
  'fabric.editor.ai.config.item.translateTo.norwegian.description': 'Перевод текста, над которым вы работаете, на норвежский язык',
  'fabric.editor.ai.config.item.translateTo.norwegian.title': 'Перевести на норвежский',
  'fabric.editor.ai.config.item.translateTo.polish.description': 'Перевод текста, над которым вы работаете, на польский язык',
  'fabric.editor.ai.config.item.translateTo.polish.title': 'Перевести на польский',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Перевод текста, над которым вы работаете, на португальский язык (бразильский вариант)',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.title': 'Перевести на португальский (бразильский)',
  'fabric.editor.ai.config.item.translateTo.russian.description': 'Перевод текста, над которым вы работаете, на русский язык',
  'fabric.editor.ai.config.item.translateTo.russian.title': 'Перевести на русский',
  'fabric.editor.ai.config.item.translateTo.spanish.description': 'Перевод текста, над которым вы работаете, на испанский язык',
  'fabric.editor.ai.config.item.translateTo.spanish.title': 'Перевод на испанский',
  'fabric.editor.ai.config.item.translateTo.swedish.description': 'Перевод текста, над которым вы работаете, на шведский язык',
  'fabric.editor.ai.config.item.translateTo.swedish.title': 'Перевести на шведский',
  'fabric.editor.ai.config.item.translateTo.thai.description': 'Перевод текста, над которым вы работаете, на тайский язык',
  'fabric.editor.ai.config.item.translateTo.thai.title': 'Перевести на тайский',
  'fabric.editor.ai.config.item.translateTo.turkish.description': 'Перевод текста, над которым вы работаете, на турецкий язык',
  'fabric.editor.ai.config.item.translateTo.turkish.title': 'Перевести на турецкий',
  'fabric.editor.ai.config.item.translateTo.ukrainian.description': 'Перевод текста, над которым вы работаете, на украинский язык',
  'fabric.editor.ai.config.item.translateTo.ukrainian.title': 'Перевести на украинский',
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Перевод текста, над которым вы работаете, на вьетнамский язык',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Не удалось получить ответ. Ваш запрос или ответ превысили ограничение для данного запроса. Закройте окно и повторите попытку.',
  'fabric.editor.ai.experience-application.unhandledErrorMessage': 'Произошла ошибка. Закройте диалоговое окно и повторите попытку.',
  ...
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Пока у Atlassian Intelligence нет предложений. Попробуйте использовать другой запрос или контент.',
  ...
  'fabric.editor.configPanel.errorBoundary.note': 'Мы сообщили об этом команде. Вы можете отредактировать и опубликовать эту страницу или просмотреть дополнительную информацию на консоли ошибок.',
  ...
  'fabric.editor.datasource.confluenceSearch.description': 'Вставка списка результатов поиска из Confluence с использованием возможностей расширенного поиска, фильтрации и настройки.',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Вставляйте задачи Jira из Jira Cloud с помощью расширенного поиска, фильтрации и настройки.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {По вашему запросу ничего не найдено.} one {По умолчанию доступен {count} вариант.} few {По умолчанию доступно {count} варианта.} many {По умолчанию доступно {count} вариантов.} other {По умолчанию доступно {count} варианта.}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'Невозможно добавить изображение по этой ссылке. Загрузите изображение, а затем перетащите его на страницу.',
  'fabric.editor.media.insert.fromUrlWarning': 'Это изображение может быть скрыто от других пользователей из-за ограничений источника. Вместо этого попробуйте загрузить файл.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Ошибка загрузки файла. Проверьте путь к файлу или подключение к сети.',
  ...
  'fabric.editor.toolbarAppears': 'Панель инструментов появится',
  'fabric.editor.toolbarLabel': 'Редактор',
  'fabric.editor.toolbarMediaTitle': 'Добавить изображение, видео или файл',
  'fabric.editor.toolbarPositionFixedAtTop': 'Закрепить наверху',
  'fabric.editor.toolbarPositionInline': 'В тексте',
  ...
  'fabric.editor.upDown': 'Используйте клавиши со стрелками вверх и вниз в следующем поле ввода, чтобы изменить дату ниже',
