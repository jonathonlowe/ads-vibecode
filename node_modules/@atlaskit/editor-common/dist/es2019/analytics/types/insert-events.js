export let USER_CONTEXT = /*#__PURE__*/function (USER_CONTEXT) {
  USER_CONTEXT["EDIT"] = "edit";
  USER_CONTEXT["NEW"] = "new";
  return USER_CONTEXT;
}({});
export let LINK_STATUS = /*#__PURE__*/function (LINK_STATUS) {
  LINK_STATUS["RESOLVED"] = "resolved";
  LINK_STATUS["UNRESOLVED"] = "unresolved";
  return LINK_STATUS;
}({});
export let LINK_REPRESENTATION = /*#__PURE__*/function (LINK_REPRESENTATION) {
...
export let LINK_RESOURCE = /*#__PURE__*/function (LINK_RESOURCE) {
