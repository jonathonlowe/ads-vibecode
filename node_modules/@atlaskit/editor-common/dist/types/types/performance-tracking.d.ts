...
export type StartedTracking = {
    /**
     * @description Control whether editor.started event tracking should be enabled
     */
    enabled?: boolean;
};
export type ErrorTracking = {
    /**
     * @description Control whether editor.unhandledErrorCaught crash events tracking should be enabled
     */
    enabled?: boolean;
};
export type PerformanceTracking = {
    ...
    /**
     * @description Control whether the editor.started event is tracked.
     */
