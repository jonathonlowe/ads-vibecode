...
exports.visuallyHiddenStyles = exports.messages = exports.default = exports.RECENT_SEARCH_LIST_SIZE = exports.HyperlinkLinkAddToolbarWithIntl = exports.HyperlinkLinkAddToolbar = void 0;
...
var containerPadding = (0, _react2.css)({
...
var HyperlinkLinkAddToolbar = exports.HyperlinkLinkAddToolbar = /*#__PURE__*/function (_PureComponent) {
  function HyperlinkLinkAddToolbar(props) {
    ...
    (0, _defineProperty2.default)(_this, "submitted", false);
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              searchItems = limit((0, _utils2.filterUniqueItems)([].concat((0, _toConsumableArray2.default)(items), (0, _toConsumableArray2.default)(searchProviderResultItems.map(mapSearchProviderResultToLinkSearchItemData))), function (firstItem, secondItem) {
    ...
    (0, _defineProperty2.default)(_this, "updateInput", /*#__PURE__*/function () {
    ...
    (0, _defineProperty2.default)(_this, "createClearHandler", function (field) {
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _context3.t3 = (0, _defineProperty2.default)({}, field, '');
              if (!activityProvider) {
                _context3.next = 15;
                break;
              }
    ...
    (0, _defineProperty2.default)(_this, "getScreenReaderText", function () {
    ...
    (0, _defineProperty2.default)(_this, "handleSelected", function (href, text) {
      _this.handleInsert(href, text, _analytics.INPUT_METHOD.TYPEAHEAD, 'click');
    });
    (0, _defineProperty2.default)(_this, "handleInsert", function (href, title, inputType, interaction) {
    ...
    (0, _defineProperty2.default)(_this, "handleMouseEnterResultItem", function (objectId) {
    ...
    (0, _defineProperty2.default)(_this, "handleMouseLeaveResultItem", function (objectId) {
    ...
    (0, _defineProperty2.default)(_this, "handleClearTextKeyDown", function (event) {
      var KEY_CODE_TAB = 9;
      ...
      if (keyCode === KEY_CODE_TAB) {
        if (!_this.submitted) {
          ...
          var url = (0, _utils.normalizeUrl)(displayUrl);
          _this.handleInsert(url, displayText || displayUrl, _analytics.INPUT_METHOD.MANUAL, 'notselected');
        }
    ...
    (0, _defineProperty2.default)(_this, "updateTextInput", function (displayText) {
      _this.setState({
    ...
    // Ignored via go/ees005
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (0, _defineProperty2.default)(_this, "handleCancel", function (e) {
  ...
  return (0, _createClass2.default)(HyperlinkLinkAddToolbar, [{
