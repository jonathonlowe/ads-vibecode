...
var mapContentTypeToIcon = exports.mapContentTypeToIcon = {
...
var sha1 = exports.sha1 = function sha1(input) {
  return _rusha.default.createHash().update(input).digest('hex');
};
var wordCount = exports.wordCount = function wordCount(input) {
