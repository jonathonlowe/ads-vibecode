...
var _default = exports.default = {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'Gera conteúdo para ser inserido na atualização',
  ...
  'fabric.editor.ai.config.item.bb.pr.description.description': 'Cria uma descrição de pull request com um resumo das alterações',
  ...
  'fabric.editor.ai.config.item.changeTone.empatheticTone.description': 'Altera o tom do conteúdo para demonstrar empatia',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Elabora uma resposta com base em itens similares ao que você está trabalhando',
  ...
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Gramática e ortografia',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': 'Corrigir gramática e ortografia',
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Melhora a clareza, a estrutura e o tom para gerar mais engajamento e facilitar a compreensão',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Selecione abaixo (a geração gratuita está desativada no Elevate no momento)',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Traduz o texto do trabalho atual para o chinês (simplificado)',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Traduzir para chinês (simplificado)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Traduz o texto do trabalho atual para o chinês (tradicional)',
  ...
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Traduz o texto do trabalho atual para o português (BR)',
  ...
  'fabric.editor.ai.config.item.translateTo.spanish.description': 'Traduz o texto que você está trabalhando para o espanhol',
  ...
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Traduz o texto do trabalho atual para o vietnamita',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Não foi possível obter uma resposta. A solicitação ou resposta estava acima do limite dessa solicitação. Feche a caixa de diálogo e tente de novo.',
  'fabric.editor.ai.experience-application.unhandledErrorMessage': 'A gente está com problemas. Feche a caixa de diálogo e tente de novo.',
  ...
  'fabric.editor.ai.experience.messageTemplateContentSearch': 'Pesquisando: um momento enquanto a gente pesquisa informações.',
  'fabric.editor.ai.experience.messageTemplateNextBestTask': 'Pesquisando: um momento enquanto a gente pesquisa no Jira.',
  'fabric.editor.ai.experience.messageTemplatePageHydration': 'Pesquisando: um momento enquanto a gente pesquisa na página.',
  'fabric.editor.ai.experience.noResultsSuggestion': 'Sem resultados',
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'O Atlassian Intelligence não tem sugestões no momento. Use um prompt ou conteúdo diferente.',
  ...
  'fabric.editor.configPanel.errorBoundary.note': 'A gente informou a equipe. Você ainda pode editar e publicar esta página ou verificar o console de erros para obter mais informações.',
  ...
  'fabric.editor.datasource.confluenceSearch.description': 'Insira uma lista de resultados de pesquisa do Confluence com pesquisa, filtragem e configuração aprimoradas.',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Insira tickets do Jira a partir do Jira Cloud com ferramentas aprimoradas de pesquisa, filtro e configuração.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Nada corresponde à pesquisa.} one {{count} sugestão disponível por padrão.} other {{count} sugestões disponíveis por padrão.}}',
  'fabric.editor.elementbrowser.searchbar.assistive.text.result': '{count, plural, =0 {Nada corresponde à pesquisa.} one {{count} sugestão disponível para texto digitado.} other {{count} sugestões disponíveis para texto digitado.}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'Não foi possível adicionar o link desta imagem. Faça download do arquivo, então arraste e solte a imagem na página.',
  'fabric.editor.media.insert.fromUrlWarning': 'Talvez esta imagem não fique visível para outras pessoas devido a restrições da fonte. Faça upload do arquivo.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Erro ao carregar o arquivo. Verifique o caminho ou rede do arquivo.',
  ...
  'fabric.editor.requestToEditDescription': 'Ao solicitar acesso, o proprietário da página vai receber uma notificação.',
  ...
  'fabric.editor.upDown': 'Ao usar as teclas de seta para cima e para baixo no seguinte campo de entrada, a data vai ser atualizada abaixo',
