...
var _default = exports.default = {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'Génère du contenu à insérer dans la mise à jour',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Rédige une ébauche de réponse basée sur des tickets semblables à celui sur lequel vous travaillez',
  'fabric.editor.ai.config.item.draftReply.title': 'Rédiger une ébauche de réponse',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.description': "Corrige les erreurs d'orthographe et de grammaire",
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Orthographe et grammaire',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': "Corriger l'orthographe et la grammaire",
  'fabric.editor.ai.config.item.enhance.improveWriting.description': "Améliore la clarté, la structure et le style pour améliorer l'engagement et la compréhension",
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Faites votre choix ci-dessous (la génération libre est désactivée dans Elevate pour le moment)',
  'fabric.editor.ai.config.item.generateContent.promptHint': "Écrivez avec AI ou sélectionnez l'une des options ci-dessous",
  'fabric.editor.ai.config.item.improveDescription.default.description': 'Restructurez la description du ticket en fonction de son type',
  'fabric.editor.ai.config.item.improveDescription.default.title.experiment.one': 'Améliorer la description',
  'fabric.editor.ai.config.item.makeLonger.description': 'Développe le contenu en fonction du contexte que vous fournissez',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Traduit le texte sur lequel vous travaillez en chinois (simplifié)',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Traduire en chinois (simplifié)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Traduit le texte sur lequel vous travaillez en chinois (traditionnel)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.title': 'Traduire en chinois (traditionnel)',
  'fabric.editor.ai.config.item.translateTo.czech.description': 'Traduit le texte sur lequel vous travaillez en tchèque',
  'fabric.editor.ai.config.item.translateTo.czech.title': 'Traduire en tchèque',
  'fabric.editor.ai.config.item.translateTo.danish.description': 'Traduit le texte sur lequel vous travaillez en danois',
  'fabric.editor.ai.config.item.translateTo.danish.title': 'Traduire en danois',
  'fabric.editor.ai.config.item.translateTo.dutch.description': 'Traduit le texte sur lequel vous travaillez en néerlandais',
  'fabric.editor.ai.config.item.translateTo.dutch.title': 'Traduire en néerlandais',
  'fabric.editor.ai.config.item.translateTo.english.description': 'Traduit le texte sur lequel vous travaillez en anglais',
  'fabric.editor.ai.config.item.translateTo.english.title': 'Traduire en anglais',
  'fabric.editor.ai.config.item.translateTo.finnish.description': 'Traduit le texte sur lequel vous travaillez en finnois',
  'fabric.editor.ai.config.item.translateTo.finnish.title': 'Traduire en finnois',
  'fabric.editor.ai.config.item.translateTo.french.description': 'Traduit le texte sur lequel vous travaillez en français',
  'fabric.editor.ai.config.item.translateTo.french.title': 'Traduire en français',
  'fabric.editor.ai.config.item.translateTo.german.description': 'Traduit le texte sur lequel vous travaillez en allemand',
  'fabric.editor.ai.config.item.translateTo.german.title': 'Traduire en allemand',
  'fabric.editor.ai.config.item.translateTo.hungarian.description': 'Traduit le texte sur lequel vous travaillez en hongrois',
  'fabric.editor.ai.config.item.translateTo.hungarian.title': 'Traduire en hongrois',
  'fabric.editor.ai.config.item.translateTo.italian.description': 'Traduit le texte sur lequel vous travaillez en italien',
  'fabric.editor.ai.config.item.translateTo.italian.title': 'Traduire en italien',
  'fabric.editor.ai.config.item.translateTo.japanese.description': 'Traduit le texte sur lequel vous travaillez en japonais',
  'fabric.editor.ai.config.item.translateTo.japanese.title': 'Traduire en japonais',
  'fabric.editor.ai.config.item.translateTo.korean.description': 'Traduit le texte sur lequel vous travaillez en coréen',
  'fabric.editor.ai.config.item.translateTo.korean.title': 'Traduire en coréen',
  'fabric.editor.ai.config.item.translateTo.norwegian.description': 'Traduit le texte sur lequel vous travaillez en norvégien',
  'fabric.editor.ai.config.item.translateTo.norwegian.title': 'Traduire en norvégien',
  'fabric.editor.ai.config.item.translateTo.polish.description': 'Traduit le texte sur lequel vous travaillez en polonais',
  'fabric.editor.ai.config.item.translateTo.polish.title': 'Traduire en polonais',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Traduit le texte sur lequel vous travaillez en portugais (brésilien)',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.title': 'Traduire en portugais (brésilien)',
  'fabric.editor.ai.config.item.translateTo.russian.description': 'Traduit le texte sur lequel vous travaillez en russe',
  'fabric.editor.ai.config.item.translateTo.russian.title': 'Traduire en russe',
  'fabric.editor.ai.config.item.translateTo.spanish.description': 'Traduit le texte sur lequel vous travaillez en espagnol',
  'fabric.editor.ai.config.item.translateTo.spanish.title': 'Traduire en espagnol',
  'fabric.editor.ai.config.item.translateTo.swedish.description': 'Traduit le texte sur lequel vous travaillez en suédois',
  ...
  'fabric.editor.ai.config.item.translateTo.ukrainian.description': 'Traduit le texte sur lequel vous travaillez en ukrainien',
  'fabric.editor.ai.config.item.translateTo.ukrainian.title': 'Traduire en ukrainien',
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Traduit le texte sur lequel vous travaillez en vietnamien',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': "Impossible d'obtenir une réponse. Votre invite ou votre réponse a dépassé la limite fixée pour cette demande. Fermez la boîte de dialogue et réessayez.",
  'fabric.editor.ai.experience-application.unhandledErrorMessage': 'Nous rencontrons un problème. Fermez la boîte de dialogue et réessayez.',
  ...
  'fabric.editor.ai.experience.messageTemplateContentSearch': 'Recherche : veuillez patienter pendant que nous recherchons des informations.',
  'fabric.editor.ai.experience.messageTemplateNextBestTask': 'Recherche : veuillez patienter pendant que nous recherchons dans Jira.',
  'fabric.editor.ai.experience.messageTemplatePageHydration': 'Recherche : veuillez patienter pendant que nous recherchons dans la page.',
  'fabric.editor.ai.experience.noResultsSuggestion': 'Aucun résultat',
  'fabric.editor.ai.experience.responseTooSimilarMessage': "Atlassian Intelligence n'a aucune suggestion pour le moment. N'hésitez pas à essayer une autre invite ou un autre contenu.",
  ...
  'fabric.editor.ai.screens.preview.convoAIBeta': 'Les demandes de génération de contenu faisant référence à des URL sont disponibles en version bêta.',
  ...
  'fabric.editor.columns.advanced.layout.description': '{numberOfColumns, plural, one {Insérer {numberOfColumns} colonne uniforme} other {Insérer {numberOfColumns} colonnes uniformes}}',
  ...
  'fabric.editor.configPanel.errorBoundary.note': "Nous avons informé l'équipe. Vous pouvez toujours modifier et publier cette page, ou consulter la console d'erreur pour en savoir plus.",
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Insérez des tickets Jira à partir de Jira Cloud grâce à la recherche, au filtrage et à la configuration améliorés.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Aucun résultat pour votre recherche.} one {{count} suggestion disponible par défaut.} other {{count} suggestions disponibles par défaut.}}',
  'fabric.editor.elementbrowser.searchbar.assistive.text.result': '{count, plural, =0 {Aucun résultat pour votre recherche.} one {{count} suggestion disponible pour le texte saisi.} other {{count} suggestions disponibles pour le texte saisi.}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': "Malheureusement, nous ne pouvons pas ajouter le lien vers cette image. Téléchargez l'image, puis faites-la glisser sur la page.",
  'fabric.editor.media.insert.fromUrlWarning': "Cette image n'est peut-être pas visible pour les autres en raison de restrictions source. Envisagez plutôt d'importer le fichier.",
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': "Erreur de chargement du fichier. Vérifiez le chemin d'accès au fichier ou le réseau.",
  ...
  'fabric.editor.replaceSuccess': '{numberOfMatches, plural, one {{numberOfMatches,number} correspondance remplacée} other {{numberOfMatches,number} correspondances remplacées}}',
