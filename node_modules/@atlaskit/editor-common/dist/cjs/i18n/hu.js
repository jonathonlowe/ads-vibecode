...
var _default = exports.default = {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'A frissítésbe beszúrható tartalmat hoz létre',
  ...
  'fabric.editor.ai.config.item.bb.pr.description.description': 'A módosítások összefoglalásával hozza létre a pull-kérelem leírását',
  'fabric.editor.ai.config.item.bb.pr.description.title': 'Pull-kérelem leírásának létrehozása',
  'fabric.editor.ai.config.item.brainstorm.description': 'Összeállít egy listát az általad megadott témakörrel kapcsolatos ötletekről',
  ...
  'fabric.editor.ai.config.item.changeTone.professionalTone.description': 'Professzionális hangnemben írja át a tartalmat',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Választ ír az aktuálisan érintett ügyhöz hasonló ügyek alapján',
  ...
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Helyesírás és nyelvtan',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': 'Helyesírás és nyelvtan javítása',
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Egyértelműbbé teszi a szöveget, és javít a felépítésén és a hangnemén, hogy érthetőbbé és figyelemfelkeltőbbé tegye',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Válassz az alábbiak közül (a szabad generálás jelenleg le van tiltva az Elevate-ben)',
  'fabric.editor.ai.config.item.generateContent.promptHint': 'Írj valamit az AI segítségével, vagy válassz az alábbiak közül',
  'fabric.editor.ai.config.item.improveDescription.default.description': 'Az ügyleírás átstrukturálása az ügytípus alapján',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Lefordítja egyszerűsített kínaira a szöveget, amelyen dolgozol',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Fordítás kínai (egyszerűsített) nyelvre',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Lefordítja hagyományos kínaira a szöveget, amelyen dolgozol',
  ...
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Lefordítja brazíliai portugálra a szöveget, amelyen dolgozol',
  ...
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Lefordítja vietnámira a szöveget, amelyen dolgozol',
  ...
  'fabric.editor.ai.experience-application.documentInsertError': 'Problémába ütköztünk a válasz beszúrásakor. Zárd be a párbeszédpanelt, és próbálkozz újra.',
  'fabric.editor.ai.experience-application.error-boundary.markdownErrorMessage': 'Problémába ütköztünk az előnézet létrehozásakor. Zárd be a párbeszédpanelt, és próbálkozz újra.',
  'fabric.editor.ai.experience-application.rateLimitEnforced': 'Túl sok friss kérelmet kaptunk az Atlassian Intelligence-hez (AI). Próbálkozz újra néhány perc múlva, vagy olvass az <link>AI túlzott használatáról</link>.',
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Nem sikerült választ kapni. Az információkérésed vagy válaszod meghaladta a kérelem korlátját. Zárd be a párbeszédpanelt, és próbálkozz újra.',
  'fabric.editor.ai.experience-application.unhandledErrorMessage': 'Problémába ütköztünk. Zárd be a párbeszédpanelt, és próbálkozz újra.',
  'fabric.editor.ai.experience.apiError': 'Nem kaptunk választ, próbáld újra.',
  'fabric.editor.ai.experience.aupViolationMessage': 'Előfordulhat, hogy az utasításod vagy a tartalmad nem felel meg az Elfogadható használatra vonatkozó irányelveknek. Kérjük, ellenőrizd mindkettőt, és szükség esetén olvasd el az <link>Elfogadható használatra vonatkozó irányelveket</link>. Ha a probléma továbbra is fennáll, akkor fontold meg egy másik utasítás vagy tartalom használatát.',
  ...
  'fabric.editor.ai.experience.messageTemplateContentSearch': 'Keresés: Egy pillanat, folyamatban van az információ keresése.',
  'fabric.editor.ai.experience.messageTemplateNextBestTask': 'Keresés: Egy pillanat, keresést végzünk a Jirában.',
  'fabric.editor.ai.experience.messageTemplatePageHydration': 'Keresés: Egy pillanat, folyamatban van az oldal keresése.',
  'fabric.editor.ai.experience.noResultsSuggestion': 'Nincs találat',
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Az Atlassian Intelligence-nek jelenleg nincs javaslata. Próbálkozz egy másik utasítással vagy tartalommal.',
  ...
  'fabric.editor.configPanel.errorBoundary.note': 'Tájékoztattuk a csapatot. Továbbra is szerkesztheted és közzéteheted az oldalt, vagy ellenőrizheted a hibakonzolt a további információk érdekében.',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Jira-ügyeket szúrhatsz be a Jira Cloudból továbbfejlesztett kereséssel, szűrőkkel és konfigurációkkal.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Semmi sem felel meg a keresésednek.} one {Alapértelmezés szerint {count} javaslat elérhető.} other {Alapértelmezés szerint {count} javaslat elérhető.}}',
  'fabric.editor.elementbrowser.searchbar.assistive.text.result': '{count, plural, =0 {Semmi sem felel meg a keresésednek.} one {{count} javaslat van a begépelt szöveghez.} other {{count} javaslat van a begépelt szöveghez.}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'Sajnos nem tudjuk hozzáadni ezt a képlinket. Töltsd le a képet, majd húzd erre az oldalra.',
  'fabric.editor.media.insert.fromUrlWarning': 'A forrás korlátozásai miatt előfordulhat, hogy ezt a képet nem fogják látni mások. Fontold meg inkább a fájl feltöltését.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Fájlfeltöltési hiba. Ellenőrizd az elérési utat vagy a hálózatot.',
  ...
  'fabric.editor.replaceSuccess': '{numberOfMatches, plural, one {{numberOfMatches,number} egyezés cserélve} other {{numberOfMatches,number} egyezés cserélve}}',
