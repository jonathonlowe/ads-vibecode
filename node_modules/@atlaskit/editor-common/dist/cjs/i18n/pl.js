...
var _default = exports.default = {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'Generuje treści do wstawienia do aktualizacji',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Przygotowuje odpowiedź na podstawie zgłoszeń podobnych do tego, nad którym pracujesz.',
  ...
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Poprawia czytelność, konstrukcję i styl, zwiększając atrakcyjność i zrozumiałość tekstu.',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Wybierz z poniższych opcji (samodzielnie generowane polecenia są obecnie wyłączone w Elevate)',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Tłumaczy tekst, nad którym pracujesz, na język chiński (uproszczony)',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Przetłumacz na chiński (uproszczony)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Tłumaczy tekst, nad którym pracujesz, na język chiński (tradycyjny)',
  ...
  'fabric.editor.ai.config.item.translateTo.danish.description': 'Tłumaczy tekst, nad którym pracujesz, na język duński',
  'fabric.editor.ai.config.item.translateTo.danish.title': 'Przetłumacz na duński',
  'fabric.editor.ai.config.item.translateTo.dutch.description': 'Tłumaczy tekst, nad którym pracujesz, na język holenderski',
  'fabric.editor.ai.config.item.translateTo.dutch.title': 'Przetłumacz na holenderski',
  'fabric.editor.ai.config.item.translateTo.english.description': 'Tłumaczy tekst, nad którym pracujesz, na język angielski',
  'fabric.editor.ai.config.item.translateTo.english.title': 'Przetłumacz na angielski',
  'fabric.editor.ai.config.item.translateTo.finnish.description': 'Tłumaczy tekst, nad którym pracujesz, na język fiński',
  'fabric.editor.ai.config.item.translateTo.finnish.title': 'Przetłumacz na fiński',
  'fabric.editor.ai.config.item.translateTo.french.description': 'Tłumaczy tekst, nad którym pracujesz, na język francuski',
  'fabric.editor.ai.config.item.translateTo.french.title': 'Przetłumacz na francuski',
  'fabric.editor.ai.config.item.translateTo.german.description': 'Tłumaczy tekst, nad którym pracujesz, na język niemiecki',
  'fabric.editor.ai.config.item.translateTo.german.title': 'Przetłumacz na niemiecki',
  'fabric.editor.ai.config.item.translateTo.hungarian.description': 'Tłumaczy tekst, nad którym pracujesz, na język węgierski',
  'fabric.editor.ai.config.item.translateTo.hungarian.title': 'Przetłumacz na węgierski',
  'fabric.editor.ai.config.item.translateTo.italian.description': 'Tłumaczy tekst, nad którym pracujesz, na język włoski',
  'fabric.editor.ai.config.item.translateTo.italian.title': 'Przetłumacz na włoski',
  'fabric.editor.ai.config.item.translateTo.japanese.description': 'Tłumaczy tekst, nad którym pracujesz, na język japoński',
  'fabric.editor.ai.config.item.translateTo.japanese.title': 'Przetłumacz na japoński',
  'fabric.editor.ai.config.item.translateTo.korean.description': 'Tłumaczy tekst, nad którym pracujesz, na język koreański',
  'fabric.editor.ai.config.item.translateTo.korean.title': 'Przetłumacz na koreański',
  'fabric.editor.ai.config.item.translateTo.norwegian.description': 'Tłumaczy tekst, nad którym pracujesz, na język norweski',
  'fabric.editor.ai.config.item.translateTo.norwegian.title': 'Przetłumacz na norweski',
  'fabric.editor.ai.config.item.translateTo.polish.description': 'Tłumaczy tekst, nad którym pracujesz, na język polski',
  'fabric.editor.ai.config.item.translateTo.polish.title': 'Przetłumacz na polski',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Tłumaczy tekst, nad którym pracujesz, na język portugalski (brazylijski)',
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.title': 'Przetłumacz na portugalski (brazylijski)',
  'fabric.editor.ai.config.item.translateTo.russian.description': 'Tłumaczy tekst, nad którym pracujesz, na język rosyjski',
  'fabric.editor.ai.config.item.translateTo.russian.title': 'Przetłumacz na rosyjski',
  'fabric.editor.ai.config.item.translateTo.spanish.description': 'Tłumaczy tekst, nad którym pracujesz, na język hiszpański',
  'fabric.editor.ai.config.item.translateTo.spanish.title': 'Przetłumacz na hiszpański',
  'fabric.editor.ai.config.item.translateTo.swedish.description': 'Tłumaczy tekst, nad którym pracujesz, na język szwedzki',
  ...
  'fabric.editor.ai.config.item.translateTo.turkish.description': 'Tłumaczy tekst, nad którym pracujesz, na język turecki',
  'fabric.editor.ai.config.item.translateTo.turkish.title': 'Przetłumacz na turecki',
  'fabric.editor.ai.config.item.translateTo.ukrainian.description': 'Tłumaczy tekst, nad którym pracujesz, na język ukraiński',
  'fabric.editor.ai.config.item.translateTo.ukrainian.title': 'Przetłumacz na ukraiński',
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Tłumaczy tekst, nad którym pracujesz, na język wietnamski',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Nie można pobrać odpowiedzi. Twoja podpowiedź lub odpowiedź przekroczyła limit tego żądania. Zamknij okno dialogowe i spróbuj ponownie.',
  ...
  'fabric.editor.ai.experience.messageTemplateNextBestTask': 'Wyszukiwanie: Zaczekaj chwilę. Przeszukujemy system Jira.',
  ...
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Atlassian Intelligence nie ma obecnie żadnych sugestii. Zachęcamy do wypróbowania innej podpowiedzi lub treści.',
  ...
  'fabric.editor.ai.screens.preview.convoAIBeta': 'Żądania generowania treści odwołujące się do adresów URL znajdują się w wersji beta.',
  ...
  'fabric.editor.datasource.confluenceSearch.description': 'Wstawianie listy wyników wyszukiwania z Confluence z ulepszonym wyszukiwaniem, filtrowaniem i konfigurowaniem.',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Wstawianie zgłoszeń Jiry z systemu Jira Cloud z ulepszonym wyszukiwaniem, filtrowaniem i konfigurowaniem.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Brak wyników pasujących do wyszukiwania.} one {{count} sugestia dostępna domyślnie.} few {{count} sugestie dostępne domyślnie.} many {{count} sugestii dostępnych domyślnie.} other {{count} sugestii dostępnej domyślnie.}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'Niestety nie można dodać obrazu, do którego prowadzi łącze. Pobierz obraz, a następnie przeciągnij i upuść na stronie.',
  'fabric.editor.media.insert.fromUrlWarning': 'Ten obraz może nie być widoczny dla innych z powodu ograniczeń źródła. Zamiast tego rozważ przekazanie pliku.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Błąd przekazywania pliku. Sprawdź ścieżkę pliku lub połączenie sieciowe.',
  ...
  'fabric.editor.upDown': 'Data wprowadzona w poniższym polu za pomocą klawiszy strzałek w górę i w dół zostanie zaktualizowana poniżej',
