...
function getLinkMark(node) {
  var _node$marks$filter = node.marks.filter(function (mark) {
    ...
    _node$marks$filter2 = (0, _slicedToArray2.default)(_node$marks$filter, 1),
 ...
 */
var createCompareNodes = exports.createCompareNodes = function createCompareNodes(options) {
  ...
  return function (nodeA, nodeB) {
    ...
    return (order === _types.SortOrder.DESC ? -1 : 1) * compareMetaFromNode(metaNodeA, metaNodeB);
  };
};
