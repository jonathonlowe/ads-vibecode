...
exports.createAutoConverterRunner = void 0;
exports.getAutoConvertPatternsFromModule = getAutoConvertPatternsFromModule;
exports.getContextualToolbarItemsFromModule = void 0;
...
var getQuickInsertItemsFromModule = exports.getQuickInsertItemsFromModule = function getQuickInsertItemsFromModule(extensions, transformFunction) {
  ...
  var flatItems = (_ref = []).concat.apply(_ref, (0, _toConsumableArray2.default)(items));
  return flatItems.map(transformFunction);
};
function getAutoConvertPatternsFromModule(_x) {
...
var createAutoConverterRunner = exports.createAutoConverterRunner = function createAutoConverterRunner(autoConvertHandlers) {
...
var getContextualToolbarItemsFromModule = exports.getContextualToolbarItemsFromModule = function getContextualToolbarItemsFromModule(extensions, node, api) {
