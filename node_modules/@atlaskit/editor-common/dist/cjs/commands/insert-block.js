...
var insertBlock = exports.insertBlock = function insertBlock(state, nodeType, start, end, attrs) {
  ...
  // Add new node.
  tr = tr.setSelection(new _state.NodeSelection(tr.doc.resolve(start + 1)))
  // Ignored via go/ees005
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  .replaceSelectionWith(newNode).setSelection(new _state.TextSelection(tr.doc.resolve(start + depth)));
  return tr;
};