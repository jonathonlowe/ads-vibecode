...
var changeImageAlignment = exports.changeImageAlignment = function changeImageAlignment(align) {
  return function (state, dispatch) {
...
var createToggleBlockMarkOnRange = exports.createToggleBlockMarkOnRange = function createToggleBlockMarkOnRange(markType, getAttrs, allowedBlocks) {
 ...
 */
var toggleBlockMark = exports.toggleBlockMark = function toggleBlockMark(markType, getAttrs, allowedBlocks) {
  return function (state, dispatch) {
    var markApplied = false;
    var tr = state.tr;
...
var clearEditorContent = exports.clearEditorContent = function clearEditorContent(state, dispatch) {
  var tr = state.tr;
...
function setHeading(level) {
  return function (state, dispatch) {
    var selection = state.selection,
      schema = state.schema,
      tr = state.tr;
    var ranges = selection instanceof _cellSelection.CellSelection ? selection.ranges : [selection];
