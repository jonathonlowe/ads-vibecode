...
export default {
  ...
  'fabric.editor.ai.atlas-prebuilt.atlasGenerateContentConfigItemDescription': 'Genererer innhold du kan sette inn i oppdateringen',
  ...
  'fabric.editor.ai.config.item.bb.pr.description.description': 'Oppretter en beskrivelse av pull-forespørselen med et sammendrag av endringer',
  ...
  'fabric.editor.ai.config.item.draftReply.description': 'Utarbeider et svar basert på saker som ligner på den du jobber med',
  ...
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.selectionToolbar.dropdownItem.title': 'Staving og grammatikk',
  'fabric.editor.ai.config.item.enhance.fixSpellingGrammar.title': 'Rett feil staving og grammatikk',
  'fabric.editor.ai.config.item.enhance.improveWriting.description': 'Forbedrer klarhet, struktur og tone for bedre engasjement og forståelse',
  ...
  'fabric.editor.ai.config.item.freeGenerate.disabled.promptHint': 'Velg blant alternativene nedenfor (fri generering er deaktivert i Elevate for øyeblikket)',
  'fabric.editor.ai.config.item.generateContent.promptHint': 'Skriv med AI eller velg noe nedenfor',
  'fabric.editor.ai.config.item.improveDescription.default.description': 'Omstrukturer saksbeskrivelsen basert på sakstype',
  ...
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.description': 'Oversetter teksten du jobber med, til kinesisk (forenklet)',
  'fabric.editor.ai.config.item.translateTo.chineseSimplified.title': 'Oversett til kinesisk (forenklet)',
  'fabric.editor.ai.config.item.translateTo.chineseTraditional.description': 'Oversetter teksten du jobber med, til kinesisk (tradisjonell)',
  ...
  'fabric.editor.ai.config.item.translateTo.portugueseBrazilian.description': 'Oversetter teksten du jobber med, til portugisisk (brasiliansk)',
  ...
  'fabric.editor.ai.config.item.translateTo.vietnamese.description': 'Oversetter teksten du jobber med, til vietnamesisk',
  ...
  'fabric.editor.ai.experience-application.tokenLimitExceeded': 'Vi fikk ikke svar. Ledeteksten eller svaret ditt var over grensen for denne forespørselen. Lukk dialogboksen og prøv igjen.',
  ...
  'fabric.editor.ai.experience.responseTooSimilarMessage': 'Atlassian Intelligence har ingen forslag akkurat nå. Du må gjerne prøve en annen ledetekst eller annet innhold.',
  ...
  'fabric.editor.configPanel.errorBoundary.note': 'Vi gir teamet beskjed. Du kan fortsatt redigere og publisere denne siden, eller du kan sjekke feilkonsollen for mer informasjon.',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh': 'Sett inn Jira-arbeidsoppgaver fra Jira Cloud med forbedret søk, filtrering og konfigurasjon.',
  ...
  'fabric.editor.elementbrowser.searchbar.assistive.text.default': '{count, plural, =0 {Ingen treff for søket ditt.} one {{count} forslag er tilgjengelig som standard.} other {{count} forslag er tilgjengelig som standard.}}',
  'fabric.editor.elementbrowser.searchbar.assistive.text.result': '{count, plural, =0 {Ingen treff for søket ditt.} one {{count} forslag er tilgjengelig for den skrevne teksten.} other {{count} forslag er tilgjengelig for den skrevne teksten.}}',
  ...
  'fabric.editor.floatingToolbar.confirmModalConnectedUnit': '{amount, plural, =0 {{name}} one {{name} (+1 tilkoblet element)} other {{name} (+{amount,number} tilkoblede elementer)}}',
  ...
  'fabric.editor.media.insert.fromUrlErrorMessage': 'Dessverre kan vi ikke legge til denne bildekoblingen. Last ned bildet. Deretter drar og slipper du det på siden.',
  'fabric.editor.media.insert.fromUrlWarning': 'Dette bildet vises kanskje ikke for andre på grunn av kildebegrensninger. Vurder å laste opp filen i stedet.',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage': 'Feil ved opplasting av fil. Kontroller filbanen eller nettverket.',
  ...
  'fabric.editor.replaceSuccess': '{numberOfMatches, plural, one {{numberOfMatches,number} treff ble erstattet} other {{numberOfMatches,number} treff ble erstattet}}',
