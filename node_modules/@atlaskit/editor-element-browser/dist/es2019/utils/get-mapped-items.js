...
const getItemData = (item, tempKey) => {
  ...
  if (itemId && itemId !== 'datasource') {
    switch (itemId) {
      ...
      case 'mention':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(MentionIcon, {
            label: ""
          }),
      ...
      case 'emoji':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(EmojiIcon, {
            label: ""
          }),
          categories: ['media'],
          shouldDisplayAtTop: true,
      ...
      case 'expand':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(ExpandElementIcon, {
            label: ""
          }),
      ...
      case 'table':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(GridIcon, {
            label: ""
          }),
          categories: ['page structure'],
          shouldDisplayAtTop: true,
      ...
      case 'codeblock':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(AngleBracketsIcon, {
            label: ""
          }),
          categories: ['text structure'],
          shouldDisplayAtTop: true,
      ...
      case 'status':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(LozengeIcon, {
            label: ""
          }),
          categories: ['text structure'],
          shouldDisplayAtTop: true,
      ...
      case 'infopanel':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(InformationCircleIcon, {
            label: ""
          }),
          categories: ['page structure'],
          shouldDisplayAtTop: true,
      ...
      case 'decision':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(DecisionIcon, {
            label: ""
          }),
          categories: ['text structure'],
          shouldDisplayAtTop: true,
      ...
      case 'threecolumnslayout':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(LayoutThreeColumnsIcon, {
            label: ""
          }),
          categories: ['page structure'],
          shouldDisplayAtTop: true,
      ...
      case 'rule':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(DividerElementIcon, {
            label: ""
          }),
          categories: ['page structure'],
          shouldDisplayAtTop: true,
      ...
      case 'blockquote':
        return {
          ...item,
          icon: () => /*#__PURE__*/React.createElement(QuotationMarkIcon, {
            label: ""
          }),
          categories: ['text structure'],
          shouldDisplayAtTop: true,
...
export const getMappedItems = items => {
