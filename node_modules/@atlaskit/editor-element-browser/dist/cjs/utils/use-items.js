...
exports.useItems = exports.PredefinedCategories = exports.CategoriesStructure = void 0;
var _slicedToArray2 = _interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));
var _react = require("react");
var _keymaps = require("@atlaskit/editor-common/keymaps");
var _getMappedItems = require("./get-mapped-items");
...
var transformBrowserElementItem = function transformBrowserElementItem(item) {
  return {
    ...
    keyshortcut: item.keyshortcut ? (0, _keymaps.makeKeyMapWithCommon)('', item.keyshortcut) : undefined,
...
var CategoriesStructure = exports.CategoriesStructure = [{
  id: 'media',
  title: 'Media',
  subcategories: [],
...
var PredefinedCategories = exports.PredefinedCategories = new Map();
...
var useItems = exports.useItems = function useItems(quickInsertPanelItems, query) {
  ...
  var insertPanelItems = (0, _react.useMemo)(function () {
    return (0, _getMappedItems.getMappedItems)(quickInsertPanelItems);
  ...
  var combinedSearchText = (0, _react.useMemo)(function () {
    return searchText || query;
  }, [query, searchText]);
  var searchItems = (0, _react.useMemo)(function () {
    if (!combinedSearchText) {
      return undefined;
    }
    var filteredItems = (0, _search.find)(combinedSearchText, insertPanelItems);
