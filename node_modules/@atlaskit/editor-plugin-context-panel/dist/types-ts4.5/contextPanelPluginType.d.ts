...
import type { HideObjectSidebar, HideObjectSidebarById, ShowObjectSidebar } from './types/object-siderbar-types';
...
export type ContextPanelPlugin = NextEditorPlugin<'contextPanel', {
