...
var InlineAsyncExtension = /** @class */ (function (_super) {
    tslib_1.__extends(InlineAsyncExtension, _super);
...
exports.extensionHandlers = {
    'com.atlassian.confluence.macro.core': function (ext) {
        ...
        switch (extensionKey) {
            case 'block-eh':
                return React.createElement(BlockExtension, tslib_1.__assign({}, macroProps));
            case 'block-layout-eh':
                return React.createElement(BlockExtension, tslib_1.__assign({}, macroProps));
            case 'block-iframe-eh':
                return React.createElement(IFrameExtension, tslib_1.__assign({}, macroProps));
            case 'bodied-eh':
                return React.createElement(BodiedExtension, tslib_1.__assign({}, macroProps));
            case 'inline-eh':
                return React.createElement(InlineExtension, tslib_1.__assign({}, macroProps));
            case 'jql-table':
            ...
            case 'inline-async-eh':
                return React.createElement(InlineAsyncExtension, tslib_1.__assign({}, macroProps));
        }
        return null;
    },
    'com.atlassian.extensions.update': {
        ...
        update: function (params) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
