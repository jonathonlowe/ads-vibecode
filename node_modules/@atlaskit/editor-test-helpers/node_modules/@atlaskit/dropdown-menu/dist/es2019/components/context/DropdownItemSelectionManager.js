...
export default class DropdownItemSelectionManager extends Component {
    constructor() {
        super(...arguments);
        this.setItemSelected = (itemId, isSelected, defaultSelected) => {
        ...
        this.setCheckboxItemSelected = (itemId, isSelected) => {
        ...
        this.setRadioItemSelected = (itemId, isSelected) => {
            const { [selectionCacheContext]: cache } = this.context;
            const isAlreadySelected = cache.isItemSelected(this.props.groupId, itemId);
        ...
        this.isItemSelectedInCache = (itemId) => this.context[selectionCacheContext].isItemSelected(this.props.groupId, itemId);
        this.handleItemClicked = (clickedItemId) => {
        ...
        this.hasAlreadyAppliedDefaultSelected = (itemId) => this.context[selectionCacheContext].hasItemAlreadyHadDefaultSelectedApplied(this.props.groupId, itemId);
        this.handleCheckboxItemClicked = (clickedItemId) => {
            const { [selectionCacheContext]: cache } = this.context;
        ...
        this.updateCacheContextWithSelections = (itemSelections) => {
...
DropdownItemSelectionManager.childContextTypes = {
    [selectionManagerContext]: PropTypes.object,
};
DropdownItemSelectionManager.contextTypes = {
