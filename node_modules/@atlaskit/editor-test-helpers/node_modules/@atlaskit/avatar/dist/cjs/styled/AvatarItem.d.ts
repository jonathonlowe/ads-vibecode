...
export declare function getBackgroundColor({ backgroundColor, href, isActive, isHover, isSelected, onClick, }: GetBackgroundColorType): string | ThemedValue<string>;
...
export declare const PrimaryText: (props: import("styled-components").ThemedOuterStyledProps<import("react").ClassAttributes<HTMLDivElement> & import("react").HTMLAttributes<HTMLDivElement> & {
    truncate: boolean;
}, any>) => JSX.Element;
export declare const SecondaryText: (props: import("styled-components").ThemedOuterStyledProps<import("react").ClassAttributes<HTMLDivElement> & import("react").HTMLAttributes<HTMLDivElement> & {
    truncate: boolean;
}, any>) => JSX.Element;
export {};
