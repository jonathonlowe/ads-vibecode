...
var CardBase = /** @class */ (function (_super) {
    ...
    function CardBase() {
        ...
        _this.renderMediaViewer = function () {
            ...
            return ReactDOM.createPortal(React.createElement(media_viewer_1.MediaViewer, { collectionName: collectionName, dataSource: dataSource, context: mediaClient, selectedItem: mediaViewerSelectedItem, onClose: _this.onMediaViewerClose }), document.body);
        };
