...
import { isPreviewableType, isFileIdentifier, isDifferentIdentifier, isImageRepresentationReady, addFileAttrsToUrl, } from '@atlaskit/media-client';
...
var CardBase = /** @class */ (function (_super) {
    ...
    function CardBase() {
        ...
        _this.renderMediaViewer = function () {
            ...
            return ReactDOM.createPortal(React.createElement(MediaViewer, { collectionName: collectionName, dataSource: dataSource, context: mediaClient, selectedItem: mediaViewerSelectedItem, onClose: _this.onMediaViewerClose }), document.body);
        };
        _this.renderCard = function () {
            var _a = _this.props, isLazy = _a.isLazy, appearance = _a.appearance, resizeMode = _a.resizeMode, dimensions = _a.dimensions, selectable = _a.selectable, selected = _a.selected, onSelectChange = _a.onSelectChange, disableOverlay = _a.disableOverlay;
            var _b = _this.state, progress = _b.progress, metadata = _b.metadata, dataURI = _b.dataURI, previewOrientation = _b.previewOrientation;
            var _c = _this, onRetry = _c.onRetry, onCardViewClick = _c.onCardViewClick, actions = _c.actions, onMouseEnter = _c.onMouseEnter;
            var status = getCardStatus(_this.state, _this.props);
            var card = (React.createElement(CardView, { status: status, metadata: metadata, dataURI: dataURI, appearance: appearance, resizeMode: resizeMode, dimensions: dimensions, actions: actions, selectable: selectable, selected: selected, onClick: onCardViewClick, onMouseEnter: onMouseEnter, onSelectChange: onSelectChange, disableOverlay: disableOverlay, progress: progress, onRetry: onRetry, previewOrientation: previewOrientation, ref: _this.cardRef }));
                    ...
                    case 1:
                        ...
                        this.subscription = mediaClient.file
                            ...
                            next: function (fileState) { return __awaiter(_this, void 0, void 0, function () {
                                var _a, status, progress, dataURI, _b, previewOrientation, contextId, metadata, _c, src, orientation_1, shouldFetchRemotePreview, _d, appearance, dimensions, resizeMode, options, width, height, mode, blob, e_1;
                                return __generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0:
