...
var Color = /** @class */ (function (_super) {
    ...
    Color.prototype.render = function () {
        ...
        return (react_1.default.createElement(ButtonWrapper, null,
            react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages[value + "Color"]), function (label) { return (react_1.default.createElement(Button, { onClick: _this.onClick, onMouseEnter: _this.onMouseEnter, onMouseLeave: _this.onMouseLeave, onMouseDown: _this.onMouseDown, tabIndex: tabIndex, className: "" + (isSelected ? 'selected' : ''), title: label, style: {
                    backgroundColor: backgroundColor || 'transparent',
                    border: borderStyle,
                } }, isSelected && (react_1.default.createElement(done_1.default, { primaryColor: borderColor, label: label })))); })));
    };
