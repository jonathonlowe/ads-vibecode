...
exports.default = (function (_a) {
    ...
    return (react_1.default.createElement(ColorPaletteWrapper, { className: className, style: { maxWidth: cols * 32 } }, palette.map(function (_a) {
        var _b = tslib_1.__read(_a, 3), colorValue = _b[0], backgroundColor = _b[1], borderColor = _b[2];
        return (react_1.default.createElement(color_1.default, { key: colorValue, value: colorValue, backgroundColor: backgroundColor, borderColor: borderColor, onClick: onClick, onHover: onHover, isSelected: colorValue === selectedColor }));
    })));
});
