...
var Date = /** @class */ (function (_super) {
    ...
    Date.prototype.render = function () {
        return (react_1.default.createElement(DateLozenge_1.DateLozenge, { className: this.props.className, onClick: isClickable(this.props) ? this.handleOnClick : undefined, color: this.props.color }, this.renderContent()));
    };
