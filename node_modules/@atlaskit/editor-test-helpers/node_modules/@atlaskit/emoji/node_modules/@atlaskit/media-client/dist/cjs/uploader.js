...
var chunkinator_1 = require("@atlaskit/chunkinator");
var hasherCreator_1 = require("./utils/hashing/hasherCreator");
var hashingFunction = function (blob) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var hasher;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, hasherCreator_1.createHasher()];
            case 1:
                hasher = _a.sent();
...
var createProbingFunction = function (store, collection) { return function (chunks) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
...
var createProcessingFunction = function (store, deferredUploadId, collection) {
    var offset = 0;
    return function (chunks) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
...
exports.uploadFile = function (file, store, uploadableFileUpfrontIds, callbacks) {
    ...
    var _a = chunkinator_1.chunkinator(content, {
