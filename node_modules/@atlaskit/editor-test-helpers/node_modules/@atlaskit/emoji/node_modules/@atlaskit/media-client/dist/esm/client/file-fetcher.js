...
var FileFetcherImpl = /** @class */ (function () {
    function FileFetcherImpl(mediaStore) {
        ...
        this.createDownloadFileStream = function (id, collection) {
            ...
            var timeoutId;
            var fetchFile = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    FileFetcherImpl.prototype.uploadExternal = function (url, collection) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                subject = createFileStateSubject();
            ...
            if (!isMimeTypeSupportedByBrowser(mimeType)) {
                processingSubscription = _this.createDownloadFileStream(id, collection).subscribe({
                    next: function (remoteFileState) {
                        return subject.next(__assign(__assign(__assign({}, stateBase), remoteFileState), overrideMediaTypeIfUnknown(remoteFileState, mediaType)));
                    },
