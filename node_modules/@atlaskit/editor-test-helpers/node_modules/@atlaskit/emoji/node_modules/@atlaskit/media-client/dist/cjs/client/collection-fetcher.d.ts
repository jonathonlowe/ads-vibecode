...
import { MediaStore, MediaStoreGetCollectionItemsParams, MediaCollectionItem, FileItem, FileDetails } from '..';
...
export declare class CollectionFetcher {
    ...
    getItems(collectionName: string, params?: MediaStoreGetCollectionItemsParams): ReplaySubject<MediaCollectionItem[]>;
