...
var ChooseEmojiFile = /** @class */ (function (_super) {
    __extends(ChooseEmojiFile, _super);
    ...
    ChooseEmojiFile.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.emojiUpload },
            React.createElement("div", { className: styles.uploadChooseFileMessage },
                React.createElement(FormattedMessage, __assign({}, messages.addCustomEmojiLabel), function (message) { return React.createElement("h5", null, message); })),
            React.createElement("div", { className: styles.uploadChooseFileRow },
                React.createElement("span", { className: styles.uploadChooseFileEmojiName },
                    React.createElement(AkFieldBase, { appearance: "standard", isCompact: true, defaultIsFocused: true, isFitContainerWidthEnabled: true },
                        React.createElement(FormattedMessage, __assign({}, messages.emojiPlaceholder), function (message) { return (React.createElement(FormattedMessage, __assign({}, messages.emojiNameAriaLabel), function (ariaLabel) { return (React.createElement("input", { placeholder: message, "aria-label": ariaLabel, maxLength: maxNameLength, onChange: onNameChange, onKeyDown: _this.onKeyDown, value: name, ref: "name", autoFocus: true })); })); }))),
                React.createElement("span", { className: styles.uploadChooseFileBrowse },
                    React.createElement(FormattedMessage, __assign({}, messages.emojiChooseFileTitle), function (message) { return (React.createElement(FormattedMessage, __assign({}, messages.emojiChooseFileAriaLabel), function (ariaLabel) { return (React.createElement(FileChooser, { label: message, onChange: onChooseFile, onClick: onClick, accept: "image/png,image/jpeg,image/gif", ariaLabel: ariaLabel, isDisabled: disableChooser })); })); }))),
            React.createElement("div", { className: styles.emojiUploadBottom }, !errorMessage ? (React.createElement("p", null,
                React.createElement(FormattedMessage, __assign({}, messages.emojiImageRequirements)))) : (React.createElement(EmojiErrorMessage, { className: styles.emojiChooseFileErrorMessage, message: errorMessage })))));
    };
    return ChooseEmojiFile;
}(PureComponent));
var EmojiUploadPicker = /** @class */ (function (_super) {
    __extends(EmojiUploadPicker, _super);
