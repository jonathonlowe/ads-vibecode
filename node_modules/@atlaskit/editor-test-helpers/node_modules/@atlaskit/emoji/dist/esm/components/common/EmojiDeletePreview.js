...
var EmojiDeletePreview = /** @class */ (function (_super) {
    __extends(EmojiDeletePreview, _super);
        ...
        return (React.createElement("div", { className: styles.deletePreview },
            React.createElement("div", { className: styles.deleteText },
                React.createElement("h5", null,
                    React.createElement(FormattedMessage, __assign({}, messages.deleteEmojiTitle))),
                React.createElement(FormattedMessage, __assign({}, messages.deleteEmojiDescription, { values: { emojiShortName: emoji.shortName } }))),
            React.createElement("div", { className: styles.deleteFooter },
                ...
                React.createElement("div", { className: styles.previewButtonGroup },
                    error ? (React.createElement(FormattedMessage, __assign({}, messages.deleteEmojiFailed), function (message) {
                    ...
                    React.createElement(FormattedMessage, __assign({}, messages.deleteEmojiLabel), function (message) { return (React.createElement(RetryableButton, { className: styles.uploadEmojiButton, retryClassName: styles.uploadRetryButton, label: message, onSubmit: _this.onSubmit, appearance: "danger", loading: loading, error: error })); }),
                    React.createElement(AkButton, { appearance: "subtle", onClick: this.onCancel, className: styles.cancelButton },
                        React.createElement(FormattedMessage, __assign({}, messages.cancelLabel)))))));
    };
