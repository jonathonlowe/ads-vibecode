...
var EmojiPickerVirtualList = /** @class */ (function (_super) {
    __extends(EmojiPickerVirtualList, _super);
        ...
        _this.buildVirtualItems = function (props, _state) {
            ...
            if (loading) {
                ...
                if (query) {
                    ...
                    items = __spread(items, _this.buildVirtualItemFromGroup({
                        category: 'SEARCH',
                        title: search.name,
                        emojis: emojis,
                        order: search.order,
                    ...
                    _this.allEmojiGroups.forEach(function (group) {
                        ...
                        items = __spread(items, _this.buildVirtualItemFromGroup(group));
                    });
                }
            }
