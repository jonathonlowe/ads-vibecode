    ...
    function EmojiTypeAheadComponent(props) {
        ...
        _this.onSearchResult = function (result) {
            ...
            if (isFullShortName(query)) {
                ...
                if (matchIndex !== undefined) {
                    var onSelect = createRecordSelectionDefault(_this.props.emojiProvider, _this.props.onSelection, function (analytic) { return _this.fireAnalyticsEvent(analytic('typeahead')); });
