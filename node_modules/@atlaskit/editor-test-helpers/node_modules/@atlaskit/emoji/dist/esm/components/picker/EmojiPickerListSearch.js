...
var EmojiPickerListSearch = /** @class */ (function (_super) {
    __extends(EmojiPickerListSearch, _super);
    ...
    EmojiPickerListSearch.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.pickerSearch, style: style },
            React.createElement(FormattedMessage, __assign({}, messages.searchLabel), function (searchLabel) { return (React.createElement(AkFieldBase, { appearance: "standard", isCompact: true, isFitContainerWidthEnabled: true },
