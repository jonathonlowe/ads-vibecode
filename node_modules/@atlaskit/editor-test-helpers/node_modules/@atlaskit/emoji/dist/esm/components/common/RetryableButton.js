...
var RetryableButton = /** @class */ (function (_super) {
    __extends(RetryableButton, _super);
    ...
    RetryableButton.prototype.renderRetry = function () {
        ...
        return loading ? (this.renderLoading()) : (React.createElement(FormattedMessage, __assign({}, messages.retryLabel), function (retryLabel) { return (React.createElement(AkButton, { className: retryClassName, appearance: "warning", onClick: onSubmit }, retryLabel)); }));
    };
