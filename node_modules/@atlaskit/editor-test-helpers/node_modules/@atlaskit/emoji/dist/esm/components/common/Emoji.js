...
var renderAsSprite = function (props) {
    ...
    var style = __assign({ backgroundImage: "url(" + sprite.url + ")", backgroundPosition: xPositionInPercent + "% " + yPositionInPercent + "%", backgroundSize: sprite.column * 100 + "% " + sprite.row * 100 + "%" }, sizing);
    var emojiNode = (React.createElement("span", { className: styles.emojiSprite, style: style }, "\u00A0"));
    return (React.createElement("span", { className: classNames(classes), onMouseDown: function (event) {
...
var renderAsImage = function (props) {
    ...
    var emojiNode = (React.createElement("img", __assign({ src: src, key: src, alt: emoji.shortName, "data-emoji-short-name": emoji.shortName, "data-emoji-id": emoji.id, "data-emoji-text": emoji.fallback || emoji.shortName, className: "emoji", style: { visibility: 'visible' }, onError: onError }, sizing)));
    return (React.createElement("span", { className: classNames(classes), onMouseDown: function (event) {
            handleMouseDown(props, event);
        }, onMouseMove: function (event) {
            handleMouseMove(props, event);
