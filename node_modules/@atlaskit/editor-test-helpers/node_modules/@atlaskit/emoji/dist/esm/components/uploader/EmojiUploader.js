...
var EmojiUploaderInternal = /** @class */ (function (_super) {
    __extends(EmojiUploaderInternal, _super);
    ...
    EmojiUploaderInternal.prototype.renderLoaded = function (loadedEmojiProvider, EmojiUploadComponent) {
        var _a = this.props, emojiProvider = _a.emojiProvider, otherProps = __rest(_a, ["emojiProvider"]);
        return (React.createElement(EmojiUploadComponent, __assign({ emojiProvider: loadedEmojiProvider }, otherProps)));
    };
