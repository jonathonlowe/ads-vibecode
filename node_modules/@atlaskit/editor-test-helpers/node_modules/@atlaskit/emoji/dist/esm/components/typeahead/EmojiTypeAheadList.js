...
var EmojiTypeAheadList = /** @class */ (function (_super) {
    __extends(EmojiTypeAheadList, _super);
    ...
    EmojiTypeAheadList.prototype.renderItems = function (emojis) {
        ...
        if (emojis && emojis.length) {
            ...
            return (React.createElement("div", null, emojis.map(function (emoji, idx) {
                ...
                var item = (React.createElement(EmojiItem, { emoji: emoji, key: key, selected: _this.isSelectedEmoji(emoji, idx), onMouseMove: _this.selectIndexOnHover, onSelection: _this.itemSelected, ref: function (ref) {
                        if (ref) {
                            _this.items[key] = ref;
                        }
                        else {
