...
var MediaImageLoader = /** @class */ (function () {
    ...
    MediaImageLoader.prototype.delay = function (durationInMillis) {
        return new Promise(function (resolve) { return setTimeout(resolve, durationInMillis); });
    };
    MediaImageLoader.prototype.requestMediaEmoji = function (url, token, retryOnAuthError, retriesOnNotFound) {
        var _this = this;
        if (retriesOnNotFound === void 0) { retriesOnNotFound = defaultMaxRetriesOnNotFound; }
        return imageAcceptHeader().then(function (acceptHeader) {
            ...
            return fetch(url, options).then(function (response) {
                ...
                if (response.status === 404 && retriesOnNotFound > 0) {
                    return _this.delay(backoffMaxDelayInMillis / retriesOnNotFound) // backoff strategy
                        .then(function () {
                        return _this.requestMediaEmoji(url, token, false, retriesOnNotFound - 1);
                    });
                }
