...
export var insertionSucceeded = function (source) {
    return createEvent('operational', 'succeeded', 'recordEmojiSelection', undefined, {
        source: source,
    });
};
export var insertionFailed = function (source) {
...
export var recordSelectionSucceededSli = function (options) { return function () {
    if (options && options.createAnalyticsEvent) {
        createAndFireEvent('editor')(insertionSucceeded('typeahead'))(options.createAnalyticsEvent);
    }
}; };
export var recordSelectionFailedSli = function (options) { return function (err) {
    if (options && options.createAnalyticsEvent) {
