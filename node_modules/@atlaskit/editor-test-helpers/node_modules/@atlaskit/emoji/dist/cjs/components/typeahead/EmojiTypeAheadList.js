...
var EmojiTypeAheadList = /** @class */ (function (_super) {
    ...
    EmojiTypeAheadList.prototype.renderItems = function (emojis) {
        ...
        if (emojis && emojis.length) {
            this.items = {};
            return (react_1.default.createElement("div", null, emojis.map(function (emoji, idx) {
                var key = getKey(emoji);
                var item = (react_1.default.createElement(EmojiTypeAheadItem_1.default, { emoji: emoji, key: key, selected: _this.isSelectedEmoji(emoji, idx), onMouseMove: _this.selectIndexOnHover, onSelection: _this.itemSelected, ref: function (ref) {
                        if (ref) {
                            _this.items[key] = ref;
                        }
                        else {
    ...
    EmojiTypeAheadList.prototype.render = function () {
        ...
        var listBody;
        if (loading) {
            listBody = (react_1.default.createElement("div", { className: styles.emojiTypeAheadSpinnerContainer },
                react_1.default.createElement("div", { className: styles.emojiTypeAheadSpinner },
                    react_1.default.createElement(spinner_1.default, { size: "medium" }))));
        }
        else {
            listBody = this.renderItems(emojis);
        }
        return (react_1.default.createElement("div", { className: styles.typeAheadListContainer },
            react_1.default.createElement("div", { className: classes },
                react_1.default.createElement(Scrollable_1.default, { ref: this.handleScrollableRef, maxHeight: shared_styles_1.emojiTypeAheadMaxHeight + "px" }, listBody))));
    };
