...
var Scrollable = /** @class */ (function (_super) {
    ...
    Scrollable.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default(scrollableClasses), onMouseLeave: onMouseLeave, onScroll: this.handleScroll, ref: this.handleRef, style: style }, children));
    };
    return Scrollable;
