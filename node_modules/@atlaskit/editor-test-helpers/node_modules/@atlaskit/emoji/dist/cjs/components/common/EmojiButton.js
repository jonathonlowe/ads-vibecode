...
exports.EmojiButton = function (props) {
    ...
    return (react_1.default.createElement("button", { className: classnames_1.default(classes), onMouseDown: function (event) {
            handleMouseDown(props, event);
        } },
        react_1.default.createElement(Emoji_1.default, { emoji: emoji, selectOnHover: selectOnHover })));
};
