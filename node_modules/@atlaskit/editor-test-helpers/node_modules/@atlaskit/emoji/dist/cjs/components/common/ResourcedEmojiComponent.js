...
var ResourcedEmojiComponent = /** @class */ (function (_super) {
    ...
    ResourcedEmojiComponent.prototype.render = function () {
        ...
        if (emoji) {
            return this.emojiWrapper(react_1.default.createElement(CachingEmoji_1.default, { emoji: emoji, showTooltip: showTooltip, fitToHeight: fitToHeight }));
        }
        else if (loaded) {
            // loaded but not found - render fallback
            return this.emojiWrapper(react_1.default.createElement("span", null, fallback || shortName));
        }
        return this.emojiWrapper(react_1.default.createElement(EmojiPlaceholder_1.default, { shortName: shortName, showTooltip: showTooltip, size: fitToHeight || constants_1.defaultEmojiHeight }));
    };
    ResourcedEmojiComponent.prototype.emojiWrapper = function (element) {
        ...
        return (react_1.default.createElement("span", { "data-emoji-id": id, "data-emoji-short-name": shortName, "data-emoji-text": fallback || shortName }, element));
    };
