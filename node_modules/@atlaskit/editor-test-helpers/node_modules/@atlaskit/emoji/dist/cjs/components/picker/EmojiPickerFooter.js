...
var EmojiPickerFooter = /** @class */ (function (_super) {
    ...
    EmojiPickerFooter.prototype.render = function () {
        ...
        if (uploading) {
            return (react_1.default.createElement("div", { className: previewFooterClassnames },
                react_1.default.createElement(EmojiUploadPicker_1.default, { onUploadCancelled: onUploadCancelled, onUploadEmoji: onUploadEmoji, onFileChooserClicked: onFileChooserClicked, errorMessage: uploadErrorMessage, initialUploadName: initialUploadName })));
        }
        if (emojiToDelete) {
            return (react_1.default.createElement("div", { className: previewFooterClassnames },
                react_1.default.createElement(EmojiDeletePreview_1.default, { emoji: emojiToDelete, onDeleteEmoji: onDeleteEmoji, onCloseDelete: onCloseDelete })));
        }
        return (react_1.default.createElement("div", { className: previewFooterClassnames },
            react_1.default.createElement(EmojiPreview_1.default, { emoji: selectedEmoji, toneEmoji: toneEmoji, selectedTone: selectedTone, onToneSelected: onToneSelected, onToneSelectorCancelled: onToneSelectorCancelled, onOpenUpload: onOpenUpload, uploadEnabled: uploadEnabled })));
    };
