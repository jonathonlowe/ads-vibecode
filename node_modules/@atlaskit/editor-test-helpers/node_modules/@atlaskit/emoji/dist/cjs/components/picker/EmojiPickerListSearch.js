...
var EmojiPickerListSearch = /** @class */ (function (_super) {
    ...
    EmojiPickerListSearch.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: styles.pickerSearch, style: style },
            react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.searchLabel), function (searchLabel) { return (react_1.default.createElement(field_base_1.default, { appearance: "standard", isCompact: true, isFitContainerWidthEnabled: true },
                react_1.default.createElement("span", { className: styles.searchIcon },
                    react_1.default.createElement(search_1.default, { label: searchLabel })),
                react_1.default.createElement("input", { className: styles.input, autoComplete: "off", disabled: false, name: "search", placeholder: searchLabel + "...", required: false, onChange: _this.onChange, value: query || '', ref: _this.handleInputRef, onBlur: _this.onBlur }))); })));
    };
