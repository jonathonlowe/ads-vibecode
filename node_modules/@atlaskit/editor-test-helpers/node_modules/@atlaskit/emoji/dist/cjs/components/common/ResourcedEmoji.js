...
var ResourcedEmoji = /** @class */ (function (_super) {
    ...
    ResourcedEmoji.prototype.renderLoading = function () {
        ...
        return (react_1.default.createElement(EmojiPlaceholder_1.default, { shortName: emojiId.shortName, showTooltip: showTooltip, size: fitToHeight || constants_1.defaultEmojiHeight }));
    };
    ResourcedEmoji.prototype.renderLoaded = function (loadedEmojiProvider, ResourcedEmojiComponent) {
        ...
        return (react_1.default.createElement(ResourcedEmojiComponent, tslib_1.__assign({}, otherProps, { emojiProvider: loadedEmojiProvider })));
    };
