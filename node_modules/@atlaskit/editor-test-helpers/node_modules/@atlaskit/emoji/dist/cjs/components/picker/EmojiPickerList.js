...
var EmojiPickerVirtualList = /** @class */ (function (_super) {
    ...
    EmojiPickerVirtualList.prototype.render = function () {
        var _a = this.props, onMouseLeave = _a.onMouseLeave, onMouseEnter = _a.onMouseEnter, query = _a.query;
        var classes = [styles.emojiPickerList];
        return (react_1.default.createElement("div", { ref: "root", className: classnames_1.default(classes), onMouseLeave: onMouseLeave, onMouseEnter: onMouseEnter },
            react_1.default.createElement(EmojiPickerListSearch_1.default, { onChange: this.onSearch, query: query }),
