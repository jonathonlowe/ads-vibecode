...
var EmojiPlaceholder = function (props) {
    ...
    var classes = (_a = {},
        ...
        _a);
    var placeholderNode = (react_1.default.createElement("span", { "aria-label": shortName, className: classnames_1.default(classes), style: style }));
    return showTooltip ? (react_1.default.createElement(tooltip_1.default, { tag: "span", content: shortName }, placeholderNode)) : (placeholderNode);
};
