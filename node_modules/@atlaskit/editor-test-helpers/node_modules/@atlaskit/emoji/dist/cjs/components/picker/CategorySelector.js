...
var CategorySelector = /** @class */ (function (_super) {
    ...
    function CategorySelector(props) {
        ...
        _this.onClick = function (event) {
            var _a = _this.props, onCategorySelected = _a.onCategorySelected, disableCategories = _a.disableCategories;
    ...
    CategorySelector.prototype.render = function () {
        ...
        if (categories) {
            categoriesSection = (react_1.default.createElement("ul", null, categories.map(function (categoryId) {
                ...
                return (react_1.default.createElement("li", { key: category.id },
                    react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages[category.name]), function (categoryName) { return (react_1.default.createElement("button", { "data-category-id": category.id, className: classnames_1.default(categoryClasses), onClick: _this.onClick, title: categoryName },
                        react_1.default.createElement(Icon, { label: categoryName }))); })));
            })));
        }
        return (react_1.default.createElement("div", { className: classnames_1.default([styles.categorySelector]) }, categoriesSection));
    };
