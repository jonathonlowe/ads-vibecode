...
var ChooseEmojiFile = /** @class */ (function (_super) {
    ...
    ChooseEmojiFile.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: styles.emojiUpload },
            react_1.default.createElement("div", { className: styles.uploadChooseFileMessage },
                react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.addCustomEmojiLabel), function (message) { return react_1.default.createElement("h5", null, message); })),
            react_1.default.createElement("div", { className: styles.uploadChooseFileRow },
                react_1.default.createElement("span", { className: styles.uploadChooseFileEmojiName },
                    react_1.default.createElement(field_base_1.default, { appearance: "standard", isCompact: true, defaultIsFocused: true, isFitContainerWidthEnabled: true },
                        react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.emojiPlaceholder), function (message) { return (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.emojiNameAriaLabel), function (ariaLabel) { return (react_1.default.createElement("input", { placeholder: message, "aria-label": ariaLabel, maxLength: maxNameLength, onChange: onNameChange, onKeyDown: _this.onKeyDown, value: name, ref: "name", autoFocus: true })); })); }))),
                react_1.default.createElement("span", { className: styles.uploadChooseFileBrowse },
                    react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.emojiChooseFileTitle), function (message) { return (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.emojiChooseFileAriaLabel), function (ariaLabel) { return (react_1.default.createElement(FileChooser_1.default, { label: message, onChange: onChooseFile, onClick: onClick, accept: "image/png,image/jpeg,image/gif", ariaLabel: ariaLabel, isDisabled: disableChooser })); })); }))),
            react_1.default.createElement("div", { className: styles.emojiUploadBottom }, !errorMessage ? (react_1.default.createElement("p", null,
                react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.emojiImageRequirements)))) : (react_1.default.createElement(EmojiErrorMessage_1.default, { className: styles.emojiChooseFileErrorMessage, message: errorMessage })))));
    };
...
var EmojiUploadPicker = /** @class */ (function (_super) {
    ...
    EmojiUploadPicker.prototype.render = function () {
        ...
        if (name && previewImage) {
            return (react_1.default.createElement(EmojiUploadPreview_1.default, { errorMessage: errorMessage, name: name, onAddEmoji: this.onAddEmoji, onUploadCancelled: cancelUpload, previewImage: previewImage, uploadStatus: uploadStatus }));
        }
        return (react_1.default.createElement(ChooseEmojiFile, { name: name, onChooseFile: this.onChooseFile, onClick: this.props.onFileChooserClicked, onNameChange: this.onNameChange, onUploadCancelled: cancelUpload, errorMessage: chooseEmojiErrorMessage ? (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, chooseEmojiErrorMessage))) : (undefined) }));
    };
