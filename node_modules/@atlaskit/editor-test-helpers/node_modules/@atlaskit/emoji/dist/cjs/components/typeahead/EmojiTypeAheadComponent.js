...
var EmojiTypeAheadComponent = /** @class */ (function (_super) {
    ...
    function EmojiTypeAheadComponent(props) {
        ...
        _this.onSearchResult = function (result) {
            ...
            if (isFullShortName(query)) {
                ...
                if (matchIndex !== undefined) {
                    var onSelect = RecordSelectionDefault_1.createRecordSelectionDefault(_this.props.emojiProvider, _this.props.onSelection, function (analytic) { return _this.fireAnalyticsEvent(analytic('typeahead')); });
    ...
    EmojiTypeAheadComponent.prototype.render = function () {
        ...
        }, function (analytic) { return _this.fireAnalyticsEvent(analytic('typeahead')); });
        ...
        return (react_1.default.createElement("div", { style: style, className: classes },
            react_1.default.createElement(EmojiTypeAheadList_1.default, { emojis: emojis, onEmojiSelected: recordUsageOnSelection, ref: this.onEmojiListRef, loading: loading })));
    };
