...
var renderAsSprite = function (props) {
    ...
    var emojiNode = (react_1.default.createElement("span", { className: styles.emojiSprite, style: style }, "\u00A0"));
    return (react_1.default.createElement("span", { className: classnames_1.default(classes), onMouseDown: function (event) {
            handleMouseDown(props, event);
        }, onMouseMove: function (event) {
            handleMouseMove(props, event);
        }, "aria-label": emoji.shortName }, showTooltip ? (react_1.default.createElement(tooltip_1.default, { tag: "span", content: emoji.shortName }, emojiNode)) : (emojiNode)));
};
...
var renderAsImage = function (props) {
    ...
    var deleteButton;
    if (showDelete) {
        deleteButton = (react_1.default.createElement("span", { className: styles.deleteButton },
            react_1.default.createElement(button_1.default, { iconBefore: react_1.default.createElement(cross_circle_1.default, { label: constants_1.deleteEmojiLabel, primaryColor: theme_1.colors.N500, size: "small" }), onClick: function (event) { return handleDelete(props, event); }, appearance: "subtle-link", spacing: "none" })));
    }
    var sizing = {};
    ...
    var emojiNode = (react_1.default.createElement("img", tslib_1.__assign({ src: src, key: src, alt: emoji.shortName, "data-emoji-short-name": emoji.shortName, "data-emoji-id": emoji.id, "data-emoji-text": emoji.fallback || emoji.shortName, className: "emoji", style: { visibility: 'visible' }, onError: onError }, sizing)));
    return (react_1.default.createElement("span", { className: classnames_1.default(classes), onMouseDown: function (event) {
            handleMouseDown(props, event);
        }, onMouseMove: function (event) {
            handleMouseMove(props, event);
        ...
        deleteButton,
        showTooltip ? (react_1.default.createElement(tooltip_1.default, { tag: "span", content: emoji.shortName }, emojiNode)) : (emojiNode)));
};
