...
var EmojiUploadComponent = /** @class */ (function (_super) {
    ...
    EmojiUploadComponent.prototype.render = function () {
        ...
        var errorMessage = uploadErrorMessage ? (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, uploadErrorMessage))) : null;
        return (react_1.default.createElement("div", { className: classnames_1.default([styles.emojiUploadWidget]), ref: this.props.onUploaderRef },
            react_1.default.createElement("div", { className: classnames_1.default([styles.emojiUploadFooter]) },
                react_1.default.createElement(EmojiUploadPicker_1.default, { ref: this.onUploaderRef, onFileChooserClicked: this.onFileChooserClicked, onUploadCancelled: this.onUploadCancelled, onUploadEmoji: this.onUploadEmoji, errorMessage: errorMessage }))));
    };
