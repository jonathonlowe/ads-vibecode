...
exports.insertionSucceeded = function (source) {
    return createEvent('operational', 'succeeded', 'recordEmojiSelection', undefined, {
        source: source,
    });
};
exports.insertionFailed = function (source) {
...
exports.recordSelectionSucceededSli = function (options) { return function () {
    if (options && options.createAnalyticsEvent) {
        analytics_next_1.createAndFireEvent('editor')(exports.insertionSucceeded('typeahead'))(options.createAnalyticsEvent);
    }
}; };
exports.recordSelectionFailedSli = function (options) { return function (err) {
    if (options && options.createAnalyticsEvent) {
        analytics_next_1.createAndFireEvent('editor')(exports.insertionFailed('typeahead'))(options.createAnalyticsEvent);
    }
