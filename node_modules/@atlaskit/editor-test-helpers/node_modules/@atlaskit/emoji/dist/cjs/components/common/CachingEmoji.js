...
exports.CachingEmoji = function (props) {
    ...
    if (type_helpers_1.isMediaEmoji(props.emoji)) {
        return react_1.default.createElement(CachingMediaEmoji, tslib_1.__assign({}, props));
    }
    return react_1.default.createElement(Emoji_1.default, tslib_1.__assign({}, emojiProps));
};
/**
...
var CachingMediaEmoji = /** @class */ (function (_super) {
    ...
    CachingMediaEmoji.prototype.render = function () {
        ...
        var emojiComponent;
        if (cachedEmoji) {
            emojiComponent = (react_1.default.createElement(Emoji_1.default, tslib_1.__assign({}, otherProps, { emoji: cachedEmoji, onLoadError: this.handleLoadError })));
        }
        else {
            ...
            emojiComponent = (react_1.default.createElement(EmojiPlaceholder_1.default, { size: fitToHeight || placeholderSize_1, shortName: shortName, showTooltip: showTooltip, representation: representation }));
        }
