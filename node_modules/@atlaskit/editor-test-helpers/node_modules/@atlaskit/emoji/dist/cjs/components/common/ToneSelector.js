...
var ToneSelectorInternal = /** @class */ (function (_super) {
    ...
    ToneSelectorInternal.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", null, toneEmojis.map(function (tone, i) { return (react_1.default.createElement(EmojiButton_1.default, { key: "" + tone.id, onSelected: function () { return _this.onToneSelectedHandler(i); }, emoji: tone, selectOnHover: true })); })));
    };
