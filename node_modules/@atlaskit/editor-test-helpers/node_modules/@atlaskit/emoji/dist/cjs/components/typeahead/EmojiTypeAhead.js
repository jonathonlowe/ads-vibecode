...
var EmojiTypeahead = /** @class */ (function (_super) {
    ...
    EmojiTypeahead.prototype.renderLoaded = function (loadedEmojiProvider, EmojiTypeAheadComponent) {
        ...
        var typeAhead = (react_1.default.createElement(EmojiTypeAheadComponent, tslib_1.__assign({}, otherProps, { emojiProvider: loadedEmojiProvider, ref: "typeAhead" })));
        if (position) {
            logger_1.default('target, position', target, position);
            if (target) {
                return (react_1.default.createElement(Popup_1.default, { target: target, relativePosition: position, zIndex: zIndex, offsetX: offsetX, offsetY: offsetY, children: typeAhead }));
            }
