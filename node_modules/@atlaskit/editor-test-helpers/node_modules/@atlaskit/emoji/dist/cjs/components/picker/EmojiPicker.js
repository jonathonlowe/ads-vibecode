...
var EmojiPickerInternal = /** @class */ (function (_super) {
    ...
    EmojiPickerInternal.prototype.renderLoading = function () {
        ...
        return (react_1.default.createElement("div", { className: styles.emojiPicker, ref: handlePickerRef }, item.renderItem()));
    };
    EmojiPickerInternal.prototype.renderLoaded = function (loadedEmojiProvider, EmojiPickerComponent) {
        ...
        return (react_1.default.createElement(EmojiPickerComponent, tslib_1.__assign({ emojiProvider: loadedEmojiProvider }, otherProps)));
    };
