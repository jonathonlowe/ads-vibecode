...
var FileChooser = /** @class */ (function (_super) {
    ...
    FileChooser.prototype.render = function () {
        ...
        return (react_1.default.createElement("span", null,
            react_1.default.createElement(button_1.default, { onClick: this.onChooseFile, isDisabled: isDisabled, "aria-label": ariaLabel || label }, label),
            react_1.default.createElement("input", { className: "emojiUploadFileInput", ref: "chooseFile", onChange: onChange, type: "file", accept: accept, style: { display: 'none' } })));
    };
    return FileChooser;
