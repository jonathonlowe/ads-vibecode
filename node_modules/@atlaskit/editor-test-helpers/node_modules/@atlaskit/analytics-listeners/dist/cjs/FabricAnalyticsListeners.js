...
var PeopleTeamsAnalyticsListener_1 = tslib_1.__importDefault(require("./peopleTeams/PeopleTeamsAnalyticsListener"));
var listenerMap = (_a = {},
    ...
    _a[types_1.FabricChannel.peopleTeams] = PeopleTeamsAnalyticsListener_1.default,
    _a);
var FabricAnalyticsListeners = /** @class */ (function (_super) {
    ...
    FabricAnalyticsListeners.prototype.render = function () {
        ...
        var listeners = Object.keys(listenerMap)
            ...
            .reduce(function (prev, Listener) { return (react_1.default.createElement(Listener, { client: client, logger: _this.logger }, prev)); }, children);
        return listeners;
    };
