...
var extract_data_from_event_1 = require("../helpers/extract-data-from-event");
var version_json_1 = require("../version.json");
var PEOPLE_TEAMS_TAG = 'peopleTeams';
/**
...
exports.default = (function (event, logger) {
    var sources = extract_data_from_event_1.getSources(event, analytics_namespaced_context_1.PEOPLE_TEAMS_CONTEXT);
    var source = lodash_last_1.default(sources) || analytics_gas_types_1.DEFAULT_SOURCE;
    var extraAttributes = extract_data_from_event_1.getExtraAttributes(event, analytics_namespaced_context_1.PEOPLE_TEAMS_CONTEXT);
    var components = extract_data_from_event_1.getComponents(event, analytics_namespaced_context_1.PEOPLE_TEAMS_CONTEXT);
    var packages = extract_data_from_event_1.getPackageInfo(event, analytics_namespaced_context_1.PEOPLE_TEAMS_CONTEXT);
    var _a = lodash_last_1.default(extract_data_from_event_1.getPackageInfo(event, analytics_namespaced_context_1.PEOPLE_TEAMS_CONTEXT)) || {}, packageName = _a.packageName, packageVersion = _a.packageVersion;
