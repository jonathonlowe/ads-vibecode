...
exports.extractFromEventContext = function (propertyName, event) {
    return event.context
        .map(function (contextItem) { return contextItem[propertyName]; })
        .filter(Boolean);
};
exports.getActionSubject = function (event) {
    var overrides = exports.extractFromEventContext('actionSubjectOverride', event);
...
exports.getSources = function (event) {
    return exports.extractFromEventContext('source', event);
};
exports.getComponents = function (event) {
    return exports.extractFromEventContext('component', event);
};
exports.getExtraAttributes = function (event) {
    return exports.extractFromEventContext('attributes', event).reduce(function (result, extraAttributes) { return lodash_merge_1.default(result, extraAttributes); }, {});
};
...
exports.getPackageVersion = function (event) {
    return exports.extractFromEventContext('packageVersion', event);
};
