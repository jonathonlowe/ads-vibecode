...
var FabricElementsListener = /** @class */ (function (_super) {
    ...
    FabricElementsListener.prototype.render = function () {
        return (react_1.default.createElement(analytics_next_1.AnalyticsListener, { onEvent: this.handleEventWrapper, channel: types_1.FabricChannel.elements }, this.props.children));
    };
