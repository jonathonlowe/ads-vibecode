...
exports.default = (function (event, logger) {
    var sources = extract_data_from_event_1.getSources(event, analytics_namespaced_context_1.NAVIGATION_CONTEXT);
    var source = lodash_last_1.default(sources) || analytics_gas_types_1.DEFAULT_SOURCE;
    var extraAttributes = extract_data_from_event_1.getExtraAttributes(event, analytics_namespaced_context_1.NAVIGATION_CONTEXT);
    var components = extract_data_from_event_1.getComponents(event, analytics_namespaced_context_1.NAVIGATION_CONTEXT);
    var packages = extract_data_from_event_1.getPackageInfo(event, analytics_namespaced_context_1.NAVIGATION_CONTEXT);
    var _a = lodash_last_1.default(extract_data_from_event_1.getPackageInfo(event, analytics_namespaced_context_1.NAVIGATION_CONTEXT)) || {}, packageName = _a.packageName, packageVersion = _a.packageVersion;
