...
p.iconGradientStart === 'inherit' &&
    ...
    `};
`;
const Wrapper = ({ label, svg, ...rest }) => (React.createElement(Span, Object.assign({ "aria-label": label ? label : undefined, role: label ? 'img' : 'presentation', dangerouslySetInnerHTML: {
