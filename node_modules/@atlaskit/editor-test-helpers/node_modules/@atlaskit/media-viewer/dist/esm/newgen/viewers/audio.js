    ...
    AudioViewer.prototype.renderSuccessful = function (src) {
        ...
        return useCustomAudioPlayer ? (React.createElement(AudioPlayer, null,
            ...
            React.createElement(CustomAudioPlayerWrapper, null,
                React.createElement(CustomMediaPlayer, { type: "audio", isAutoPlay: isAutoPlay, src: src, isShortcutEnabled: true, showControls: showControls, onCanPlay: onCanPlay, onError: onError })))) : (React.createElement(AudioPlayer, null,
            this.renderCover(),
            React.createElement(CustomAudioPlayerWrapper, null,
