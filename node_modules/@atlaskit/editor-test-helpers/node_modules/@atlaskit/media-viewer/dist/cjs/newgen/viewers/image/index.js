...
exports.REQUEST_CANCELLED = 'request_cancelled';
...
var ImageViewer = /** @class */ (function (_super) {
    ...
    ImageViewer.prototype.init = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, file, mediaClient, collectionName, orientation_1, objectUrl, preview, value, item, controller_1, response, _b, _c, err_1;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 9:
                        this.setState({
                            content: domain_1.Outcome.successful({ objectUrl: objectUrl, orientation: orientation_1 }),
                        });
                        return [3 /*break*/, 11];
                    case 10:
                        err_1 = _d.sent();
                        if (err_1.message === exports.REQUEST_CANCELLED) {
    ...
    ImageViewer.prototype.renderSuccessful = function (content) {
        ...
        return (React.createElement(interactive_img_1.InteractiveImg, { onLoad: this.onLoad, onError: this.onError, src: content.objectUrl, orientation: content.orientation, onClose: onClose }));
    };
    return ImageViewer;
