    ...
    AudioViewer.prototype.renderSuccessful = function (src) {
        ...
        return useCustomAudioPlayer ? (React.createElement(styled_1.AudioPlayer, null,
            ...
            React.createElement(styled_1.CustomAudioPlayerWrapper, null,
                React.createElement(media_ui_1.CustomMediaPlayer, { type: "audio", isAutoPlay: isAutoPlay, src: src, isShortcutEnabled: true, showControls: showControls, onCanPlay: onCanPlay, onError: onError })))) : (React.createElement(styled_1.AudioPlayer, null,
            this.renderCover(),
            React.createElement(styled_1.CustomAudioPlayerWrapper, null,
