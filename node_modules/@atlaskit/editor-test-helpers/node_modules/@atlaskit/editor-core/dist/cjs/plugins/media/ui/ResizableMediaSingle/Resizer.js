...
var re_resizable_1 = tslib_1.__importDefault(require("re-resizable"));
...
var Resizer = /** @class */ (function (_super) {
    ...
    function Resizer(props) {
        ...
        _this.handleResizeStart = function (event) {
            ...
            _this.setState({ isResizing: true }, function () {
                _this.props.displayGrid(true, grid_1.gridTypeForLayout(_this.props.layout), _this.props.highlights(_this.props.width, _this.props.snapPoints));
            });
        };
        _this.handleResize = function (_event, _direction, _elementRef, delta) {
            ...
            _this.props.displayGrid(true, grid_1.gridTypeForLayout(newSize.layout), _this.props.highlights(newWidth, _this.props.snapPoints));
            resizable.updateSize({ width: newWidth, height: 'auto' });
        };
        _this.handleResizeStop = function (_event, _direction, _refToElement, delta) {
            var resizable = _this.resizable.current;
            if (!resizable || !resizable.state.original) {
                return;
            }
            var newWidth = Math.max(resizable.state.original.width + delta.width, _this.props.snapPoints[0]);
            var snapWidth = utils_1.snapTo(newWidth, _this.props.snapPoints);
            var newSize = _this.props.calcNewSize(snapWidth, true);
            // show committed grid size
            _this.props.displayGrid(true, grid_1.gridTypeForLayout(newSize.layout), _this.props.highlights(newWidth, _this.props.snapPoints));
            _this.setState({ isResizing: false }, function () {
                _this.props.updateSize(newSize.width, newSize.layout);
                _this.props.displayGrid(false, grid_1.gridTypeForLayout(_this.props.layout));
            });
        };
    ...
    Resizer.prototype.render = function () {
        ...
        return (React.createElement(re_resizable_1.default, { ref: this.resizable, onResize: this.handleResize, size: {
                width: this.props.width,
            }, className: classnames_1.default('media-single', "image-" + this.props.layout, this.props.className, {
