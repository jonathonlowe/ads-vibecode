...
function isEnabled(state) {
    ...
    var isTypeAheadQueryActive = state.selection.$from
        .marks()
        .some(function (mark) { return mark.type === typeAheadQuery; });
    return (isTypeAheadQueryActive ||
        utils_1.isMarkTypeAllowedInCurrentSelection(typeAheadQuery, state));
}
...
var AsciiEmojiTransactionCreator = /** @class */ (function () {
    ...
    AsciiEmojiTransactionCreator.prototype.create = function () {
        ...
        return analytics_1.addAnalytics(tr, {
            ...
            attributes: { inputMethod: analytics_1.INPUT_METHOD.ASCII },
