...
var MediaNode = /** @class */ (function (_super) {
    ...
    MediaNode.prototype.render = function () {
        var _a = this.props, node = _a.node, selected = _a.selected, cardDimensions = _a.cardDimensions, onClick = _a.onClick, allowLazyLoading = _a.allowLazyLoading, viewMediaClientConfig = _a.viewMediaClientConfig, uploadComplete = _a.uploadComplete;
        ...
        , { 
            ...
            // there is a possibility mediaClientConfig will be part of a identifier,
            // so this might be not an issue
            mediaClientConfig: viewMediaClientConfig, resizeMode: "stretchy-fit", dimensions: cardDimensions, identifier: identifier, selectable: true, selected: selected, disableOverlay: true, onClick: onClick, useInlinePlayer: allowLazyLoading, isLazy: allowLazyLoading }));
    };
    return MediaNode;
}(react_1.Component));
