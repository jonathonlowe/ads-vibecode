...
exports.isEmptyParagraph = document_2.isEmptyParagraph;
exports.hasVisibleContent = document_2.hasVisibleContent;
exports.isNodeEmpty = document_2.isNodeEmpty;
exports.isEmptyDocument = document_2.isEmptyDocument;
exports.processRawValue = document_2.processRawValue;
exports.getStepRange = document_2.getStepRange;
exports.findFarthestParentNode = document_2.findFarthestParentNode;
exports.isSelectionEndOfParagraph = document_2.isSelectionEndOfParagraph;
exports.nodesBetweenChanged = document_2.nodesBetweenChanged;
exports.getNodesCount = document_2.getNodesCount;
...
exports.isNodeTypeParagraph = nodes_1.isNodeTypeParagraph;
...
exports.isChromeWithSelectionBug = editor_common_1.browser.chrome && !editor_common_1.browser.android && editor_common_1.browser.chrome_version >= 58;
    ...
    var innerIsEmptyNode = function (node) {
        switch (node.type) {
            ...
            case doc:
                ...
                return isEmpty_1;
            default:
                return document_1.isNodeEmpty(node);
        }
    };
    return innerIsEmptyNode;
};
exports.insideTable = function (state) {
    var _a = state.schema.nodes, table = _a.table, tableCell = _a.tableCell;
    return prosemirror_utils_1.hasParentNodeOfType([table, tableCell])(state.selection);
};
exports.insideTableCell = function (state) {
...
exports.pipe = pipe;
exports.normaliseNestedLayout = function (state, node) {
    if (state.selection.$from.depth > 1) {
        if (node.attrs.layout && node.attrs.layout !== 'default') {
            return node.type.createChecked(tslib_1.__assign(tslib_1.__assign({}, node.attrs), { layout: 'default' }), node.content, node.marks);
        }
