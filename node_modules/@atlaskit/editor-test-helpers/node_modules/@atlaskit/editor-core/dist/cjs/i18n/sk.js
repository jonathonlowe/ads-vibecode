...
exports.default = {
    ...
    'fabric.editor.hyperlinkToolbarPlaceholder': 'Vložte prepojenie alebo hľadajte v naposledy zobrazených',
    ...
    'fabric.editor.clearCells': '{0, plural, one{Vymazať bunku} few{Vymazať bunky} many{Vymazať buniek} other{Vymazať bunky}}',
    'fabric.editor.insertColumn': 'Vložiť stĺpec',
    'fabric.editor.removeColumns': '{0, plural, one{Odstrániť stĺpec} few{Odstrániť stĺpce} many{Odstrániť stĺpcov} other{Odstrániť stĺpce}}',
    'fabric.editor.insertRow': 'Vložiť riadok',
    'fabric.editor.removeRows': '{0, plural, one{Odstrániť riadok} few{Odstrániť riadky} many{Odstrániť riadkov} other{Odstrániť riadky}}',
