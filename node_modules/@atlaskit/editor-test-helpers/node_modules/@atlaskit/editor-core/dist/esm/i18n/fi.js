...
export default {
    ...
    'fabric.editor.hyperlinkToolbarPlaceholder': 'Liitä linkki tai hae äskettäin katsotuista',
    ...
    'fabric.editor.clearCells': '{0, plural, one{Tyhjennä solu} other{Tyhjennä solut}}',
    'fabric.editor.insertColumn': 'Lisää sarake',
    'fabric.editor.removeColumns': '{0, plural, one{Poista sarake} other{Poista sarakkeita}}',
    'fabric.editor.insertRow': 'Lisää rivi',
    'fabric.editor.removeRows': '{0, plural, one{Poista rivi} other{Poista rivejä}}',
