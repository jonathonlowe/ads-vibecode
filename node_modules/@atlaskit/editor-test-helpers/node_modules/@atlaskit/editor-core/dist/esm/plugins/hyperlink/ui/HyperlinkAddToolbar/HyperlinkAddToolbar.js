    ...
    function LinkAddToolbar(props) {
        ...
        _this.handleSubmit = function () {
            ...
            if (items && items.length > 0 && selectedIndex > -1) {
                ...
                if (_this.props.onSubmit) {
                    _this.props.onSubmit(item.url, _this.state.displayText || item.name, INPUT_METHOD.TYPEAHEAD);
                ...
                if (_this.props.onSubmit) {
                    ...
                    _this.props.onSubmit(text, _this.state.displayText || text, INPUT_METHOD.MANUAL);
