...
export var indent = createIndentationCommandWithAnalytics(getIndentAttrs, INDENT_DIR.INDENT);
/**
 * Get new level for outdent
 * @param oldAttr Old attributes for the mark, undefined if the mark doesn't exit
 * @returns  - undefined; No change required
...
export var outdent = createIndentationCommandWithAnalytics(getOutdentAttrs, INDENT_DIR.OUTDENT);
