...
var initCollab = function (collabEditProvider, view) {
    collabEditProvider.initialize(function () { return view.state; }, function (json) { return Step.fromJSON(view.state.schema, json); });
};
var initCollabMemo = memoizeOne(initCollab);
export var createPlugin = function (dispatch, providerFactory, options, sanitizePrivateContent) {
    ...
    return new Plugin({
        ...
        view: function (view) {
            var _this = this;
            providerFactory.subscribe('collabEditProvider', function (_name, providerPromise) { return __awaiter(_this, void 0, void 0, function () {
                var pluginState;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            collabEditProvider
                                ...
                                handleInit(data, view, options, providerFactory, sanitizePrivateContent);
                            })
