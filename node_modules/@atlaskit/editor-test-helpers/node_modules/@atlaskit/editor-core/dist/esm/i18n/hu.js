...
export default {
    ...
    'fabric.editor.hyperlinkToolbarPlaceholder': 'Hivatkozás beillesztése vagy keresés a legutóbb megtekintett lapokon',
    ...
    'fabric.editor.clearCells': '{0, plural, one{Cella törlése} other{Cellák törlése}}',
    'fabric.editor.insertColumn': 'Oszlop beszúrása',
    'fabric.editor.removeColumns': '{0, plural, one{Oszlop eltávolítása} other{Oszlopok eltávolítása}}',
    'fabric.editor.insertRow': 'Sor beszúrása',
    'fabric.editor.removeRows': '{0, plural, one{Sor eltávolítása} other{Sorok eltávolítása}}',
