...
var ProfilecardTrigger = /** @class */ (function (_super) {
    ...
    ProfilecardTrigger.prototype.renderProfileCard = function () {
        ...
        return (react_1.default.createElement(ProfileCard_1.default, tslib_1.__assign({}, newProps, { actions: this.filterActions(), customElevation: "none", hasError: this.state.hasError, errorType: this.state.error })));
    };
    ProfilecardTrigger.prototype.renderWithPopper = function (element) {
        var _this = this;
        return (react_1.default.createElement(popper_1.Popper, { referenceElement: this.targetRef, placement: this.props.position }, function (_a) {
            var ref = _a.ref, style = _a.style;
            return (react_1.default.createElement(CardElevationWrapperWithOuter, tslib_1.__assign({ style: style, innerRef: ref }, _this.containerListeners, _this.layerListeners, { customElevation: _this.props.customElevation }), element));
        }));
    };
    ProfilecardTrigger.prototype.renderLoading = function () {
        ...
        return visible && isFetchingOrNotStartToFetchYet && this.targetRef
            ? this.renderWithPopper(react_1.default.createElement(LoadingState_1.default, null))
            : null;
    };
    ...
    ProfilecardTrigger.prototype.renderWithTrigger = function () {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(Card_1.CardTriggerWrapper, tslib_1.__assign({}, this.containerListeners),
                react_1.default.createElement(react_node_resolver_1.default, { innerRef: this.setRef }, this.props.children)),
            react_1.default.createElement(portal_1.default, { zIndex: constants_1.layers.tooltip() },
                this.renderLoading(),
