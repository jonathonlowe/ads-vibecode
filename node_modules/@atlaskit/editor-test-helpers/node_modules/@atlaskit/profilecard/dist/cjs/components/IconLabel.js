...
var IconLabel = /** @class */ (function (_super) {
    ...
    IconLabel.prototype.render = function () {
        ...
        var displayIcon = IconElement ? (react_1.default.createElement(IconElement, { label: "icon " + this.props.icon, size: "small" })) : null;
        return (react_1.default.createElement(Card_1.DetailsLabel, null,
            react_1.default.createElement(Card_1.DetailsLabelIcon, null, displayIcon),
            react_1.default.createElement(Card_1.DetailsLabelText, null, this.props.children)));
    };
