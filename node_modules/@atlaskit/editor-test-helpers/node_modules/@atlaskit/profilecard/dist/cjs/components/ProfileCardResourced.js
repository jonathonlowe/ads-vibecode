...
var ProfileCardResourced = /** @class */ (function (_super) {
    ...
    ProfileCardResourced.prototype.render = function () {
        ...
        if (isFetchingOrNotStartToFetchYet) {
            return (react_1.default.createElement(Card_1.CardElevationWrapper, { customElevation: customElevation },
                react_1.default.createElement(LoadingState_1.default, null)));
        }
        else if (hasError) {
            return (react_1.default.createElement(Card_1.CardElevationWrapper, { customElevation: customElevation },
                react_1.default.createElement(ErrorMessage_1.default, { errorType: error, reload: this.clientFetchProfile })));
        }
        ...
        return (react_1.default.createElement(Card_1.CardElevationWrapper, { customElevation: customElevation },
            react_1.default.createElement(ProfileCard_1.default, tslib_1.__assign({}, newProps, { actions: this.filterActions(), customElevation: "none" }))));
    };
