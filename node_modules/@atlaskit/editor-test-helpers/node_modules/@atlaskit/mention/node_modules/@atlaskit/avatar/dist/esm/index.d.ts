export { default, AvatarPropTypes } from './Avatar';
export { default as AvatarItem, AvatarItemProps } from './AvatarItem';
...
export { AvatarClickType, AppearanceType, SizeType, IndicatorSizeType, } from './types';
