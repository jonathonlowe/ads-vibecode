...
export default {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': 'Mais de 50 membros, incluindo o utilizador',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} membro} other {{0} membros}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} membro, incluindo o utilizador} other {{0} membros, incluindo o utilizador}}',
