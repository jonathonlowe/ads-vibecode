...
export default {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': '50+ leden, inclusief jezelf',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} lid} other {{0} leden}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} lid, inclusief jijzelf} other {{0} leden, inclusief jijzelf}}',
