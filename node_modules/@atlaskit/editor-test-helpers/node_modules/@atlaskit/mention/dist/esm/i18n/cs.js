...
export default {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': '50+ členů včetně vás',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} člen} few {{0} členové} many {{0} člena} other {{0} členů}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} člen (včetně vás)} few {{0} členové (včetně vás)} many {{0} člena (včetně vás)} other {{0} členů (včetně vás)}}',
