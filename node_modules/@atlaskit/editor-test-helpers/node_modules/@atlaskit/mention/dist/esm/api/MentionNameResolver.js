...
var DefaultMentionNameResolver = /** @class */ (function () {
    function DefaultMentionNameResolver(client, analyticsProps) {
        ...
        this.processQueue = function () {
            ...
            _this.processingQueue = new Map(__spread(_this.processingQueue, queue));
            _this.client
    ...
    DefaultMentionNameResolver.prototype.lookupName = function (id) {
        ...
        return new Promise(function (resolve) {
            ...
            if (processingItems) {
                _this.processingQueue.set(id, __spread(processingItems, [resolve]));
            }
            var queuedItems = _this.nameQueue.get(id) || [];
            _this.nameQueue.set(id, __spread(queuedItems, [resolve]));
...
export { DefaultMentionNameResolver };
