...
function applyPresence(mentions, presences) {
    ...
    for (var i = 0; i < mentions.length; i++) {
        // Shallow copy
        var mention = __assign({}, mentions[i]);
...
var ResourcedMentionListWithoutAnalytics = /** @class */ (function (_super) {
    __extends(ResourcedMentionListWithoutAnalytics, _super);
    function ResourcedMentionListWithoutAnalytics(props) {
        ...
        _this.mentionsHighlight = function () {
            ...
            var enabledViaLocalStorage = TeamMentionHighlightController.isHighlightEnabled();
            ...
            return (React.createElement(TeamMentionHighlight, { createTeamLink: createTeamPath, onClose: _this.closeHighlight }));
        };
...
export { ResourcedMentionListWithoutAnalytics };
