...
var MentionPicker = /** @class */ (function (_super) {
    __extends(MentionPicker, _super);
    ...
    MentionPicker.prototype.render = function () {
        ...
        var resourceMentionList = (React.createElement(ResourcedMentionList, { resourceProvider: resourceProvider, presenceProvider: presenceProvider, onSelection: onSelection, query: query, ref: this.handleMentionListRef, isTeamMentionHighlightEnabled: !!showTeamMentionsHighlight, createTeamPath: createTeamPath }));
