...
export default {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': 'Ponad 50 członków, wliczając Ciebie',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} członek} few {{0} członków} many {{0} członków} other {{0} członka}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} członek razem z Tobą} few {{0} członków razem z Tobą} many {{0} członków razem z Tobą} other {{0} członka razem z Tobą}}',
