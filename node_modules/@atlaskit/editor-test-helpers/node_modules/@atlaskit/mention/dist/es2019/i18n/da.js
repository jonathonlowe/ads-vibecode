...
export default {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': '50+ medlemmer, inklusive dig',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} medlem} other {{0} medlemmer}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} medlem, inklusive dig} other {{0} medlemmer, inklusive dig}}',
