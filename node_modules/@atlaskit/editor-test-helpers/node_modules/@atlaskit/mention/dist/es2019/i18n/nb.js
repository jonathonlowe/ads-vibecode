...
export default {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': '50 medlemmer eller mer, medregnet deg',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} medlem} other {{0} medlemmer}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} medlem, medregnet deg} other {{0} medlemmer, medregnet deg}}',
    'fabric.elements.mentions.team.mention.highlight.description': 'Få alle på siden med ett trykk. Inget lag?',
