...
export default class MentionList extends React.PureComponent {
    constructor(props) {
        ...
        this.selectIndexOnHover = (mention, event) => {
            if (!event) {
                return;
            }
        ...
        if (mentions && mentions.length) {
            ...
            return (React.createElement("div", null,
                ...
                mentions.map((mention, idx) => {
                    ...
                    const item = (React.createElement(MentionItem, { mention: mention, selected: this.isSelectedMention(mention, idx), key: key, onMouseMove: this.selectIndexOnHover, 
                        /* Cannot use onclick, as onblur will close the element, and prevent
                         * onClick from firing.
                         */
                        onSelection: this.itemSelected, ref: ref => {
                            if (ref) {
                                this.items[key] = ref;
                            }
                            else {
