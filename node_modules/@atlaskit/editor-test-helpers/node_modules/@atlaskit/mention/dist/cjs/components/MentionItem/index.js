...
function renderLozenge(lozenge) {
    if (lozenge) {
        return react_1.default.createElement(lozenge_1.default, null, lozenge);
    }
    return null;
}
function renderTime(time) {
    if (time) {
        return react_1.default.createElement(styles_1.TimeStyle, null, time);
    }
    return null;
}
var MentionItem = /** @class */ (function (_super) {
    ...
    MentionItem.prototype.render = function () {
        ...
        return (react_1.default.createElement(styles_1.MentionItemStyle, { selected: selected, onMouseDown: this.onMentionSelected, onMouseMove: this.onMentionMenuItemMouseMove, onMouseEnter: this.onMentionMenuItemMouseEnter, "data-mention-id": id, "data-mention-name": mentionName },
            react_1.default.createElement(styles_1.RowStyle, null,
                react_1.default.createElement(styles_1.AvatarStyle, { restricted: restricted },
                    react_1.default.createElement(avatar_1.default, { src: avatarUrl, size: "medium", presence: status, borderColor: borderColor })),
                react_1.default.createElement(styles_1.NameSectionStyle, { restricted: restricted },
                    MentionHighlightHelpers_1.renderHighlight(styles_1.FullNameStyle, name, nameHighlights),
                    react_1.default.createElement(MentionDescriptionByline_1.default, { mention: mention })),
                react_1.default.createElement(styles_1.InfoSectionStyle, { restricted: restricted },
                    renderLozenge(lozenge),
                    renderTime(time)),
                restricted ? (react_1.default.createElement(NoAccessTooltip_1.NoAccessTooltip, { name: name },
                    react_1.default.createElement(styles_1.AccessSectionStyle, null,
                        react_1.default.createElement(i18n_1.NoAccessLabel, null, function (text) { return (react_1.default.createElement(lock_circle_1.default, { label: text })); } /* safe to cast to string given there is no value binding */)))) : null)));
    };
    return MentionItem;
