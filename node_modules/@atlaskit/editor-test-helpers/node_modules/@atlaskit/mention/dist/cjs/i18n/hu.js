...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': '50+ tag, ideértve téged is',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} tag} other {{0} tag}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} tag, veled együtt} other {{0} tag, veled együtt}}',
