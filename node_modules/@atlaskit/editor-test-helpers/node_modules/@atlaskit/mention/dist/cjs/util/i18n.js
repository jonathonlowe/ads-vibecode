...
exports.noPropFormatter = function (messageDescriptor) { return function (props) { return (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, props, messageDescriptor))); }; };
exports.NoAccessWarning = function (_a) {
    var name = _a.name, props = tslib_1.__rest(_a, ["name"]);
    return (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, props, { values: { name: name } }, i18n_1.messages.noAccessWarning)));
};
