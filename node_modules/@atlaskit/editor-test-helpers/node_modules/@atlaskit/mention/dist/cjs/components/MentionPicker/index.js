...
var MentionPicker = /** @class */ (function (_super) {
    ...
    MentionPicker.prototype.render = function () {
        ...
        var resourceMentionList = (react_1.default.createElement(ResourcedMentionList_1.default, { resourceProvider: resourceProvider, presenceProvider: presenceProvider, onSelection: onSelection, query: query, ref: this.handleMentionListRef, isTeamMentionHighlightEnabled: !!showTeamMentionsHighlight, createTeamPath: createTeamPath }));
        var infoContent = info && !visible ? (react_1.default.createElement(styles_1.MentionPickerInfoStyle, null,
            react_1.default.createElement("p", null, info))) : null;
        var content;
        if (position) {
            logger_1.default('target, position', target, position);
            if (target) {
                content = (react_1.default.createElement(Popup_1.default, { target: target, relativePosition: position, zIndex: zIndex, offsetX: offsetX, offsetY: offsetY },
        ...
        react_1.default.createElement(styles_1.MentionPickerStyle, { className: "ak-mention-picker", visible: visible || info }, content));
    };
