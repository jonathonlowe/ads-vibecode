...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': '50+ jäsentä, mukaan lukien sinut',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} jäsen} other {{0} jäsentä}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} jäsen, mukaan luettuna sinä} other {{0} jäsentä, mukaan luettuna sinä}}',
