    ...
    MentionDescriptionByline.prototype.render = function () {
        ...
        switch (userType) {
            case types_1.UserType[types_1.UserType.TEAM]: {
                return react_1.default.createElement(TeamMentionDescriptionByline_1.default, { mention: this.props.mention });
            }
            default: {
                return react_1.default.createElement(UserMentionDescriptionByline_1.default, { mention: this.props.mention });
            }
        }
    };
