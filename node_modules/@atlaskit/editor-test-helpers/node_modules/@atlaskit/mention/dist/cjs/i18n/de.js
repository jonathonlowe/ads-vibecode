...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': 'Mehr als 50 Mitglieder, einschließlich Ihnen',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} Mitglied} other {{0} Mitglieder}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} Mitglied, Sie eingeschlossen} other {{0} Mitglieder, Sie eingeschlossen}}',
