...
var MentionResource_1 = tslib_1.__importDefault(require("./MentionResource"));
...
var TeamMentionResource = /** @class */ (function (_super) {
    ...
    TeamMentionResource.prototype.remoteInitialStateTeamAndUsers = function (contextIdentifier) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                getTeamsPromise = util_service_support_1.utils.requestService(this.teamMentionConfig, options);
                ...
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        if (userRequestError && teamRequestError) {
                            ...
                            logger_1.default('User mention request fails. ', userRequestError);
                            logger_1.default('Team mention request fails. ', teamRequestError);
                        }
                        return [2 /*return*/];
                }
            });
    ...
    TeamMentionResource.prototype.getQueryParamsOfTeamMentionConfig = function (contextIdentifier) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, configParams), contextIdentifier);
    };
    TeamMentionResource.prototype.remoteUserSearch = function (query, contextIdentifier) {
        return _super.prototype.remoteSearch.call(this, query, contextIdentifier);
    };
    TeamMentionResource.prototype.remoteTeamSearch = function (query, contextIdentifier) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var options, teamResult, error_3;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, util_service_support_1.utils.requestService(this.teamMentionConfig, options)];
                    case 2:
                        teamResult = _a.sent();
                        this._notifyAnalyticsListeners(analytics_1.SLI_EVENT_TYPE, analytics_1.SliNames.SEARCH_TEAM, analytics_1.Actions.SUCCEEDED);
                        return [2 /*return*/, this.convertTeamResultToMentionResult(teamResult, query)];
                    case 3:
                        error_3 = _a.sent();
                        this._notifyAnalyticsListeners(analytics_1.SLI_EVENT_TYPE, analytics_1.SliNames.SEARCH_TEAM, analytics_1.Actions.FAILED);
                        throw error_3;
    ...
    TeamMentionResource.prototype.convertTeamResultToMentionResult = function (result, query) {
        ...
        var mentions = result.map(function (team) {
            ...
            return {
                ...
                accessLevel: types_1.UserAccessLevel[types_1.UserAccessLevel.CONTAINER],
                userType: types_1.UserType[types_1.UserType.TEAM],
