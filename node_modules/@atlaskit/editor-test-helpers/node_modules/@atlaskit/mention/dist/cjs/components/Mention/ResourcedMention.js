...
var ResourcedMention = /** @class */ (function (_super) {
    ...
    ResourcedMention.prototype.render = function () {
        ...
        return (react_1.default.createElement(_1.default, { id: props.id, text: state.resolvedMentionName || props.text, isHighlighted: state.isHighlighted, accessLevel: props.accessLevel, onClick: props.onClick, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave }));
    };
