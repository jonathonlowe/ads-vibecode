...
})(SliNames = exports.SliNames || (exports.SliNames = {}));
var ComponentNames;
...
exports.fireSliAnalyticsEvent = function (props) { return function (actionSubject, action) {
    if (props.createAnalyticsEvent) {
        var eventPayload = exports.buildSliPayload(actionSubject, action);
        props.createAnalyticsEvent(eventPayload).fire(_constants_1.ELEMENTS_CHANNEL);
    }
}; };
exports.buildSliPayload = function (actionSubject, action) {
    var eventPayload = {
        action: action,
        actionSubject: actionSubject,
        eventType: analytics_gas_types_1.OPERATIONAL_EVENT_TYPE,
