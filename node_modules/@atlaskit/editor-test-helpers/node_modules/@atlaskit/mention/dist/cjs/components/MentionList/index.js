...
var MentionList = /** @class */ (function (_super) {
        ...
        if (mentions && mentions.length) {
            ...
            return (react_1.default.createElement("div", null,
                ...
                mentions.map(function (mention, idx) {
                    var key = mention.id;
                    var item = (react_1.default.createElement(MentionItem_1.default, { mention: mention, selected: _this.isSelectedMention(mention, idx), key: key, onMouseMove: _this.selectIndexOnHover, 
    ...
    MentionList.prototype.render = function () {
        ...
        var resultSection;
        if (mustShowError) {
            errorSection = react_1.default.createElement(MentionListError_1.default, { error: resourceError });
        }
        else if (hasMentions) {
            resultSection = (react_1.default.createElement(Scrollable_1.default, { ref: this.handleScrollableRef }, this.renderItems()));
        }
        return (react_1.default.createElement(styles_1.MentionListStyle, { empty: !hasMentions && !resourceError },
            errorSection,
            resultSection));
    };
    return MentionList;
