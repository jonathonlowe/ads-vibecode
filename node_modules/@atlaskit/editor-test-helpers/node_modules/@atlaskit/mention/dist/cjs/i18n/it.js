...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.50plus.including.you': 'Più di 50 membri, incluso te',
    'fabric.elements.mentions.team.member.count': '{0, plural, one {{0} membro} other {{0} membri}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one {{0} membro, tu incluso} other {{0} membri, tu incluso}}',
