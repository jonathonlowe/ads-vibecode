...
var MentionInternal = /** @class */ (function (_super) {
    ...
    MentionInternal.prototype.renderUnknownUserError = function (id) {
        return (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, i18n_1.messages.unknownUserError, { values: { userId: id.slice(-5) } }), function (message) { return "@" + message; }));
    };
    MentionInternal.prototype.render = function () {
        ...
        var mentionComponent = (react_1.default.createElement(styles_1.MentionStyle, { mentionType: mentionType, onClick: handleOnClick, onMouseEnter: handleOnMouseEnter, onMouseLeave: handleOnMouseLeave }, failedMention ? this.renderUnknownUserError(id) : text || '@...'));
        return (react_1.default.createElement("span", { "data-mention-id": id, "data-access-level": accessLevel, spellCheck: false }, mentionType === types_1.MentionType.RESTRICTED ? (react_1.default.createElement(NoAccessTooltip_1.NoAccessTooltip, { name: text }, mentionComponent)) : (mentionComponent)));
    };
