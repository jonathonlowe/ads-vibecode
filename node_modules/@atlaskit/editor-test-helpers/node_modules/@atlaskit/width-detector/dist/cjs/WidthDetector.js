...
var WidthDetector = /** @class */ (function (_super) {
    ...
    function WidthDetector(props) {
        ...
        _this.state = {};
        _this.handleResize = raf_schd_1.default(function () {
    ...
    WidthDetector.prototype.render = function () {
        ...
        var sizerEl = (react_1.default.createElement("object", { type: "text/html", style: sizerStyle, ref: this.handleObjectRef, onLoad: this.handleObjectLoad, "aria-hidden": true, tabIndex: -1 }));
        ...
        return (react_1.default.createElement("div", tslib_1.__assign({}, props, { style: tslib_1.__assign(tslib_1.__assign({}, containerDivStyle), containerStyle), ref: this.handleContainerRef }),
