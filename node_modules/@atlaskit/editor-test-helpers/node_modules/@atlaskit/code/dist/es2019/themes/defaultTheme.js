...
export const defaultColors = memoizeOne((theme) => {
    const akTheme = { theme };
    return {
        lineNumberColor: themed({ light: colors.N90, dark: colors.DN90 })(akTheme),
        lineNumberBgColor: themed({ light: colors.N30, dark: colors.DN20 })(akTheme),
        backgroundColor: themed({ light: colors.N20, dark: colors.DN50 })(akTheme),
        textColor: themed({ light: colors.N800, dark: colors.DN800 })(akTheme),
        substringColor: themed({ light: colors.N400, dark: colors.DN400 })(akTheme),
        keywordColor: themed({ light: colors.B400, dark: colors.B100 })(akTheme),
        attributeColor: themed({ light: colors.T300, dark: colors.T200 })(akTheme),
        selectorTagColor: themed({ light: colors.B400, dark: colors.B100 })(akTheme),
        ...
        templateVariableColor: themed({ light: colors.T300, dark: colors.T200 })(akTheme),
        linkColor: themed({ light: colors.P300, dark: colors.P100 })(akTheme),
        selectorAttributeColor: themed({ light: colors.T300, dark: colors.T200 })(akTheme),
        selectorPseudoColor: themed({ light: colors.T300, dark: colors.T200 })(akTheme),
        typeColor: themed({ light: colors.T500, dark: colors.T300 })(akTheme),
        stringColor: themed({ light: colors.G300, dark: colors.G300 })(akTheme),
        selectorIdColor: themed({ light: colors.T500, dark: colors.T300 })(akTheme),
        selectorClassColor: themed({ light: colors.T500, dark: colors.T300 })(akTheme),
        quoteColor: themed({ light: colors.T500, dark: colors.T300 })(akTheme),
        templateTagColor: themed({ light: colors.T500, dark: colors.T300 })(akTheme),
        ...
        metaKeywordColor: themed({ light: colors.G300, dark: colors.G300 })(akTheme),
        metaColor: themed({ light: colors.N400, dark: colors.DN400 })(akTheme),
        functionColor: themed({ light: colors.N800, dark: colors.DN800 })(akTheme),
