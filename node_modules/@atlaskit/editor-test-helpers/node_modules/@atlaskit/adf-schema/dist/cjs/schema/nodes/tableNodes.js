...
exports.setCellAttrs = function (node, cell) {
    ...
    if (node.attrs.background) {
        ...
        var ignored = (nodeType === 'tableHeader' &&
            background === exports.tableBackgroundColorNames.get('gray')) ||
            (nodeType === 'tableCell' &&
...
exports.tableBackgroundBorderColors = {
    blue: colors_1.B75,
    teal: colors_1.T75,
    red: colors_1.R75,
    gray: colors_1.N40,
...
exports.tableCell = {
    content: '(paragraph | panel | blockquote | orderedList | bulletList | rule | heading | codeBlock |  mediaGroup | mediaSingle | applicationCard | decisionList | taskList | blockCard | extension | unsupportedBlock)+',
    attrs: cellAttrs,
    tableRole: 'cell',
    marks: 'alignment',
    isolating: true,
