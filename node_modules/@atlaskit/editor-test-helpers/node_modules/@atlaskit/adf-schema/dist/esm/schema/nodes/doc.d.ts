...
import { CodeBlockDefinition as CodeBlock, CodeBlockWithMarksDefinition as CodeBlockWithMarks } from './code-block';
 ...
 * @name block_content
 */
export declare type BlockContent = Panel | Paragraph | ParagraphWithMarks | Blockquote | OrderedList | BulletList | Rule | Heading | HeadingWithMarks | CodeBlock | MediaGroup | MediaSingle | ApplicationCard | DecisionList | TaskList | Table | Extension | BodiedExtension | BlockCard;
/**
 * @name table_cell_content
 * @minItems 1
 * @allowUnsupportedBlock true
 */
export declare type TableCellContent = Array<Panel | Paragraph | ParagraphWithMarks | Blockquote | OrderedList | BulletList | Rule | Heading | HeadingWithMarks | CodeBlock | MediaGroup | MediaSingle | ApplicationCard | DecisionList | TaskList | Extension | BlockCard>;
/**
 * @name extension_content
 * @minItems 1
 * @allowUnsupportedBlock true
 */
export declare type ExtensionContent = Array<Panel | Paragraph | Blockquote | OrderedList | BulletList | Rule | Heading | CodeBlock | MediaGroup | MediaSingle | ApplicationCard | DecisionList | TaskList | Table | Extension | BlockCard>;
/**
 ...
 */
export declare type InlineFormattedText = Text & MarksObject<Link | Em | Strong | Strike | SubSup | Underline | TextColor | Action | Annotation>;
/**
 ...
 */
export declare type InlineAtomic = HardBreak | Mention | Emoji | InlineExtension | Date | Placeholder | InlineCard | Status;
/**
 * @name inline_node
 */
