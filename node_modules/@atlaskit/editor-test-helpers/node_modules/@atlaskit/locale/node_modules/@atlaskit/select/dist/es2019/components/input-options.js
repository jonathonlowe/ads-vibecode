...
class ControlOption extends Component {
    constructor() {
        ...
        this.onMouseDown = () => this.setState({ isActive: true });
        this.onMouseUp = () => this.setState({ isActive: false });
        this.onMouseLeave = () => this.setState({ isActive: false });
    }
    render() {
        ...
        return (jsx("div", Object.assign({ css: styles, className: classes, ref: innerRef }, props),
            jsx("div", { css: {
                    alignItems: 'center',
                    display: 'flex ',
                    flexShrink: 0,
                    paddingRight: '4px',
                } }, !!Icon ? (jsx(Icon, { label: "", primaryColor: getPrimaryColor({ ...this.props, ...this.state }), secondaryColor: getSecondaryColor({
                    ...this.props,
                    ...this.state,
                }) })) : null),
            jsx("div", { css: {
...
export const CheckboxOption = props => (jsx(ControlOption, Object.assign({ Icon: CheckboxIcon }, props)));
export const RadioOption = props => (jsx(ControlOption, Object.assign({ Icon: RadioIcon }, props)));
