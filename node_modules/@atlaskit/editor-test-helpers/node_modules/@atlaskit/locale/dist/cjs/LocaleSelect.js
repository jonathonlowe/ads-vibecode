...
var LocaleSelect = /** @class */ (function (_super) {
    ...
    LocaleSelect.prototype.render = function () {
        ...
        return (react_1.default.createElement(select_1.default, { options: locales, defaultValue: defaultLocale, onChange: function (locale) { return onLocaleChange(locale); }, styles: {
