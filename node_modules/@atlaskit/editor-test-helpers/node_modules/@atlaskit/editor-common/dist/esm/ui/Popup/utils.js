...
export function calculatePosition(_a) {
    var placement = _a.placement, target = _a.target, popup = _a.popup, offset = _a.offset, stick = _a.stick, _b = _a.allowOutOfBounds, allowOutOfBounds = _b === void 0 ? false : _b;
    var position = {};
    ...
    var _c = __read(placement, 2), verticalPlacement = _c[0], horizontalPlacement = _c[1];
    var _d = popupOffsetParent.getBoundingClientRect(), popupOffsetParentTop = _d.top, popupOffsetParentLeft = _d.left, popupOffsetParentRight = _d.right, popupOffsetParentHeight = _d.height;
