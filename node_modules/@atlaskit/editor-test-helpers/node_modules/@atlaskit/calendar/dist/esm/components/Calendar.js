...
import { createLocalizationProvider, LocalizationProvider } from '@atlaskit/locale';
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", _extends({}, innerProps, {
        ...
        role: "grid",
        tabIndex: 0
      }, React.createElement(Heading // The month number needs to be translated to index in the month
      ...
      , {
        ...
        role: "presentation"
      }, React.createElement(CalendarThead, null, React.createElement("tr", null, l10n.getDaysShort().map(function (shortDay) {
