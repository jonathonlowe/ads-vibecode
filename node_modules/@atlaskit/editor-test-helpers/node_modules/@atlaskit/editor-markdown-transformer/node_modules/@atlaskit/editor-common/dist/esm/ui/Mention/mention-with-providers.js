...
var MentionWithProviders = /** @class */ (function (_super) {
    __extends(MentionWithProviders, _super);
    ...
    MentionWithProviders.prototype.render = function () {
        ...
        var MentionComponent = profilecardProvider && GENERIC_USER_IDS.indexOf(id) === -1
            ...
            : ResourcedMention;
        return (React.createElement(MentionComponent, __assign({ id: id, text: text, accessLevel: accessLevel, userType: userType, mentionProvider: mentionProvider, profilecardProvider: profilecardProvider, portal: portal }, actionHandlers)));
    };
