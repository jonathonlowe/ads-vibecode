...
var MentionWithProviders = /** @class */ (function (_super) {
    ...
    MentionWithProviders.prototype.render = function () {
        ...
        return (react_1.default.createElement(MentionComponent, tslib_1.__assign({ id: id, text: text, accessLevel: accessLevel, userType: userType, mentionProvider: mentionProvider, profilecardProvider: profilecardProvider, portal: portal }, actionHandlers)));
    };
