...
var MentionWithProfileCard = /** @class */ (function (_super) {
    ...
    MentionWithProfileCard.prototype.render = function () {
        ...
        return (react_1.default.createElement("span", { ref: this.handleRef, onClick: this.showProfilecard },
            react_1.default.createElement(mention_1.ResourcedMention, { ref: this.handleMentionNodeRef, id: id, text: text, accessLevel: accessLevel, mentionProvider: mentionProvider, onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }),
            target && portal && visible && (react_1.default.createElement(Popup_1.default, { offset: [0, 8], target: target, mountTo: portal, alignX: popupAlignX, alignY: popupAlignY },
                react_1.default.createElement(ProfilecardResourcedWithListeners, { handleClickOutside: this.hideProfilecard, handleEscapeKeydown: this.hideProfilecard, cloudId: cloudId, userId: id, resourceClient: resourceClient, actions: this.getActions(id, text, accessLevel) })))));
    };
