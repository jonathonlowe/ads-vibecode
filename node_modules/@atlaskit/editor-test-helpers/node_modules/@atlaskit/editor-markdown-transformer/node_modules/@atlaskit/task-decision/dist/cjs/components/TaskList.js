...
var TaskList = /** @class */ (function (_super) {
    ...
    TaskList.prototype.render = function () {
        ...
        var listSize = react_1.default.Children.count(children);
        if (!children) {
            return null;
        }
        ...
        return (react_1.default.createElement(ListWrapper_1.TaskListWrapper, { "data-task-list-local-id": "" }, react_1.default.Children.map(children, function (child, idx) {
            ...
            return (react_1.default.createElement(analytics_namespaced_context_1.FabricElementsAnalyticsContext, { data: {
                ...
                react_1.default.createElement("div", { key: idx, "data-task-local-id": localId || '' }, child)));
        })));
    };
    return TaskList;
