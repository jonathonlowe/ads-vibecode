...
var ColorButton = /** @class */ (function (_super) {
    ...
    ColorButton.prototype.render = function () {
        ...
        return (react_1.default.createElement(colorButtonStyles_1.ColorSample, { style: style, onClick: onClick }, this.checkMark()));
    };
    ColorButton.prototype.checkMark = function () {
        var isSelected = this.props.isSelected;
        if (isSelected) {
            return (react_1.default.createElement(colorButtonStyles_1.CheckArea, null,
                react_1.default.createElement(check_1.default, { label: "check", size: "medium" })));
        }
        return null;
    };
    return ColorButton;
