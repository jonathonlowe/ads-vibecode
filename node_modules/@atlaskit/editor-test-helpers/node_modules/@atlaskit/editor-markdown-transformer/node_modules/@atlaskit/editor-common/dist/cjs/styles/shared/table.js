...
exports.TableSharedCssClassName = {
    ...
    TABLE_STICKY_SHADOW: adf_schema_1.tablePrefixSelector + "-sticky-shadow",
    TABLE_STICKY_WRAPPER: adf_schema_1.tablePrefixSelector + "-sticky-wrapper",
...
var tableSharedStyle = styled_components_1.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  .", " {\n    position: relative;\n    margin: 0 auto ", "px;\n    box-sizing: border-box;\n\n    /**\n     * Fix block top alignment inside table cells.\n     */\n    .decisionItemView-content-wrap:first-child > div {\n      margin-top: 0;\n    }\n  }\n  .", "[data-number-column='true'] {\n    padding-left: ", "px;\n  }\n  /* avoid applying styles to nested tables (possible via extensions) */\n  .", " > table,\n  .", " > table,\n  .", " > table {\n    border-collapse: collapse;\n    margin: ", "px ", "px 0 0;\n    border: ", "px solid ", ";\n    table-layout: fixed;\n    font-size: 1em;\n    width: 100%;\n\n    &[data-autosize='true'] {\n      table-layout: auto;\n    }\n\n    & {\n      * {\n        box-sizing: border-box;\n      }\n      hr {\n        box-sizing: content-box;\n      }\n\n      tbody {\n        border-bottom: none;\n      }\n      th td {\n        background-color: white;\n      }\n      th,\n      td {\n        min-width: ", "px;\n        font-weight: normal;\n        vertical-align: top;\n        border: 1px solid ", ";\n        border-right-width: 0;\n        border-bottom-width: 0;\n        padding: ", "px;\n        /* https://stackoverflow.com/questions/7517127/borders-not-shown-in-firefox-with-border-collapse-on-table-position-relative-o */\n        ", "\n\n        > *:first-child {\n          margin-top: 0;\n        }\n\n        > .ProseMirror-gapcursor.-right:first-child + * {\n          margin-top: 0;\n        }\n\n        > .ProseMirror-gapcursor:first-child + span + * {\n          margin-top: 0;\n        }\n\n        th p:not(:first-of-type),\n        td p:not(:first-of-type) {\n          margin-top: 12px;\n        }\n      }\n      th {\n        background-color: ", ";\n        text-align: left;\n\n        .code-block {\n          /*\n            Add a background color tint to code blocks inside a table heading since they both\n            share the same background colour. This prevents them visually blending together.\n          */\n          background: ", ";\n\n          > span {\n            /*\n              The codeblock inside @atlaskit/code uses inline styles so we disable the default\n              background color because editor/renderer provides it's own background colours.\n            */\n            background: transparent !important;\n          }\n        }\n      }\n    }\n  }\n"], ["\n  .", " {\n    position: relative;\n    margin: 0 auto ", "px;\n    box-sizing: border-box;\n\n    /**\n     * Fix block top alignment inside table cells.\n     */\n    .decisionItemView-content-wrap:first-child > div {\n      margin-top: 0;\n    }\n  }\n  .", "[data-number-column='true'] {\n    padding-left: ", "px;\n  }\n  /* avoid applying styles to nested tables (possible via extensions) */\n  .", " > table,\n  .", " > table,\n  .", " > table {\n    border-collapse: collapse;\n    margin: ", "px ", "px 0 0;\n    border: ", "px solid ",
    ";\n    table-layout: fixed;\n    font-size: 1em;\n    width: 100%;\n\n    &[data-autosize='true'] {\n      table-layout: auto;\n    }\n\n    & {\n      * {\n        box-sizing: border-box;\n      }\n      hr {\n        box-sizing: content-box;\n      }\n\n      tbody {\n        border-bottom: none;\n      }\n      th td {\n        background-color: white;\n      }\n      th,\n      td {\n        min-width: ", "px;\n        font-weight: normal;\n        vertical-align: top;\n        border: 1px solid ",
    ";\n        border-right-width: 0;\n        border-bottom-width: 0;\n        padding: ", "px;\n        /* https://stackoverflow.com/questions/7517127/borders-not-shown-in-firefox-with-border-collapse-on-table-position-relative-o */\n        ", "\n\n        > *:first-child {\n          margin-top: 0;\n        }\n\n        > .ProseMirror-gapcursor.-right:first-child + * {\n          margin-top: 0;\n        }\n\n        > .ProseMirror-gapcursor:first-child + span + * {\n          margin-top: 0;\n        }\n\n        th p:not(:first-of-type),\n        td p:not(:first-of-type) {\n          margin-top: 12px;\n        }\n      }\n      th {\n        background-color: ",
    ";\n        text-align: left;\n\n        .code-block {\n          /*\n            Add a background color tint to code blocks inside a table heading since they both\n            share the same background colour. This prevents them visually blending together.\n          */\n          background: ", ";\n\n          > span {\n            /*\n              The codeblock inside @atlaskit/code uses inline styles so we disable the default\n              background color because editor/renderer provides it's own background colours.\n            */\n            background: transparent !important;\n          }\n        }\n      }\n    }\n  }\n"])), exports.TableSharedCssClassName.TABLE_CONTAINER, exports.tableMarginBottom, exports.TableSharedCssClassName.TABLE_CONTAINER, consts_1.akEditorTableNumberColumnWidth - 1, exports.TableSharedCssClassName.TABLE_CONTAINER, exports.TableSharedCssClassName.TABLE_NODE_WRAPPER, exports.TableSharedCssClassName.TABLE_STICKY_WRAPPER, exports.tableMarginTop, exports.tableMarginSides, exports.tableCellBorderWidth, theme_1.themed({
    light: consts_1.akEditorTableBorder,
    dark: consts_1.akEditorTableBorderDark,
}), exports.tableCellMinWidth, theme_1.themed({
    light: consts_1.akEditorTableBorder,
    dark: consts_1.akEditorTableBorderDark,
}), exports.tableCellPadding, browser_1.default.gecko || browser_1.default.ie ? 'background-clip: padding-box;' : '', theme_1.themed({
