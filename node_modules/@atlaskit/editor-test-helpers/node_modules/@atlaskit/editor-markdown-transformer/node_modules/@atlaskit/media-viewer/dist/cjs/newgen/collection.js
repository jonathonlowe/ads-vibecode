...
var Collection = /** @class */ (function (_super) {
    ...
    function Collection() {
        ...
        _this.onNavigationChange = function (item) {
            var _a = _this.props, mediaClient = _a.mediaClient, collectionName = _a.collectionName, pageSize = _a.pageSize, onNavigationChange = _a.onNavigationChange;
    ...
    Collection.prototype.render = function () {
        var _this = this;
        var _a = this.props, defaultSelectedItem = _a.defaultSelectedItem, mediaClient = _a.mediaClient, onClose = _a.onClose, collectionName = _a.collectionName, showControls = _a.showControls, extensions = _a.extensions, onSidebarButtonClick = _a.onSidebarButtonClick;
        return this.state.items.match({
            ...
            successful: function (items) {
                ...
                return (react_1.default.createElement(list_1.List, { items: identifiers, defaultSelectedItem: item, mediaClient: mediaClient, onClose: onClose, onNavigationChange: _this.onNavigationChange, showControls: showControls, extensions: extensions, onSidebarButtonClick: onSidebarButtonClick }));
            },
