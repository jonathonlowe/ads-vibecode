...
var breakout_1 = require("../../utils/breakout");
    ...
    switch (layout) {
        ...
        case 'wrap-left':
            return width > styles_1.akEditorFullPageMaxWidth / 2
                ...
                : width + "px";
        case 'wide':
            return breakout_1.calcWideWidth(containerWidth);
        case 'full-width':
            return breakout_1.calcBreakoutWidth(layout, containerWidth);
        default:
            return isResized
                ? width + "px"
                : fullWidthMode
...
exports.MediaSingleDimensionHelper = function (_a) {
    ...
    return styled_components_1.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  tr & {\n    max-width: 100%;\n  }\n  width: ", ";\n  max-width: ", ";\n  float: ", ";\n  margin: ", ";\n  ", ";\n\n  &:not(.is-resizing) {\n    transition: width 100ms ease-in;\n  }\n"], ["\n  tr & {\n    max-width: 100%;\n  }\n  width: ",
        ...
        : calcLegacyWidth(layout, width || 0, containerWidth, fullWidthMode, isResized), calcMaxWidth(layout, containerWidth), float(layout), calcMargin(layout), isImageAligned(layout));
};
var RenderFallbackContainer = function (_a) {
    var hasFallbackContainer = _a.hasFallbackContainer, ratio = _a.ratio;
...
var Wrapper = styled_components_1.default.div(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  ", ";\n  position: relative;\n\n  ", "\n\n  /* Editor */\n  & > div {\n    position: ", ";\n    height: 100%;\n  }\n\n  &[data-node-type='embedCard'] > div {\n    width: 100%;\n  }\n\n  /* Renderer */\n  [data-node-type='media'] {\n    position: static !important;\n\n    > div {\n      position: absolute;\n      height: 100%;\n    }\n  }\n"], ["\n  ", ";\n  position: relative;\n\n  ", "\n\n  /* Editor */\n  & > div {\n    position: ",
    ";\n    height: 100%;\n  }\n\n  &[data-node-type='embedCard'] > div {\n    width: 100%;\n  }\n\n  /* Renderer */\n  [data-node-type='media'] {\n    position: static !important;\n\n    > div {\n      position: absolute;\n      height: 100%;\n    }\n  }\n"])), exports.MediaSingleDimensionHelper, RenderFallbackContainer, function (_a) {
    var hasFallbackContainer = _a.hasFallbackContainer;
