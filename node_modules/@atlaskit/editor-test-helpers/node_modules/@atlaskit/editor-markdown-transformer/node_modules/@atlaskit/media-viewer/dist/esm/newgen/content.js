        ...
        return (React.createElement(InactivityDetector, null, function (triggerActivityCallback) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(CloseButtonWrapper, { className: hideControlsClassName },
                    React.createElement(MediaButton, { testId: "media-viewer-close-button", appearance: 'toolbar', onClick: onClose, iconBefore: React.createElement(CrossIcon, { label: "Close" }) })),
                children));
        }));
    };
    return Content;
