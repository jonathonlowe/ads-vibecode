...
var CardActionIconButtonWithProps = function (props) { return react_1.default.createElement(cardActionIconButton_1.CardActionIconButton, tslib_1.__assign({}, props)); };
var CardActionsView = /** @class */ (function (_super) {
    ...
    CardActionsView.prototype.render = function () {
        ...
        return (react_1.default.createElement(preventClickThrough_1.PreventClickThrough, null,
    ...
    CardActionsView.prototype.renderActionIconButton = function (action, isPrimary) {
        ...
        return (react_1.default.createElement(CardActionIconButtonWithAnalytics, { icon: icon, triggerColor: triggerColor, onClick: function () { return handler(); } }));
    };
    CardActionsView.prototype.renderOtherActionButtons = function (actions) {
        if (actions.length === 0) {
            ...
            if (firstActionWithIcon && otherActions.length === 0) {
                ...
                return (react_1.default.createElement(cardActionsDropdownMenu_1.CardActionsDropdownMenu, { actions: actions, triggerColor: triggerColor, onOpenChange: onToggle }));
            }
        }
    };
