...
export const renderText = (fragments, config) => {
...
const generateTextures = (config, measures, renderer) => {
...
const renderNormalText = (text, context, measures) => {
    context.fillStyle = '#FFFFFF';
    context.fillText(text, measures.x, measures.y);
};
const renderStroke = (text, context, measures, strokeThickness) => {
...
const sliceCanvasToTextures = (context, gl, measures) => {
    const result = [];
...
const createTexture = (context, gl, xstart, xend, height) => {
...
const deleteTextures = (gl, textures) => {
