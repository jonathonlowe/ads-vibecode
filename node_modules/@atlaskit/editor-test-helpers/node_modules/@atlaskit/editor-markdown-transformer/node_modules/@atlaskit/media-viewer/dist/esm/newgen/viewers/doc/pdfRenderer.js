...
var PDFRenderer = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _b.doc = _c.sent();
                        this.setState({ doc: Outcome.successful(this.doc) }, function () {
    ...
    PDFRenderer.prototype.render = function () {
        ...
        return this.state.doc.match({
            ...
            successful: function () { return (React.createElement(PDFWrapper, { "data-testid": "media-viewer-pdf-content", innerRef: _this.savePdfElement, isSidebarVisible: isSidebarVisible },
