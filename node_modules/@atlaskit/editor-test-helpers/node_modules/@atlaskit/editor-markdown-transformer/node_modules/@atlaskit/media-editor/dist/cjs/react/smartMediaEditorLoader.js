...
var AsyncSmartMediaEditor = /** @class */ (function (_super) {
    ...
    AsyncSmartMediaEditor.prototype.render = function () {
        ...
        if (!this.state.SmartMediaEditor) {
            return react_1.default.createElement(media_ui_1.ModalSpinner, { blankedColor: colors_1.N700A, invertSpinnerColor: true });
        }
        return react_1.default.createElement(this.state.SmartMediaEditor, tslib_1.__assign({}, this.props));
    };
