...
export var isImageMimeTypeSupportedByBrowser = function (mimeType) {
    return [
        'image/apng',
        'image/bmp',
        'image/gif',
...
export var isDocumentMimeTypeSupportedByBrowser = function (mimeType) {
    return mimeType.toLowerCase() === 'application/pdf';
};
// For backward compatilbity, we consider all audio files as natively supported
export var isAudioMimeTypeSupportedByBrowser = function (mimeType) {
 ...
 */
export var isVideoMimeTypeSupportedByBrowser = function (mimeType) {
    return ['video/mp4', 'video/quicktime'].indexOf(mimeType.toLowerCase()) > -1;
};
export var isMimeTypeSupportedByBrowser = function (mimeType) {
    return isDocumentMimeTypeSupportedByBrowser(mimeType) ||
...
//# sourceMappingURL=isMimeTypeSupportedByBrowser.js.map