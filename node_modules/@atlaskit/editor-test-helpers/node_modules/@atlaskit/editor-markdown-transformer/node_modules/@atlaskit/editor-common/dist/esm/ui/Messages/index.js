...
export var HelperMessage = function (_a) {
    ...
    return (React.createElement(Message, null, children));
};
export var ErrorMessage = function (_a) {
    var children = _a.children;
    return (React.createElement(Message, { error: true },
        React.createElement(IconWrapper, null,
            React.createElement(ErrorIcon, { size: "small", label: "error", "aria-label": "error" })),
        children));
};
export var ValidMessage = function (_a) {
    var children = _a.children;
    return (React.createElement(Message, { valid: true },
        React.createElement(IconWrapper, null,
