...
var ToolButton = /** @class */ (function (_super) {
    ...
    ToolButton.prototype.render = function () {
        ...
        var iconBefore = (react_1.default.createElement(styles_1.ButtonIconWrapper, null,
            react_1.default.createElement(Icon, { label: tool, size: "medium", primaryColor: iconPrimaryColor })));
        return (react_1.default.createElement(button_1.default, { iconBefore: iconBefore, appearance: "subtle", onClick: onClick, isSelected: isActive }));
    };
    return ToolButton;
}(react_2.Component));
