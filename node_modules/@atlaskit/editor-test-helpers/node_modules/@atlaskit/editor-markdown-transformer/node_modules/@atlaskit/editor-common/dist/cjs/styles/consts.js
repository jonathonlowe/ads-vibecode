...
exports.akEditorFullPageDefaultFontSize = 16;
...
exports.akEditorDeleteBackgroundWithOpacity = 'rgba(255, 189, 173, 0.5)'; // R75 with 50% opacity
exports.akEditorDeleteBorder = R300;
exports.akEditorDeleteIconColor = R400;
exports.akEditorSelectedBorder = B300;
exports.akEditorSelectedBgColor = B50;
exports.akEditorSelectedBlanketColor = B75;
exports.akEditorSelectedIconColor = B400;
exports.akEditorSelectedBorderSize = 1;
exports.akEditorSelectedBorderBoldSize = 2;
exports.akEditorSelectedBlanketOpacity = 0.3;
exports.akEditorUnitZIndex = 1;
exports.akEditorShadowZIndex = 2;
exports.akEditorStickyHeaderZIndex = 11; // filmstrip uses 10 for its shadow
exports.akEditorSmallZIndex = exports.akEditorStickyHeaderZIndex + 1;
...
exports.getAkEditorFullPageMaxWidth = function (allowDynamicTextSizing) {
    if (allowDynamicTextSizing === void 0) { allowDynamicTextSizing = false; }
    return allowDynamicTextSizing
        ? exports.akEditorFullPageMaxWidth
        : exports.akEditorDefaultLayoutWidth;
};
exports.akEditorFullPageMaxWidth = 680;
exports.akEditorDefaultLayoutWidth = 760;
...
exports.akEditorSwoopCubicBezier = "cubic-bezier(0.15, 1, 0.3, 1)";
exports.gridMediumMaxWidth = 1024;
exports.breakoutWideScaleRatio = 1.33;
exports.akRichMediaResizeZIndex = exports.akEditorUnitZIndex * 99;
exports.akLayoutGutterOffset = theme_1.gridSize() * 1.5;
exports.akEditorLineHeight = 1.714;
exports.akEditorSelectedBorderStyles = "\n  // No offset, no blur\n  box-shadow: 0px 0px 0px " + exports.akEditorSelectedBorderSize + "px " + theme_1.colors.B300 + ";\n  border-radius: " + theme_1.borderRadius() + "px;\n";
...
exports.blockNodesVerticalMargin = '1.143rem';
exports.DEFAULT_EMBED_CARD_WIDTH = 680;
exports.DEFAULT_EMBED_CARD_HEIGHT = 480;
