...
var MediaTypeIcon = /** @class */ (function (_super) {
    ...
    MediaTypeIcon.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.IconWrapper, { type: type || 'unknown' },
            react_1.default.createElement(Icon, { label: "media-type", size: size, className: className })));
    };
