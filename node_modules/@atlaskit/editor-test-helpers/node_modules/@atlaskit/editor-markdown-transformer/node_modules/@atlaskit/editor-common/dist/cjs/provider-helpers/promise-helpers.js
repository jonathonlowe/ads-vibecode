 ...
 * @param promises
 */
exports.waitForFirstFulfilledPromise = function (promises) {
    var rejectReasons = [];
 ...
 * @param results
 */
exports.getOnlyFulfilled = function (results) { return results.filter(isFullfilled).map(function (result) { return result.value; }); };
