...
var ResourcedTaskItem = /** @class */ (function (_super) {
    ...
    ResourcedTaskItem.prototype.render = function () {
        ...
        var _a = this.props, appearance = _a.appearance, children = _a.children, contentRef = _a.contentRef, objectAri = _a.objectAri, showPlaceholder = _a.showPlaceholder, placeholder = _a.placeholder, taskId = _a.taskId, disabled = _a.disabled, dataAttributes = _a.dataAttributes;
        return (react_1.default.createElement(analytics_namespaced_context_1.FabricElementsAnalyticsContext, { data: {
                objectAri: objectAri,
            } },
            react_1.default.createElement(TaskItem_1.default, { isDone: isDone, taskId: taskId, onChange: this.handleOnChange, appearance: appearance, contentRef: contentRef, showPlaceholder: showPlaceholder, placeholder: placeholder, disabled: disabled, dataAttributes: dataAttributes }, children)));
    };
