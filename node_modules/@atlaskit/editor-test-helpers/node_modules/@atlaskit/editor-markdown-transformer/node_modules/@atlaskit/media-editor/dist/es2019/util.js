...
export const colorWithAlphaSame = (a, b) => {
    return (a.red === b.red &&
        a.green === b.green &&
        a.blue === b.blue &&
        a.alpha === b.alpha);
};
export const dimensionsSame = (a, b) => {
...
export const getUtf32Codes = (text) => {
    return splitText(text, code => code, (high, low) => (high - 0xd800) * 0x400 + (low - 0xdc00) + 0x10000);
};
...
// but not ['\uD834', '\uDF06'].
export const getUtf32CodeUnits = (text) => {
    return splitText(text, code => String.fromCharCode(code), (high, low) => String.fromCharCode(high, low));
};
