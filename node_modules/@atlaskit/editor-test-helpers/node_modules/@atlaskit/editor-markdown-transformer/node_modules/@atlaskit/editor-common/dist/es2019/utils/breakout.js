...
const calcBreakoutWidth = (layout, containerWidth) => {
...
const calcWideWidth = (containerWidth = breakoutConsts.defaultLayoutWidth, maxWidth = Infinity, fallback = '100%') => {
    const effectiveFullWidth = containerWidth - breakoutConsts.padding;
    const layoutMaxWidth = mapBreakpointToLayoutMaxWidth(getBreakpoint(containerWidth));
