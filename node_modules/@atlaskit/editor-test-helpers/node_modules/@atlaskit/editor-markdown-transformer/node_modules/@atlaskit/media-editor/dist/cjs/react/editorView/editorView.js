...
var EditorView = /** @class */ (function (_super) {
    ...
    EditorView.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_components_1.ThemeProvider, { theme: theme },
            react_1.default.createElement(button_1.Theme.Provider, { value: function (currentTheme, themeProps) {
                    return currentTheme(tslib_1.__assign(tslib_1.__assign({}, themeProps), { mode: 'dark' }));
                } },
                react_1.default.createElement(styles_1.EditorContainer, { innerRef: refHandler, onKeyDown: this.handleEsc },
                    this.renderEditor(),
                    this.renderToolbar()))));
    };
    ...
    EditorView.prototype.renderToolbar = function () {
        ...
        return (react_1.default.createElement(toolbar_1.default, { tool: tool, color: color, lineWidth: lineWidth, onToolChanged: onToolChanged, onColorChanged: onColorChanged, onLineWidthChanged: onLineWidthChanged, onSave: this.onSave, onCancel: onCancel }));
    };
