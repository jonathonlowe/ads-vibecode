...
exports.getDataURIDimension = function (dimension, options) {
    ...
    if (isValidPercentageUnit_1.isValidPercentageUnit(dimensionValue) && options.element) {
        return getElementDimension_1.getElementDimension(options.element, dimension) * retinaFactor;
    }
