...
var MediaViewer = /** @class */ (function (_super) {
    ...
    MediaViewer.prototype.render = function () {
        var _a = this.props, featureFlags = _a.featureFlags, onClose = _a.onClose, mediaClient = _a.mediaClient, selectedItem = _a.selectedItem, collectionName = _a.collectionName, dataSource = _a.dataSource, pageSize = _a.pageSize, extensions = _a.extensions, contextId = _a.contextId;
        ...
        if (dataSourceWithSelectedItem.list) {
            ...
            return (react_1.default.createElement(media_viewer_1.MediaViewer, { mediaClient: mediaClient, selectedItem: identifier, onClose: onClose, itemSource: itemSource, featureFlags: featureFlags, extensions: extensions, contextId: contextId }));
        }
            ...
            if (media_client_1.isExternalImageIdentifier(selectedItem)) {
                ...
                return (react_1.default.createElement(media_viewer_1.MediaViewer, { mediaClient: mediaClient, selectedItem: selectedItem, onClose: onClose, itemSource: { kind: 'ARRAY', items: [selectedItem] }, featureFlags: featureFlags, contextId: contextId }));
            }
            var itemSource = {
                kind: 'COLLECTION',
            ...
            return (react_1.default.createElement(media_viewer_1.MediaViewer, { mediaClient: mediaClient, selectedItem: identifier, onClose: onClose, itemSource: itemSource, featureFlags: featureFlags, contextId: contextId }));
        }
        else {
            throw new Error();
        }
