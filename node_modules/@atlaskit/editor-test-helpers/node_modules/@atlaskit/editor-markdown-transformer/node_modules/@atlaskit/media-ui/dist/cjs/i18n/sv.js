...
exports.default = {
    ...
    'fabric.media.connect_link_account_card_view_description': 'Förbättra dina förhandsgranskningar av länkar genom att ansluta {context} till dina Atlassian-produkter.',
    ...
    'fabric.media.couldnt_load_link': 'Vi kunde inte läsa in den här länken av någon anledning.',
    ...
    'fabric.media.invalid_permissions': 'Du har inte behörighet att använda den här länken',
    ...
    'fabric.media.not_found_description': 'Kontrollera URL-adressen och försök att redigera eller klistra in igen.',
