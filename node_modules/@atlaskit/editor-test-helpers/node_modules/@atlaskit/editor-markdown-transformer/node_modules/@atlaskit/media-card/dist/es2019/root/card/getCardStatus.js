...
export const getCardStatus = (state, props) => {
    ...
    if (metadata) {
        const { size, mediaType, name } = metadata;
...
export const getCardStatusFromFileState = (fileState, dataURI) => {
...
export const getCardProgressFromFileState = (fileState, dataURI) => {
    switch (fileState.status) {
        case 'uploading':
