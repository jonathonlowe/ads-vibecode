...
var SmartMediaEditor = /** @class */ (function (_super) {
    ...
    function SmartMediaEditor() {
        ...
        _this.onSave = function (imageData, dimensions) {
            ...
            perf_marks_1.start('MediaEditor.MediaAnnotation.Uploaded');
                ...
                next: function (fileState) {
                    if (fileState.status === 'processing') {
                        _this.copyFileToUserCollection(fileState.id).then(function () {
                            ...
                            var duration = perf_marks_1.end('MediaEditor.MediaAnnotation.Uploaded').duration;
                            util_1.fireAnalyticsEvent({
                                eventType: 'track',
                                action: 'uploaded',
                                actionSubject: 'media',
        ...
        _this.renderDeleteConfirmation = function () {
            ...
            if (closeIntent) {
                ...
                return (react_1.default.createElement(modal_dialog_1.ModalTransition, null,
                    react_1.default.createElement(modal_dialog_1.default, { width: "small", appearance: "danger", heading: formatMessage(media_ui_1.messages.annotate_confirmation_heading), actions: actions, onClose: _this.closeConfirmationDialog }, formatMessage(media_ui_1.messages.annotate_confirmation_content))));
            }
            return null;
        };
        ...
        _this.renderEditor = function (imageUrl) {
            return (react_1.default.createElement(editorView_1.default, { imageUrl: imageUrl, onSave: _this.onSave, onCancel: _this.onCancel, onError: _this.onError, onAnyEdit: _this.onAnyEdit }));
        };
        _this.renderError = function (error) {
            ...
            return react_1.default.createElement(errorView_1.default, { message: error, onCancel: onClose || (function () { }) });
        };
        return _this;
    }
    ...
    SmartMediaEditor.prototype.render = function () {
        ...
        var content = hasError
            ...
            : imageUrl
                ...
                : this.renderLoading();
        return (react_1.default.createElement(styled_1.Blanket, { onClick: this.clickShellNotPass },
            this.renderDeleteConfirmation(),
            react_1.default.createElement(media_ui_1.Shortcut, { keyCode: 27, handler: function () { return _this.onCancel('esc'); } }),
            content));
    };
...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function () {
        ...
        var content = react_1.default.createElement(Component, tslib_1.__assign({}, this.props));
