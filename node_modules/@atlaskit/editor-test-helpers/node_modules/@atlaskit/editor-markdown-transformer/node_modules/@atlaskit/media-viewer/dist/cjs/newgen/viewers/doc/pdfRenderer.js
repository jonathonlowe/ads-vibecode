...
var PDFRenderer = /** @class */ (function (_super) {
    ...
    PDFRenderer.prototype.init = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, src, onSuccess, onError, _b, err_1;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.props, src = _a.src, onSuccess = _a.onSuccess, onError = _a.onError;
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        _b = this;
                        return [4 /*yield*/, fetchPdf(src)];
                    case 2:
                        _b.doc = _c.sent();
                        this.setState({ doc: domain_1.Outcome.successful(this.doc) }, function () {
                            _this.pdfViewer = new PDFJSViewer.PDFViewer({ container: _this.el });
                            _this.pdfViewer.setDocument(_this.doc);
    ...
    PDFRenderer.prototype.render = function () {
        var _this = this;
        var isSidebarVisible = this.props.isSidebarVisible;
        return this.state.doc.match({
            pending: function () { return react_1.default.createElement(loading_1.Spinner, null); },
            successful: function () { return (react_1.default.createElement(styled_1.PDFWrapper, { "data-testid": "media-viewer-pdf-content", innerRef: _this.savePdfElement, isSidebarVisible: isSidebarVisible },
                react_1.default.createElement("div", { className: exports.pdfViewerClassName, onClick: closeOnDirectClick_1.closeOnDirectClick(_this.props.onClose) }),
                react_1.default.createElement(zoomControls_1.ZoomControls, { zoomLevel: _this.state.zoomLevel, onChange: _this.handleZoom }))); },
            failed: function (err) { return react_1.default.createElement(error_1.default, { error: err }); },
        });
    };
    return PDFRenderer;
