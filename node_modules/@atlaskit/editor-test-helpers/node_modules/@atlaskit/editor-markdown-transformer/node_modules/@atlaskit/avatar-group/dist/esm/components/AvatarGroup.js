...
var AvatarGroup = /** @class */ (function (_super) {
    ...
    AvatarGroup.prototype.getOverrides = function () {
        return {
            AvatarGroupItem: __assign({ render: function (Component, props, index) { return (React.createElement(Component, __assign({}, props, { key: composeAUniqueKey(props.avatar, index) }))); } }, (this.props.overrides && this.props.overrides.AvatarGroupItem)),
            Avatar: __assign({ render: function (Component, props, index) { return (React.createElement(Component, __assign({}, props, { key: composeAUniqueKey(props, index) }))); } }, (this.props.overrides && this.props.overrides.Avatar)),
        };
    };
    ...
    AvatarGroup.prototype.render = function () {
        ...
        var items = data.slice(0, maxAvatar).map(function (avatarData, idx) {
            var avatar = _this.getOverrides().Avatar.render(Item, __assign(__assign({}, avatarData), { size: size,
