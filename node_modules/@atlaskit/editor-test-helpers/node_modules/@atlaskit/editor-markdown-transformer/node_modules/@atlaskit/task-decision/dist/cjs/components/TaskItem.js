...
var TaskItem = /** @class */ (function (_super) {
    ...
    TaskItem.prototype.render = function () {
        var _a = this.props, appearance = _a.appearance, isDone = _a.isDone, contentRef = _a.contentRef, children = _a.children, placeholder = _a.placeholder, showPlaceholder = _a.showPlaceholder, disabled = _a.disabled, dataAttributes = _a.dataAttributes;
        var icon = (react_1.default.createElement(TaskItem_1.CheckBoxWrapper, { contentEditable: false },
            react_1.default.createElement("input", { id: this.checkBoxId, name: this.checkBoxId, type: "checkbox", onChange: this.handleOnChange, checked: !!isDone, disabled: !!disabled, suppressHydrationWarning: true }),
            react_1.default.createElement("label", { htmlFor: this.checkBoxId, suppressHydrationWarning: true })));
        return (react_1.default.createElement(Item_1.default, { appearance: appearance, contentRef: contentRef, icon: icon, placeholder: placeholder, showPlaceholder: showPlaceholder, itemType: "TASK", dataAttributes: dataAttributes }, children));
    };
