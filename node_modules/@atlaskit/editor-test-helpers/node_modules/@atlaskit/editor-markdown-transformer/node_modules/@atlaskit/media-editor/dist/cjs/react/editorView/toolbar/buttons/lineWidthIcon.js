...
var LineWidthIcon = /** @class */ (function (_super) {
    ...
    LineWidthIcon.prototype.render = function () {
        ...
        return (react_1.default.createElement(lineWidthButtonStyles_1.MainArea, { onClick: onClick, isActive: isActive, style: mainAreaStyle },
            react_1.default.createElement(lineWidthButtonStyles_1.FrontArea, { style: style, isActive: isActive })));
    };
