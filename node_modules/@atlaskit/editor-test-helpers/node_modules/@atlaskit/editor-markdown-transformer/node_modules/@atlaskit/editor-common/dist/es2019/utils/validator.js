import { defaultSchema, inlineNodes, isSafeUrl, generateUuid as uuid, } from '@atlaskit/adf-schema';
/*
...
const wrapInlineNodes = (nodes = []) => {
    return nodes.map(node => inlineNodes.has(node.type) ? { type: 'paragraph', content: [node] } : node);
};
