...
var defaultImageOptions = {
    'max-age': constants_1.FILE_CACHE_MAX_AGE,
    allowAnimated: true,
    mode: 'crop',
};
...
var extendImageParams = function (params, fetchMaxRes) {
    ...
    return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, defaultImageOptions), params), (fetchMaxRes ? { width: constants_1.MAX_RESOLUTION, height: constants_1.MAX_RESOLUTION } : {}));
};
var jsonHeaders = {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __1.createUrl("" + auth.baseUrl + artifactUrl, {
                                params: { collection: collectionName, 'max-age': constants_1.FILE_CACHE_MAX_AGE },
                                auth: auth,
                            })];
                }
            });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        auth = _a.sent();
                        return [4 /*yield*/, __1.request("" + auth.baseUrl + path, {
                                method: method,
                                auth: auth,
                                params: params,
                                headers: headers,
