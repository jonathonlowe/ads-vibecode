...
const { B100, B300, B400, B50, B75, N0, N20, N40, N50, N100, N500, N700, N900, R300, R400, R50, R75, DN50, DN70, } = colors;
...
export const getAkEditorFullPageMaxWidth = (allowDynamicTextSizing = false) => allowDynamicTextSizing
...
`;
export const editorFontSize = ({ theme }) => theme && theme.baseFontSize ? theme.baseFontSize : defaultFontSize();
export const relativeSize = (multiplier) => ({ theme, }) => editorFontSize({ theme }) * multiplier;
