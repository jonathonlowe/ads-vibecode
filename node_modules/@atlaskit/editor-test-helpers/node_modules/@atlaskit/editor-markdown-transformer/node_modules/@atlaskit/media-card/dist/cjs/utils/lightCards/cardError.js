...
var CardError = /** @class */ (function (_super) {
    ...
    CardError.prototype.render = function () {
        ...
        return react_1.default.createElement(styled_1.Wrapper, { dimensions: dimensions }, this.icon);
    };
    Object.defineProperty(CardError.prototype, "icon", {
        get: function () {
            var size = this.props.size;
            return react_1.default.createElement(errorIcon_1.ErrorIcon, { size: size });
        },
        enumerable: true,
        configurable: true
    });
