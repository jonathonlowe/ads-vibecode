...
export async function getFileInfo(file, src) {
    return {
        file,
        src: src || (await fileToDataURI(file)),
    };
}
export async function getFileInfoFromSrc(src, file) {
    return {
...
export const findParentByClassname = (element, className, maxParentElement = document.body) => {
