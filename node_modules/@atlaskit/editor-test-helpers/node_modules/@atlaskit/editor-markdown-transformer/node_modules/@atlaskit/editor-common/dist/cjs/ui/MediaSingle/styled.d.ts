 ...
 */
export declare const MediaSingleDimensionHelper: ({ width, layout, containerWidth, pctWidth, fullWidthMode, isResized, }: WrapperProps) => import("styled-components").InterpolationValue[];
