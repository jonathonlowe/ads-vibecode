...
var getValidMarks = function (marks, adfStage) {
    if (adfStage === void 0) { adfStage = 'final'; }
    ...
    if (type) {
        switch (type) {
            ...
            case 'text': {
                ...
                if (text) {
                    return marks_1
                        ? { type: type, text: text, marks: getValidMarks(marks_1, adfStage) }
                        : { type: type, text: text };
                }
                break;
            }
            ...
            case 'expand':
            case 'nestedExpand': {
                return { type: type, attrs: attrs, content: content, marks: marks };
            }
        }
    }
    return getValidUnknownNode(node);
