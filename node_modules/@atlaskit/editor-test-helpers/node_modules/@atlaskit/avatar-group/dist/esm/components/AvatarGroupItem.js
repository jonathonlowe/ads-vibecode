...
import Avatar, { getProps, withPseudoState, } from '@atlaskit/avatar';
...
var AvatarGroupItem = /** @class */ (function (_super) {
    ...
    AvatarGroupItem.prototype.render = function () {
        var _a = this.props, avatar = _a.avatar, onAvatarClick = _a.onAvatarClick, testId = _a.testId;
        var href = avatar.href, rest = __rest(avatar, ["href"]);
        var enhancedProps = getProps(this);
        return (React.createElement(DropdownItem, __assign({ isInteractive: true }, enhancedProps, { elemBefore: React.createElement(Avatar, __assign({}, rest, { testId: testId && testId + "--avatar", borderColor: "transparent", enableTooltip: false, size: "small" })), href: href, onClick: function (event) {
