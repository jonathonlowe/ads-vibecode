...
exports.getMediaClient = function (props) {
    var mediaClientConfig = props.mediaClientConfig;
...
exports.withMediaClient = function (Component) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.render = function () {
            ...
            return (React.createElement(Component, tslib_1.__assign({}, props, { mediaClient: exports.getMediaClient(this.props) })));
        };
        return class_1;
    }(React.Component));
};
