...
declare type BrowserWithMediaClientConfigProps = WithContextOrMediaClientConfigProps<BrowserProps>;
...
export declare class BrowserLoader extends React.PureComponent<BrowserWithMediaClientConfigProps, State> {
    ...
    state: {
        Browser: React.ComponentClass<WithContextOrMediaClientConfigProps<BrowserProps>, any> | React.FunctionComponent<WithContextOrMediaClientConfigProps<BrowserProps>> | undefined;
    };
