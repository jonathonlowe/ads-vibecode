...
function isContext(contextOrMediaClientConfig) {
    return !!contextOrMediaClientConfig.collection;
}
function MediaPicker(contextOrMediaClientConfig, pickerConfig) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var _a, PopupImpl, getMediaClient, contextOrMediaClientConfigObject, mediaClient;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    contextOrMediaClientConfigObject = isContext(contextOrMediaClientConfig)
                        ? { context: contextOrMediaClientConfig }
                        : { mediaClientConfig: contextOrMediaClientConfig };
                    mediaClient = getMediaClient(contextOrMediaClientConfigObject);
