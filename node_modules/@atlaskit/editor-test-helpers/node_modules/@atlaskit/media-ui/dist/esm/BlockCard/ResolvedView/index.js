...
function getActionPendingState(action) {
    return function (state) {
        var _a;
        return ({
            pendingActionsById: __assign(__assign({}, state.pendingActionsById), (_a = {}, _a[action.id] = true, _a)),
        });
    };
}
function getActionSuccessState(action, message) {
    return function (state) {
        var _a;
        return ({
            pendingActionsById: __assign(__assign({}, state.pendingActionsById), (_a = {}, _a[action.id] = false, _a)),
            alert: message
                ? {
                    type: 'success',
                    text: message,
...
var BlockCardResolvedView = /** @class */ (function (_super) {
    __extends(BlockCardResolvedView, _super);
