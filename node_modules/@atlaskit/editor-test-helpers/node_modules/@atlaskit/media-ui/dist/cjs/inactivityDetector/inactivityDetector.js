...
var InactivityDetector = /** @class */ (function (_super) {
    ...
    function InactivityDetector() {
        ...
        _this.contentWrapperElement = react_1.default.createRef();
        _this.state = {
    ...
    InactivityDetector.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.InactivityDetectorWrapper, { innerRef: this.contentWrapperElement, controlsAreVisible: controlsAreVisible, onMouseMove: this.checkMouseMovement, onMouseOut: function () {
