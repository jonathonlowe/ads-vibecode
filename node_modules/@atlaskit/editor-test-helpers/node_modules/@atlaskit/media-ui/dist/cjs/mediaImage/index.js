...
var MediaImage = /** @class */ (function (_super) {
    ...
    MediaImage.prototype.componentDidMount = function () {
        var parent = react_dom_1.default.findDOMNode(this).parentElement;
        if (!parent) {
            return;
        }
    ...
    MediaImage.prototype.render = function () {
        var _a = this.props, crop = _a.crop, stretch = _a.stretch, dataURI = _a.dataURI, previewOrientation = _a.previewOrientation, crossOrigin = _a.crossOrigin, onImageError = _a.onImageError, alt = _a.alt;
        ...
        */
        ...
        var isImageRotated = __1.isRotated(previewOrientation || 1);
        /*
        ...
        if (previewOrientation && previewOrientation > 1) {
            var transform = __1.getCssFromImageOrientation(previewOrientation);
            style.transform += " " + transform;
        }
        return (react_1.default.createElement(styled_1.ImageComponent, { "data-testid": "media-image", draggable: false, alt: alt, style: style, onLoad: this.onImageLoad, onError: onImageError, innerRef: this.imageRef, src: dataURI, crossOrigin: crossOrigin }));
    };
