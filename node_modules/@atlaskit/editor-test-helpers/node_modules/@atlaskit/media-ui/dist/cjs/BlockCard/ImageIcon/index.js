...
var ImageIcon = /** @class */ (function (_super) {
    ...
    ImageIcon.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_render_image_1.default, { src: src, loading: this.props.default, loaded: react_1.default.createElement(styled_1.Image, { src: src, alt: alt, size: size, title: title }), errored: this.props.default }));
    };
    return ImageIcon;
