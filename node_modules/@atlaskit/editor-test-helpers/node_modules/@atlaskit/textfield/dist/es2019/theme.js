...
const getContainerBackgroundColor = ({ appearance, isFocused, isHovered, isDisabled, isInvalid, mode, }) => {
    if (isDisabled) {
...
const getContainerBorderColor = ({ appearance, isFocused, isDisabled, isInvalid, mode, }) => {
    if (isDisabled) {
        // switch on focus then switch on hover
        if (isFocused) {
            return {
