...
var TaskDecisionResource = /** @class */ (function () {
    ...
    TaskDecisionResource.prototype.apiQueryToServiceQuery = function (query) {
        var sortCriteria = query.sortCriteria, limit = query.limit, other = __rest(query, ["sortCriteria", "limit"]);
        var serviceQuery = __assign(__assign({}, other), { limit: limit || defaultLimit });
        switch (sortCriteria) {
            case 'lastUpdateDate':
