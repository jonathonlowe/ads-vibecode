...
var DecisionItem = /** @class */ (function (_super) {
    ...
    DecisionItem.prototype.render = function () {
        ...
        return (React.createElement(Item, { appearance: appearance, contentRef: contentRef, icon: icon, placeholder: placeholder, showPlaceholder: showPlaceholder, attribution: this.getAttributionText() }, children));
    };
