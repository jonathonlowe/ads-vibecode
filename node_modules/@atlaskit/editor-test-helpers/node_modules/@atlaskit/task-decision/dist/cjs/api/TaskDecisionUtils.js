...
exports.convertServiceDecisionResponseToDecisionResponse = function (serviceDecisionResponse, query) {
    ...
    if (query &&
        ...
        nextQuery = tslib_1.__assign(tslib_1.__assign({}, query), { cursor: serviceDecisionResponse.meta.cursor });
    }
    return {
        decisions: decisions,
        nextQuery: nextQuery,
...
exports.convertServiceTaskResponseToTaskResponse = function (serviceResponse, query) {
    ...
    if (query && serviceResponse.meta && serviceResponse.meta.cursor) {
        nextQuery = tslib_1.__assign(tslib_1.__assign({}, query), { cursor: serviceResponse.meta.cursor });
    }
    return {
        tasks: tasks,
        nextQuery: nextQuery,
