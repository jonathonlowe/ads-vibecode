...
var ResourcedTaskItem = /** @class */ (function (_super) {
    ...
    ResourcedTaskItem.prototype.componentDidMount = function () {
        this.mounted = true;
        this.subscribe(this.props.taskDecisionProvider, this.props.containerAri, this.props.objectAri, this.props.isDone);
    };
    ResourcedTaskItem.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
        ...
        if (nextProps.taskDecisionProvider !== this.props.taskDecisionProvider ||
            ...
            this.unsubscribe();
            this.subscribe(nextProps.taskDecisionProvider, nextProps.containerAri, nextProps.objectAri, nextProps.isDone);
        }
    };
    ...
    ResourcedTaskItem.prototype.subscribe = function (taskDecisionProvider, containerAri, objectAri, isDone) {
        var _this = this;
        if (taskDecisionProvider && containerAri && objectAri) {
            taskDecisionProvider.then(function (provider) {
                if (!_this.mounted) {
                ...
                var objectKey = { localId: taskId, objectAri: objectAri, containerAri: containerAri };
                var item = tslib_1.__assign(tslib_1.__assign({}, objectKey), { state: isDone ? 'DONE' : 'TODO', lastUpdateDate: new Date(), type: 'TASK' });
                provider.subscribe({ localId: taskId, objectAri: objectAri, containerAri: containerAri }, _this.onUpdate, item);
            });
        }
    };
    ...
    ResourcedTaskItem.prototype.render = function () {
        ...
        var _b = this.props, appearance = _b.appearance, children = _b.children, containerAri = _b.containerAri, contentRef = _b.contentRef, creator = _b.creator, objectAri = _b.objectAri, showPlaceholder = _b.showPlaceholder, placeholder = _b.placeholder, taskId = _b.taskId, disabled = _b.disabled;
        return (React.createElement(analytics_namespaced_context_1.FabricElementsAnalyticsContext, { data: {
                containerAri: containerAri,
                objectAri: objectAri,
            } },
            React.createElement(TaskItem_1.default, { isDone: isDone, taskId: taskId, onChange: this.handleOnChange, appearance: appearance, contentRef: contentRef, showPlaceholder: showPlaceholder, placeholder: placeholder, creator: creator, lastUpdater: lastUpdater, disabled: disabled }, children)));
    };
