...
export function LazyCardWithUrlContent(props) {
    ...
    return (React.createElement(LazilyRender, { offset: offset, component: appearance === 'inline' ? 'span' : 'div', placeholder: React.createElement(CardLinkView, { isSelected: isSelected, key: 'lazy-render-placeholder', link: url, testId: testId }), scrollContainer: container, content: React.createElement(CardWithUrlContent, __assign({}, props)) }));
}
