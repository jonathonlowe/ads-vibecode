...
var CardWithDataContent = /** @class */ (function (_super) {
    ...
    CardWithDataContent.prototype.render = function () {
        var _a = this.props, details = _a.data, isSelected = _a.isSelected, appearance = _a.appearance, onClick = _a.onClick, onResolve = _a.onResolve, testId = _a.testId;
        if (appearance === 'inline') {
            var props = extractInlinePropsFromJSONLD(details || {});
            if (onResolve) {
                onResolve({ title: props.title });
            }
            return (React.createElement(InlineCardResolvedView, __assign({}, props, { isSelected: isSelected, onClick: onClick, testId: testId })));
        }
        else {
