...
export function extractPropsFromSourceCodeRepository(json) {
    ...
    return __assign(__assign(__assign(__assign(__assign({}, buildRepositoryLink(json)), buildRepositoryTitle(json)), buildRepositoryDescription(json)), buildRepositoryByline(json)), props);
}
