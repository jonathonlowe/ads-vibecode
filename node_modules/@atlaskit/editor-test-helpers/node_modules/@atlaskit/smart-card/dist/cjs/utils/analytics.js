...
exports.resolvedEvent = function (definitionId, cached) {
    if (cached === void 0) { cached = false; }
    return ({
        action: 'resolved',
        actionSubject: 'smartLink',
        eventType: 'operational',
        attributes: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, exports.context), (definitionId ? { definitionId: definitionId } : {})), { cached: cached }),
    });
};
