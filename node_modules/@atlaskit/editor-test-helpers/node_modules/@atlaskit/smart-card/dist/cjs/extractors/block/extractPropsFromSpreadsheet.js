...
function extractPropsFromSpreadsheet(json) {
    ...
    if (json.fileFormat === 'application/vnd.google-apps.spreadsheet') {
        props.icon = (react_1.default.createElement(_24_2.default, { label: json.provider ? json.provider.name : 'Google Sheet' }));
    }
    else if (json.fileFormat === 'application/vnd.ms-excel') {
        props.icon = (react_1.default.createElement(_24_3.default, { label: json.provider ? json.provider.name : 'MS Excel' }));
    }
    else {
        props.icon = (react_1.default.createElement(_24_1.default, { label: json.provider ? json.provider.name : 'Spreadsheet' }));
    }
    return props;
}
