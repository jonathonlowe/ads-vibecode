...
exports.buildTaskByline = function (json) {
    ...
    if (json.dateCreated || json.updated) {
        return {
            byline: json.updated ? (react_1.default.createElement("span", null,
                "Updated ",
                updatedBy,
                " ",
                react_1.default.createElement(react_intl_1.FormattedRelative, { value: json.updated }))) : (react_1.default.createElement("span", null,
                "Created ",
                attributedTo,
                " ",
                react_1.default.createElement(react_intl_1.FormattedRelative, { value: json.dateCreated }))),
        };
    }
    return {};
};
...
exports.buildTaskCommentCount = function (json) {
    if (!isNaN(Number(json.commentCount)) && Number(json.commentCount) > 0) {
        return {
            icon: (react_1.default.createElement(comment_1.default, { label: "", key: "comments-count-icon", size: "medium", primaryColor: colors_1.N600 })),
