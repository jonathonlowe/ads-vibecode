...
exports.buildRepositoryByline = function (json) {
    ...
    if (dateCreated || dateUpdated) {
        return {
            byline: updatedBy ? (react_1.default.createElement("span", null,
                "Updated by ",
                updatedBy,
                " ",
                react_1.default.createElement(react_intl_1.FormattedRelative, { value: dateUpdated }))) : (react_1.default.createElement("span", null,
                "Created by ",
                attributedTo,
                " ",
                react_1.default.createElement(react_intl_1.FormattedRelative, { value: dateCreated }))),
        };
    }
    return {};
};
