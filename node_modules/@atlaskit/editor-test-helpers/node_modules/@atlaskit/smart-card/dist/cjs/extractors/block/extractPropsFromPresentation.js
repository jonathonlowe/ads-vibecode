...
function extractPropsFromPresentation(json) {
    ...
    if (json.fileFormat === 'application/vnd.google-apps.presentation') {
        props.icon = (react_1.default.createElement(_24_3.default, { label: json.provider ? json.provider.name : 'Google Slides' }));
    }
    else if (json.fileFormat === 'application/vnd.mspowerpoint') {
        props.icon = (react_1.default.createElement(_24_2.default, { label: json.provider ? json.provider.name : 'PowerPoint Presentation' }));
    }
    else {
        props.icon = (react_1.default.createElement(_24_1.default, { label: json.provider ? json.provider.name : 'Presentation' }));
    }
    return props;
}
