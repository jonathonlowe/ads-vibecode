...
var CardWithDataRenderer = /** @class */ (function (_super) {
    ...
    CardWithDataRenderer.prototype.render = function () {
        ...
        if (CardWithDataRenderer.CardContent) {
            return (react_1.default.createElement(CardWithDataRenderer.CardContent, { appearance: appearance, data: data, isSelected: isSelected, onClick: onClick, onResolve: onResolve, testId: testId }));
        }
