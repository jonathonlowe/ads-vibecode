    ...
    if (json.generator &&
        ...
        switch (taskTypeName) {
            case constants_1.JIRA_TASK:
                return { icon: react_1.default.createElement(_16_2.default, { label: taskLabel }) };
            case constants_1.JIRA_SUB_TASK:
                return { icon: react_1.default.createElement(_16_3.default, { label: taskLabel }) };
            case constants_1.JIRA_STORY:
                return { icon: react_1.default.createElement(_16_4.default, { label: taskLabel }) };
            case constants_1.JIRA_BUG:
                return { icon: react_1.default.createElement(_16_5.default, { label: taskLabel }) };
            case constants_1.JIRA_EPIC:
                return { icon: react_1.default.createElement(_16_6.default, { label: taskLabel }) };
            case constants_1.JIRA_INCIDENT:
                return { icon: react_1.default.createElement(_16_7.default, { label: taskLabel }) };
            case constants_1.JIRA_SERVICE_REQUEST:
                return { icon: react_1.default.createElement(_16_8.default, { label: taskLabel }) };
            case constants_1.JIRA_CHANGE:
                return { icon: react_1.default.createElement(_16_9.default, { label: taskLabel }) };
            case constants_1.JIRA_PROBLEM:
                return { icon: react_1.default.createElement(_16_10.default, { label: taskLabel }) };
            case constants_1.JIRA_CUSTOM_TASK_TYPE:
                return {
                    icon: (taskType.icon && taskType.icon.url) ||
                        (json.icon && json.icon.url) || (react_1.default.createElement(_16_1.default, { label: json.provider ? json.provider.name : '' })),
                };
        }
    }
    return {
        icon: react_1.default.createElement(_16_1.default, { label: json.provider ? json.provider.name : '' }),
    };
};
