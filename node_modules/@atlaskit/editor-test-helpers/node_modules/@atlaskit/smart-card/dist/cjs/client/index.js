                    ...
                    case 1:
                        ...
                        switch (errorType) {
                            case 'ResolveAuthError':
                                throw new errors_1.FetchError('auth', "authentication required for URL " + url + ", error: " + errorType);
                            case 'ResolveBadRequestError':
                                throw new errors_1.FetchError('fatal', "Bad Request for " + url + ", error: " + errorType);
                            case 'InternalServerError': // Timeouts and ORS failures
                                throw new errors_1.FetchError('fatal', "Internal Server Error for " + url + ", error: " + errorType);
                            case 'ResolveUnsupportedError': // URL isn't supported
                                throw new errors_1.FetchError('fatal', "the URL " + url + " is unsupported, received server error: " + errorType);
                            default:
                                if (status === 404) {
                                    return [2 /*return*/, {
                                            meta: {
