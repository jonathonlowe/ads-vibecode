...
export declare function findMatchedLanguage(supportedLanguages: Language[], language?: string): {
    readonly name: "PHP";
    readonly alias: readonly ["php", "php3", "php4", "php5"];
    readonly value: "php";
} | {
...
export declare function createLanguageList(supportedLanguages: Language[]): ({
    readonly name: "PHP";
    readonly alias: readonly ["php", "php3", "php4", "php5"];
    readonly value: "php";
} | {
