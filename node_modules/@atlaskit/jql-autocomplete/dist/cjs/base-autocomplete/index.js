...
exports.BaseAutocomplete = void 0;
var _slicedToArray2 = _interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));
var _toConsumableArray2 = _interopRequireDefault(require("@babel/runtime/helpers/toConsumableArray"));
var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));
var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));
var _CodeCompletionCore = require("antlr4-c3/lib/src/CodeCompletionCore");
...
var BaseAutocomplete = exports.BaseAutocomplete = /*#__PURE__*/function () {
  ...
  function BaseAutocomplete(parser) {
    ...
    (0, _classCallCheck2.default)(this, BaseAutocomplete);
    this.parser = parser;
    this.core = new _CodeCompletionCore.CodeCompletionCore(this.parser);
  ...
  (0, _createClass2.default)(BaseAutocomplete, [{
    key: "getTokenStream",
    ...
    value: function getMatchedText(maybeCaretToken, caretSelectionRange) {
      ...
      return (0, _util.getMatchedText)(this.getTokenStream(), startTokenIndex, maybeCaretToken, caretSelectionRange);
    }
    ...
    value: function getCandidateTokens(maybeCaretToken, caretSelectionRange, collectedCandidateTokens) {
      ...
      collectedCandidateTokens.forEach(function (value, key) {
        var tokenSequence = [key].concat((0, _toConsumableArray2.default)(value)); // handle token sequences that are always used together, e.g. ORDER + BY
    ...
    value: function mapCandidateRules(maybeCaretToken, caretSelectionRange, collectedCandidateRules) {
      ...
      collectedCandidateRules.forEach(function (_ref, key) {
        ...
        if (!maybeCaretToken) {
          ...
          var matchedText = (0, _util.getMatchedText)(tokens, startTokenIndex, maybeCaretToken, caretSelectionRange);
          defaultRule = {
            matchedText: matchedText,
            replacePosition: replacePosition,
            context: null
    ...
    value: function getCaretToken(caretStartPosition) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (caretStartPosition > token.startIndex && caretStartPosition <= token.stopIndex + 1 || token.type === _antlr4ts.Token.EOF) {
            return token;
          }
        }
      } catch (err) {
    ...
    value: function isCaretAtDelimiterOrHiddenToken(caretToken) {
      return this.isCaretAtDelimiterToken(caretToken) || caretToken.channel === _antlr4ts.Token.HIDDEN_CHANNEL;
    }
