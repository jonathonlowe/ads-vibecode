export declare const defaultIgnoredTokens: Set<number>;
/**
 ...
 */
export declare const unhandledRules: number[];
/**
 ...
 */
export declare const defaultPreferredRules: Set<number>;
export declare const defaultDelimiterTokens: Set<number>;
