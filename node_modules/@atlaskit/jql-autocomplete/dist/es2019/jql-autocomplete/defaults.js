...
export const defaultIgnoredTokens = new Set([JQLLexer.EOF, JQLLexer.LPAREN, JQLLexer.RPAREN, JQLLexer.LBRACKET, JQLLexer.RBRACKET, JQLLexer.STRING, JQLLexer.QUOTE_STRING, JQLLexer.SQUOTE_STRING, JQLLexer.POSNUMBER, JQLLexer.NEGNUMBER, JQLLexer.BANG, JQLLexer.CUSTOMFIELD, JQLLexer.COMMA]);
 ...
 */
export const unhandledRules = [JQLParser.RULE_jqlFieldProperty // stop field from being suggested after whitespace
];
...
const operandRules = [JQLParser.RULE_jqlValue, JQLParser.RULE_jqlFunction,
 ...
 */
export const defaultPreferredRules = new Set([JQLParser.RULE_jqlField, ...operatorRules, ...operandRules, ...unhandledRules,
