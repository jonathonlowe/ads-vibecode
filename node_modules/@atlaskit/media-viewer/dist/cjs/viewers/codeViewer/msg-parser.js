...
exports.getMsgDate = getMsgDate;
exports.msgToText = msgToText;
exports.parseHeaders = parseHeaders;
var _msgreader = _interopRequireDefault(require("@kenjiuno/msgreader"));
function msgToText(buffer) {
  try {
    var msgReader = new _msgreader.default(buffer);
