...
export var mockDatasourceDataResponse = {
  meta: {
...
export var mockDatasourceDataNoActionsResponse = {
  meta: {
    key: 'jira-object-provider',
    access: 'granted',
    auth: [],
...
export var mockDatasourceDetailsResponse = {
  meta: {
    key: 'jira-object-provider',
    access: 'granted',
    auth: [],
...
export var mockDatasourceDataResponseWithSchema = _objectSpread(_objectSpread({}, mockDatasourceDataResponse), {}, {
...
export var mockActionsDiscoveryResponse = {
  actions: [{
...
export var mockActionsDiscoveryEmptyResponse = {
  actions: [],
  permissions: {
    data: []
  }
};
export var mockExecuteActionResponse = {
  operationStatus: ActionOperationStatus.SUCCESS,
  errors: []
};
export var mockExecuteActionResponseFailure = {
