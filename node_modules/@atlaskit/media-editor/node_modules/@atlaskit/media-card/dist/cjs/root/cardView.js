...
var CardViewBase = /** @class */ (function (_super) {
    ...
    function CardViewBase() {
        ...
        _this.renderFile = function () {
            var _a = _this.props, status = _a.status, metadata = _a.metadata, dataURI = _a.dataURI, progress = _a.progress, onRetry = _a.onRetry, resizeMode = _a.resizeMode, appearance = _a.appearance, dimensions = _a.dimensions, actions = _a.actions, selectable = _a.selectable, selected = _a.selected, disableOverlay = _a.disableOverlay, previewOrientation = _a.previewOrientation;
            return (React.createElement(files_1.FileCard, { status: status, details: metadata, dataURI: dataURI, progress: progress, onRetry: onRetry, resizeMode: resizeMode, appearance: appearance, dimensions: dimensions, actions: actions, selectable: selectable, selected: selected, disableOverlay: disableOverlay, previewOrientation: previewOrientation }));
        };
        return _this;
    }
