...
var FileCardImageViewBase = /** @class */ (function (_super) {
    ...
    function FileCardImageViewBase() {
        ...
        _this.renderMediaImage = function () {
            ...
            return (React.createElement(media_ui_1.MediaImage, { dataURI: dataURI, crop: _this.isCropped, stretch: _this.isStretched, previewOrientation: previewOrientation, onImageLoad: _this.onImageLoad, onImageError: _this.onImageError }));
        };
