        ...
        return (react_1.default.createElement(Content_1.Footer, { showKeyline: showKeyline },
            ...
            react_1.default.createElement(Content_1.Actions, null, actions
                ? actions.map(function (_a, index) {
                    var text = _a.text, rest = tslib_1.__rest(_a, ["text"]);
                    var variant = index !== 0 ? 'subtle' : appearance || 'primary';
                    return (
                    // Index used as text can be a ReactNode
                    react_1.default.createElement(Content_1.ActionItem, { key: index },
                        react_1.default.createElement(button_1.default, tslib_1.__assign({ appearance: variant }, rest), text)));
                })
                : null)));
    };
    return ModalFooter;
