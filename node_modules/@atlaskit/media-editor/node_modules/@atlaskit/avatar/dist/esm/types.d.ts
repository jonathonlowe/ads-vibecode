...
import { AnalyticsEvent, WithAnalyticsEventsProps } from '@atlaskit/analytics-next';
...
export declare type PresenceType = ('online' | 'busy' | 'focus' | 'offline') | ReactNode;
...
export declare type StyledComponentType = 'custom' | 'button' | 'link' | 'span';
export declare type AvatarClickType = (event: {
    event: React.MouseEvent;
    item: Record<string, any>;
}, analyticsEvent?: AnalyticsEvent) => void;
export interface AvatarPropTypes extends WithAnalyticsEventsProps, WithPseudoStateProps {
