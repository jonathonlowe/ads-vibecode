...
var validIconSizes = Object.keys(constants_1.ICON_SIZES);
    ...
    function Avatar() {
        ...
        _this.guardedClick = function (event) {
            ...
            if (isDisabled || typeof onClick !== 'function')
                return;
            var item = utils_1.omit.apply(void 0, tslib_1.__spread([_this.props], constants_2.propsOmittedFromClickData));
