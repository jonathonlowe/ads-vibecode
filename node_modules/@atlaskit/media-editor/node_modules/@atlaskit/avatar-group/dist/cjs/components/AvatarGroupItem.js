...
var AvatarGroupItem = /** @class */ (function (_super) {
    ...
    AvatarGroupItem.prototype.render = function () {
        ...
        return (react_1.default.createElement(dropdown_menu_1.DropdownItem, tslib_1.__assign({ isInteractive: true }, enhancedProps, { elemBefore: react_1.default.createElement(avatar_1.default, tslib_1.__assign({}, rest, { testId: testId && testId + "--avatar", borderColor: "transparent", enableTooltip: false, size: "small" })), href: href, onClick: function (event) {
