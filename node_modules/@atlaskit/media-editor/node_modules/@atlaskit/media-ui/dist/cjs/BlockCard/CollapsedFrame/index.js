...
var CollapsedFrame = /** @class */ (function (_super) {
    ...
    CollapsedFrame.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.Wrapper, { minWidth: minWidth, maxWidth: maxWidth, isInteractive: isInteractive, isSelected: isSelected, tabIndex: isInteractive ? 0 : undefined, role: isInteractive ? 'button' : undefined, onClick: this.handleClick, onKeyPress: this.handleKeyPress }, children));
    };
