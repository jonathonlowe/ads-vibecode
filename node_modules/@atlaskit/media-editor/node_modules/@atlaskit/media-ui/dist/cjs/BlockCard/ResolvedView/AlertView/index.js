...
var AlertView = /** @class */ (function (_super) {
    ...
    AlertView.prototype.renderContent = function () {
        ...
        if (width && width < contentWidthWhenCardIs400px) {
            return react_1.default.createElement(ellipsify_1.Ellipsify, { text: txt, lines: 2, inline: true });
        }
        else {
            return react_1.default.createElement(ellipsify_1.Ellipsify, { text: txt, lines: 1, inline: true });
        }
    };
    AlertView.prototype.renderRetryAndCancel = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(button_1.default, { appearance: "link", spacing: "none", onClick: this.handleRetry }, "Try again"),
            ' ',
            "or",
            ' ',
            react_1.default.createElement(button_1.default, { appearance: "link", spacing: "none", onClick: this.handleDismis }, "cancel"),
            "."));
    };
    AlertView.prototype.render = function () {
        var _a = this.props, type = _a.type, style = _a.style;
        return (react_1.default.createElement(styled_1.Wrapper, { innerRef: this.handleMount, type: type, style: style },
            this.renderContent(),
            " ",
