...
var Frame = /** @class */ (function (_super) {
    ...
    Frame.prototype.render = function () {
        var _a = this.props, isSelected = _a.isSelected, children = _a.children, onClick = _a.onClick, link = _a.link, withoutBackground = _a.withoutBackground, testId = _a.testId;
        var isInteractive = Boolean(onClick);
        return (react_1.default.createElement(styled_1.Wrapper, { href: link, withoutBackground: withoutBackground, isSelected: isSelected, isInteractive: isInteractive, tabIndex: isInteractive ? 0 : undefined, role: isInteractive ? 'button' : undefined, onClick: this.handleClick, onMouseDown: this.handleMouseDown, onKeyPress: this.handleKeyPress, "data-testid": testId }, children));
    };
    return Frame;
