...
var Widgets = /** @class */ (function (_super) {
    ...
    Widgets.prototype.renderTitle = function (title) {
        return react_1.default.createElement(styled_1.Title, { key: "title" },
            title,
            ":");
    };
    Widgets.prototype.renderIcon = function (icon) {
        if (typeof icon === 'string') {
            return react_1.default.createElement(ImageIcon_1.ImageIcon, { key: "icon", src: icon, size: 16 });
        }
        else {
            return icon;
        }
    ...
    Widgets.prototype.renderBadge = function (badge) {
        return (react_1.default.createElement(badge_1.default, { key: "badge", appearance: badge.appearance || 'default', max: badge.max }, badge.value));
    };
    Widgets.prototype.renderLozenge = function (lozenge) {
        return (react_1.default.createElement(lozenge_1.default, { key: "lozenge", appearance: lozenge.appearance || 'default', isBold: lozenge.isBold }, lozenge.text));
    };
    Widgets.prototype.renderText = function (text) {
        return react_1.default.createElement(styled_1.Text, { key: "text" }, text);
    };
    Widgets.prototype.renderWidgetDetails = function (attrs, tooltip) {
        if (tooltip) {
            return (react_1.default.createElement(tooltip_1.default, { content: tooltip },
                react_1.default.createElement(styled_1.WidgetDetails, null, attrs)));
        }
        else {
            return react_1.default.createElement(styled_1.WidgetDetails, null, attrs);
        }
    };
    Widgets.prototype.renderWidget = function (key, detail) {
        ...
        return (react_1.default.createElement(styled_1.WidgetWrapper, { key: key }, this.renderWidgetDetails(attrs, tooltip)));
    };
    Widgets.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.Wrapper, null, details.map(function (detail, index) { return _this.renderWidget(index, detail); })));
    };
    return Widgets;
