...
var ExpandedFrame = /** @class */ (function (_super) {
    ...
    ExpandedFrame.prototype.renderHeader = function () {
        ...
        return (react_1.default.createElement(styled_1.Header, null,
            react_1.default.createElement(styled_1.IconWrapper, { isPlaceholder: isPlaceholder }, !isPlaceholder && icon),
            react_1.default.createElement(styled_1.TextWrapper, { isPlaceholder: isPlaceholder }, !isPlaceholder && text)));
    };
    ExpandedFrame.prototype.renderContent = function () {
        var isInteractive = this.isInteractive;
        var children = this.props.children;
        return react_1.default.createElement(styled_1.Content, { isInteractive: isInteractive }, children);
    };
    ExpandedFrame.prototype.render = function () {
        ...
        if (!isPlaceholder && href) {
            return (react_1.default.createElement(styled_1.LinkWrapper, { target: "_blank", rel: "noopener", className: styled_1.className, isInteractive: isInteractive, isSelected: isSelected, href: href, minWidth: minWidth, maxWidth: maxWidth, onClick: this.handleClick },
                this.renderHeader(),
                this.renderContent()));
        }
        else {
            return (react_1.default.createElement(styled_1.Wrapper, { className: styled_1.className, isInteractive: isInteractive, isSelected: isSelected, minWidth: minWidth, maxWidth: maxWidth, onClick: this.handleClick },
                this.renderHeader(),
                this.renderContent()));
        }
    };
