...
var Transition = /** @class */ (function (_super) {
    ...
    Transition.prototype.getStyle = function (status) {
        ...
        if (status === 'entering') {
            return enter.reduce(function (accum, name) { return (__assign(__assign({}, accum), getStyle('enter', name, 'entering'))); }, {});
        }
        if (status === 'entered') {
            return __assign(__assign(__assign({}, enter.reduce(function (accum, name) { return (__assign(__assign({}, accum), getStyle('enter', name, 'entering'))); }, {})), enter.reduce(function (accum, name) { return (__assign(__assign({}, accum), getStyle('enter', name, 'entered'))); }, {})), { transition: "all " + timeout + "ms ease-in-out" });
        }
        if (status === 'exiting') {
            return __assign({}, exit.reduce(function (accum, name) { return (__assign(__assign({}, accum), getStyle('exit', name, 'exiting'))); }, {}));
        }
        if (status === 'exited') {
            return __assign(__assign(__assign({}, exit.reduce(function (accum, name) { return (__assign(__assign({}, accum), getStyle('exit', name, 'exiting'))); }, {})), exit.reduce(function (accum, name) { return (__assign(__assign({}, accum), getStyle('exit', name, 'exited'))); }, {})), { transition: "all " + timeout + "ms ease-in-out" });
        }
        return {};
    };
