...
var SmartMediaEditor = /** @class */ (function (_super) {
    ...
    function SmartMediaEditor() {
        ...
        _this.renderEditor = function (imageUrl) {
            return (React.createElement(editorView_1.default, { imageUrl: imageUrl, onSave: _this.onSave, onCancel: _this.onCancel, onError: _this.onError, onAnyEdit: _this.onAnyEdit }));
        };
    ...
    SmartMediaEditor.prototype.render = function () {
        ...
        return (React.createElement(styled_1.Blanket, { onClick: this.clickShellNotPass },
            ...
            React.createElement(media_ui_1.Shortcut, { keyCode: 27, handler: this.onCancel }),
            content));
    };
...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function () {
        var Component = react_intl_1.injectIntl(SmartMediaEditor);
