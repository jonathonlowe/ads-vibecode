...
export type RemoteLinkType = 'document' | 'alert' | 'test' | 'security' | 'logFile' | 'prototype' | 'coverage' | 'bugReport' | 'releaseNotes' | 'other';
...
export type SubType = 'task' | 'bug' | 'story' | 'epic' | 'feature' | 'question' | 'other' | 'incident' | 'problem' | 'approval' | 'section' | 'milestone' | 'work_item' | 'default_task';
...
export type DocumentType = 'folder' | 'document' | 'presentation' | 'spreadsheet' | 'image' | 'audio' | 'video' | 'pdf' | 'shortcut' | 'code' | 'archive' | 'form' | 'web-page' | 'other';
 ...
 */
export type EntityType = BaseEntity | DesignEntity | RemoteLinkEntity | ProjectEntity | WorkItemEntity | DocumentEntity | UnsupportedEntity;
