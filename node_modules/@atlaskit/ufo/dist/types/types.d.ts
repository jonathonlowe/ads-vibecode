...
import { type ExperiencePerformanceTypes, type ExperienceTypes } from './platform-client/core/experience/experience-types';
export type { GlobalEventStream } from './global-stream-buffer';
export declare enum UFOGlobalEventStreamEventType {
...
export type UFOGlobalEventStreamEvent = UFOGlobalEventStreamExperiencePayload | UFOGlobalEventStreamSubscribe | UFOGlobalEventStreamUnsubscribe;
...
export declare enum PageVisibleState {
    VISIBLE = "visible",
    HIDDEN = "hidden",
    MIXED = "mixed"
}
...
export declare enum PageLoadMetrics {
    fmp = "fmp",
    tti = "tti"
}
export declare enum PageSegmentLoadMetrics {
    fmp = "fmp",
    tti = "tti"
}
export declare enum InteractionMetrics {
    response = "response",
    result = "result"
}
export declare enum CustomMetrics {
    duration = "duration"
}
...
export declare const SUBSCRIBE_ALL = "__SUBSCRIBE_ALL__";
export declare const FMP_MARK = "fmp";
export declare const INLINE_RESPONSE_MARK = "inline-response";
