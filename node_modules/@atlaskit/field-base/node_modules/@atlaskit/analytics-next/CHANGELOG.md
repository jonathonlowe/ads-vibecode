...
Fix: The stable context package got bumped unintentionally, this allows us to roll forward with that bump

## 6.3.7

Hotfix for analytics-next to use a stable context reference for versions 6.x
