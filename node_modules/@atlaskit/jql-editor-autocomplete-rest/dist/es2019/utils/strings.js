export const isSingleQuoted = maybeQuotedString => {
...
export const isDoubleQuoted = maybeQuotedString => {
  if (maybeQuotedString.length < 2) {
    return false;
  }
  return maybeQuotedString[0] === '"' && maybeQuotedString[maybeQuotedString.length - 1] === '"' && maybeQuotedString[maybeQuotedString.length - 2] !== '\\';
};
export const isQuoted = maybeQuotedString => isSingleQuoted(maybeQuotedString) || isDoubleQuoted(maybeQuotedString);
 ...
 */
export const normalize = maybeQuotedString => {
 ...
 */
export const areStringsEquivalent = (a, b) => collator.compare(a, b) === 0;