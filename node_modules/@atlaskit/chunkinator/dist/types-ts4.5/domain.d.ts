...
export interface Hashinator {
    (blobs$: Observable<SlicedBlob>, options: HashinatorOptions): Observable<HashedBlob>;
}
...
export interface Uploadinator {
    (blobs$: Observable<HashedBlob>, options: UploadinatorOptions): Observable<HashedBlob>;
}
...
export interface Processinator {
    (blobs$: Observable<HashedBlob>, options: ProcessinatorOptions): Observable<HashedBlob[]>;
}
...
export interface Chunkinator {
    (file: ChunkinatorFile, options: Options, callbacks: Callbacks): ChunkinatorResponse;
}
