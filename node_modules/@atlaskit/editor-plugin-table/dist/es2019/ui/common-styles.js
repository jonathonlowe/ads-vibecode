...
export const baseTableStyles = props => {
  ...
  return css`
	...
	.${ClassName.DRAG_ROW_CONTROLS} {
		...
		align-items: center;
		position: absolute;
		z-index: ${fg('platform_editor_table_column_selected_state_fix') ? rowControlsZIndex + 4 : akEditorUnitZIndex};
	...
	.${ClassName.NUMBERED_COLUMN} {
		...
		top: ${(fg('platform_editor_number_column_sticky_header_broken') ? props.isDragAndDropEnabled : (_props$featureFlags2 = props.featureFlags) === null || _props$featureFlags2 === void 0 ? void 0 : _props$featureFlags2.tableDragAndDrop) || editorExperiment('support_table_in_comment_jira', true) ? 0 : akEditorTableToolbarSize}px;
	...
	${fg('platform_editor_nested_tables_sticky_header_bug') ? `
		${fg('platform_editor_number_column_sticky_header_broken') ? `.${ClassName.TABLE_STICKY} > .${props.isDragAndDropEnabled ? ClassName.DRAG_ROW_CONTROLS_WRAPPER : ClassName.ROW_CONTROLS_WRAPPER} {
				.${ClassName.NUMBERED_COLUMN_BUTTON_DISABLED}:first-of-type::after {` : `.${ClassName.TABLE_STICKY} > .${ClassName.DRAG_ROW_CONTROLS_WRAPPER} {
	...
	.${ClassName.DRAG_ROW_CONTROLS_WRAPPER} {
		...
		${fg('platform_editor_table_column_selected_state_fix') ? '' : `z-index: ${rowControlsZIndex + 4}`}
	}
