...
const getInsertLineWidth = (tableRef, isDragAndDropEnabled, isChromelessEditor) => {
...
const InsertButtonForDragAndDrop = ({
  ...
  const content = /*#__PURE__*/React.createElement(Tooltip, {
    ...
    className: classnames(ClassName.DRAG_CONTROLS_INSERT_BUTTON_INNER, {
      ...
      [ClassName.DRAG_CONTROLS_INSERT_BUTTON_INNER_ROW_CHROMELESS]: isRow && isChromelessEditor
    })
