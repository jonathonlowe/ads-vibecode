...
function createApiRouter(isSlowServer) {
    ...
    router.get('/file/:fileId/image', function (_a, database) {
        ...
        return new kakapo_1.KakapoResponse(200, blob, {
    ...
    router.head('/chunk/:chunkId', function (_a, database) {
        ...
        if (database.findOne('chunk', { id: chunkId })) {
            return new kakapo_1.KakapoResponse(200, undefined, {});
        }
        else {
            return new kakapo_1.KakapoResponse(404, undefined, {});
        }
    });
    router.put('/chunk/:chunkId', function (_a, database) {
        ...
        return new kakapo_1.KakapoResponse(201, undefined, {});
    });
    router.post('/chunk/probe', function (_a, database) {
        ...
        return new kakapo_1.KakapoResponse(200, {
            data: {
    ...
    router.post('/file', function (_a, database) {
        ...
        database.push('collectionItem', item);
        return new kakapo_1.KakapoResponse(201, {
            data: {
                id: item.id,
                insertedAt: Date.now(),
            },
