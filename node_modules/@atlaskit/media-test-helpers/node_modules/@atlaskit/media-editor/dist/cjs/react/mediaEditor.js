...
var MediaEditor = /** @class */ (function (_super) {
    ...
    MediaEditor.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.MediaEditorContainer, { style: dimensions },
            !isImageLoaded ? this.renderSpinner() : null,
            react_1.default.createElement(styled_1.OutputArea, { innerRef: this.handleOutputAreaInnerRef, style: dimensions },
                react_1.default.createElement(styled_1.SupplementaryCanvas, { innerRef: this.handleSupplementaryCanvasInnerRef }),
                react_1.default.createElement(styled_1.HiddenTextArea, { autoComplete: 'off', innerRef: this.handleHiddenTextAreaInnerRef }),
                react_1.default.createElement(styled_1.HiddenTextHelperDiv, { innerRef: this.handleHiddenTextHelperDivInnerRef }),
                react_1.default.createElement(styled_1.DrawingCanvas, { onClick: this.onCanvasClick, innerRef: this.handleDrawingCanvasInnerRef, style: dimensions }))));
    };
