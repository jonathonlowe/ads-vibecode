...
var ErrorView = /** @class */ (function (_super) {
    ...
    ErrorView.prototype.render = function () {
        return (react_1.default.createElement(styles_2.EditorContainer, null,
            react_1.default.createElement(styles_1.ErrorPopup, null,
                react_1.default.createElement(styles_1.ErrorIconWrapper, null, icons_1.errorIcon),
                react_1.default.createElement(styles_1.ErrorMessage, null, this.props.message),
                react_1.default.createElement(styles_1.ErrorHint, null, this.renderHint()),
    ...
    ErrorView.prototype.renderTryAgainButton = function () {
        var _a = this.props, onRetry = _a.onRetry, formatMessage = _a.intl.formatMessage;
        if (onRetry) {
            return (react_1.default.createElement(styles_1.ErrorButton, { appearance: "primary", onClick: onRetry }, formatMessage(media_ui_1.messages.try_again)));
        }
        return null;
    };
    ErrorView.prototype.renderCancelButton = function () {
        ...
        return (react_1.default.createElement(styles_1.ErrorButton, { appearance: "subtle", onClick: onCancel }, formatMessage(message)));
    };
    return ErrorView;
}(react_2.Component));
