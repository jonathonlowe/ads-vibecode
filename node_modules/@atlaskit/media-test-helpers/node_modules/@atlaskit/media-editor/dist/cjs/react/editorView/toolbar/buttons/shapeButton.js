...
var ShapeButton = /** @class */ (function (_super) {
    ...
    ShapeButton.prototype.render = function () {
        ...
        var iconBefore = (react_1.default.createElement(styles_1.DropdownLeftIconWrapper, null,
            react_1.default.createElement(Icon, { label: activeShape, size: "medium", primaryColor: iconPrimaryColor })));
        var iconAfter = (react_1.default.createElement(styles_1.DropdownRightIconWrapper, null,
            react_1.default.createElement(chevron_down_1.default, { label: "chevron-icon", primaryColor: iconPrimaryColor })));
        return (react_1.default.createElement(tooltip_1.default, { content: formatMessage(media_ui_1.messages.annotate_tool_shape) },
            react_1.default.createElement(button_1.default, { iconBefore: iconBefore, iconAfter: iconAfter, appearance: "subtle", onClick: onClick, isSelected: isActive })));
    };
    return ShapeButton;
}(react_2.Component));
