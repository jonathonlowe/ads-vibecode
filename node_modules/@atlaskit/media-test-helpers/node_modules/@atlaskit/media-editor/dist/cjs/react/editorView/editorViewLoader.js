...
var AsyncEditorView = /** @class */ (function (_super) {
    ...
    AsyncEditorView.prototype.render = function () {
        if (!this.state.EditorView) {
            return react_1.default.createElement(media_ui_1.ModalSpinner, { blankedColor: "none", invertSpinnerColor: false });
        }
        return react_1.default.createElement(this.state.EditorView, tslib_1.__assign({}, this.props));
    };
