...
var ColorPopup = /** @class */ (function (_super) {
    ...
    ColorPopup.prototype.render = function () {
        ...
        var content = (react_1.default.createElement(popupStyles_1.ColorPopupContentWrapper, { onMouseLeave: this.closeSoon, onMouseEnter: this.cancelCloseSoon }, this.renderButtons()));
        return (react_1.default.createElement(inline_dialog_1.default, { onContentBlur: onClose, isOpen: isOpen, placement: "top-start", content: content }, children));
    };
    ColorPopup.prototype.renderButtons = function () {
        var _a = this.props, onPickColor = _a.onPickColor, currentColor = _a.color;
        return Object.keys(exports.PICKER_COLORS).map(function (color, index) { return (react_1.default.createElement(colorButton_1.ColorButton, { key: "" + index, color: color, isSelected: currentColor.toLowerCase() === color.toLowerCase(), onClick: onPickColor })); });
    };
    return ColorPopup;
}(react_2.Component));
