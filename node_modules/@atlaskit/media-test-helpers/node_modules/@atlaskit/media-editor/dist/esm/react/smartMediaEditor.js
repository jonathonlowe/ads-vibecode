...
export var convertFileNameToPng = function (fileName) {
    if (!fileName) {
...
var SmartMediaEditor = /** @class */ (function (_super) {
    __extends(SmartMediaEditor, _super);
    function SmartMediaEditor() {
        ...
        _this.getFile = function (identifier) {
            ...
            var getFileSubscription = mediaClient.file
            ...
            _this.getFileSubscription = getFileSubscription;
        };
        _this.setRemoteImageUrl = function (identifier) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.copyFileToUserCollection = function (fileId) { return __awaiter(_this, void 0, void 0, function () {
                ...
                next: function (fileState) {
                    if (fileState.status === 'processing') {
                        _this.copyFileToUserCollection(fileState.id).then(function () {
                            ...
                            var duration = end('MediaEditor.MediaAnnotation.Uploaded').duration;
                            fireAnalyticsEvent({
                                eventType: 'track',
                                action: 'uploaded',
                                actionSubject: 'media',
        ...
        _this.renderDeleteConfirmation = function () {
            ...
            if (closeIntent) {
                ...
                return (React.createElement(ModalTransition, null,
                    React.createElement(ModalDialog, { width: "small", appearance: "danger", heading: formatMessage(messages.annotate_confirmation_heading), actions: actions, onClose: _this.closeConfirmationDialog }, formatMessage(messages.annotate_confirmation_content))));
            }
            return null;
        };
        ...
        _this.renderEditor = function (imageUrl) {
            return (React.createElement(EditorView, { imageUrl: imageUrl, onSave: _this.onSave, onCancel: _this.onCancel, onError: _this.onError, onAnyEdit: _this.onAnyEdit }));
        };
    ...
    SmartMediaEditor.prototype.render = function () {
        ...
        return (React.createElement(Blanket, { onClick: this.clickShellNotPass },
            ...
            React.createElement(Shortcut, { keyCode: 27, handler: function () { return _this.onCancel('esc'); } }),
            content));
    };
...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function () {
        var Component = withAnalyticsContext({
            packageName: packageName,
            packageVersion: packageVersion,
        })(withAnalyticsEvents()(injectIntl(SmartMediaEditor)));
        var content = React.createElement(Component, __assign({}, this.props));
