...
var downloadUrl_1 = require("@atlaskit/media-common/downloadUrl");
var __1 = require("..");
...
var overrideMediaTypeIfUnknown_1 = require("../utils/overrideMediaTypeIfUnknown");
...
var createFileStateSubject_1 = require("../utils/createFileStateSubject");
var isMimeTypeSupportedByBrowser_1 = require("../utils/isMimeTypeSupportedByBrowser");
...
var isDataloaderErrorResult = function (result) {
...
var FileFetcherImpl = /** @class */ (function () {
    function FileFetcherImpl(mediaStore) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(Object.keys(fileIdsByCollection).map(function (collectionNameKey) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var fileIds, collectionName, response, error_1;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 3:
                                            ...
                                            fileIds.forEach(function (fileId) {
                                                items.push({
                                                    id: fileId,
                                                    error: error_1 || new Error('Failed to fetch'),
        ...
        this.createDownloadFileStream = function (id, collection) {
            var subject = createFileStateSubject_1.createFileStateSubject();
            var timeoutId;
            var fetchFile = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    FileFetcherImpl.prototype.getFileState = function (id, options) {
        ...
        return __1.getFileStreamsCache().getOrInsert(id, function () {
            ...
            return _this.createDownloadFileStream(id, collection);
        });
    };
    ...
    FileFetcherImpl.prototype.uploadExternal = function (url, collection) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                subject = createFileStateSubject_1.createFileStateSubject();
    ...
    FileFetcherImpl.prototype.upload = function (file, controller, uploadableFileUpfrontIds) {
        ...
        var subject = createFileStateSubject_1.createFileStateSubject();
        var processingSubscription;
        if (content instanceof Blob) {
            size = content.size;
            mimeType = content.type;
            if (isMimeTypeSupportedByBrowser_1.isMimeTypeSupportedByBrowser(content.type)) {
                preview = {
                    value: content,
                    origin: 'local',
                };
        ...
        var onUploadFinish = function (error) {
            ...
            if (!isMimeTypeSupportedByBrowser_1.isMimeTypeSupportedByBrowser(mimeType)) {
                processingSubscription = _this.createDownloadFileStream(id, collection).subscribe({
                    next: function (remoteFileState) {
                        return subject.next(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, stateBase), remoteFileState), overrideMediaTypeIfUnknown_1.overrideMediaTypeIfUnknown(remoteFileState, mediaType)));
                    },
                    error: function (err) { return subject.error(err); },
    ...
    FileFetcherImpl.prototype.downloadBinary = function (id, name, collectionName) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mediaStore.getFileBinaryURL(id, collectionName)];
                    case 1:
                        url = _a.sent();
                        downloadUrl_1.downloadUrl(url, { name: name });
