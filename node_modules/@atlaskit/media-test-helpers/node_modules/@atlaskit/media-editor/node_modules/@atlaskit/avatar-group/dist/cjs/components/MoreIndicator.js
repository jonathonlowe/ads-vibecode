...
var MoreIndicator = /** @class */ (function (_super) {
    ...
    MoreIndicator.prototype.render = function () {
        var outerProps = utils_1.getProps(this);
        var _a = this.props, appearance = _a.appearance, isActive = _a.isActive, isFocus = _a.isFocus, isHover = _a.isHover, size = _a.size, count = _a.count, testId = _a.testId;
        var displayCount = count > MAX_DISPLAY_COUNT ? MAX_DISPLAY_COUNT : count;
        return (react_1.default.createElement(MoreIndicator_1.Outer, tslib_1.__assign({}, outerProps, { isInteractive: true, "data-testid": testId }),
...
exports.default = utils_1.withPseudoState(MoreIndicator);
