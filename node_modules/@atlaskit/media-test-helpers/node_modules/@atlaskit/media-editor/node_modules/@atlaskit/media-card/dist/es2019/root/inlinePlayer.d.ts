...
export declare const InlinePlayer: React.ForwardRefExoticComponent<Pick<Pick<InlinePlayerProps, "onError" | "onClick" | "testId" | "selected" | "dimensions" | "identifier" | "mediaClient">, "onError" | "onClick" | "testId" | "selected" | "identifier" | "mediaClient"> & Partial<Pick<Pick<InlinePlayerProps, "onError" | "onClick" | "testId" | "selected" | "dimensions" | "identifier" | "mediaClient">, "dimensions">> & Partial<Pick<{
    dimensions: {
        width: number;
        height: number;
    };
