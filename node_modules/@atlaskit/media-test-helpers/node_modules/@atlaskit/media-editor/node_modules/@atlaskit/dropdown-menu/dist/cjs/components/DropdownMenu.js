...
var DropdownMenuStateless_1 = tslib_1.__importDefault(require("./DropdownMenuStateless"));
var DropdownMenu = /** @class */ (function (_super) {
    ...
    function DropdownMenu() {
        ...
        _this.state = {
            ...
            items: tslib_1.__spread(_this.props.items),
        };
        ...
        _this.handleItemActivation = function (attrs) {
            ...
            var items = tslib_1.__spread(_this.state.items);
        ...
        _this.handleOpenChange = function (attrs) {
            ...
            (_a = _this.props).onOpenChange.apply(_a, tslib_1.__spread([attrs], args));
        };
        _this.close = function () {
            ...
            (_a = _this.props).onOpenChange.apply(_a, tslib_1.__spread([{ isOpen: false }], args));
        };
        return _this;
    }
    DropdownMenu.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
        if (nextProps.items !== this.state.items) {
            this.setState({ items: tslib_1.__spread(nextProps.items) });
        }
