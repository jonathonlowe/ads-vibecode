...
export declare const importFilesFromLocalUpload: (selectedUploadFile: SelectedUploadFile, uploadId: string, store: Store<State>, localUpload: LocalUpload, replaceFileId?: string | undefined) => Promise<void>;
export declare const importFilesFromRecentFiles: (selectedUploadFile: SelectedUploadFile, store: Store<State>) => Promise<void>;
export declare const importFilesFromRemoteService: (selectedUploadFile: SelectedUploadFile, store: Store<State>, wsConnectionHolder: WsConnectionHolder) => Promise<void>;
