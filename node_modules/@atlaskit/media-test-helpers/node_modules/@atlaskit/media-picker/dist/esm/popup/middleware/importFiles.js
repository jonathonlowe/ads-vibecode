...
import { getFileStreamsCache, getMediaTypeFromMimeType, isPreviewableType, globalMediaEventEmitter, observableToPromise, isErrorFileState, safeUnsubscribe, } from '@atlaskit/media-client';
 ...
 */
export var touchSelectedFile = function (touchFileDescriptor, store) {
                ...
                case 2:
                    ...
                    selectedUploadFiles.forEach(function (selectedUploadFile) {
                        ...
                        if (serviceName === 'upload') {
                            ...
                            importFilesFromLocalUpload(selectedUploadFile, fileId, store, localUpload, fileId);
                        }
...
export var importFilesFromLocalUpload = function (selectedUploadFile, uploadId, store, localUpload, replaceFileId) { return __awaiter(void 0, void 0, void 0, function () {
    var id, touchFileDescriptor;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = selectedUploadFile.file.id, touchFileDescriptor = selectedUploadFile.touchFileDescriptor;
                store.dispatch(setEventProxy(id, uploadId));
                return [4 /*yield*/, touchSelectedFile(touchFileDescriptor, store)];
            case 1:
                _a.sent();
...
export var importFilesFromRecentFiles = function (selectedUploadFile, store) { return __awaiter(void 0, void 0, void 0, function () {
...
export var importFilesFromRemoteService = function (selectedUploadFile, store, wsConnectionHolder) { return __awaiter(void 0, void 0, void 0, function () {
    var touchFileDescriptor, serviceName, accountId, file, fileId, uploadActivity;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                fileId = touchFileDescriptor.fileId;
                uploadActivity = new RemoteUploadActivity(fileId, serviceName, function (event, payload) {
