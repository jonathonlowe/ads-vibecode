...
var App = /** @class */ (function (_super) {
    ...
    function App(props) {
        ...
        _this.renderClipboard = function () {
            ...
            return (React.createElement(Clipboard, { mediaClient: _this.componentMediaClient, config: config, onUploadsStart: _this.onDrop, onPreviewUpdate: onUploadPreviewUpdate, onStatusUpdate: onUploadStatusUpdate, onEnd: onUploadEnd, onError: onUploadError }));
        };
        _this.renderBrowser = function () {
            ...
            return (React.createElement(BrowserComponent, { ref: _this.browserRef, mediaClient: _this.componentMediaClient, config: config, onUploadsStart: onUploadsStart, onPreviewUpdate: onUploadPreviewUpdate, onStatusUpdate: onUploadStatusUpdate, onEnd: onUploadEnd, onError: onUploadError }));
        };
