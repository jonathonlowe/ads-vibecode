...
import { MediaStore, getFileStreamsCache, createFileStateSubject, observableToPromise, } from '@atlaskit/media-client';
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (!(firstItem &&
                                ...
                                tenantSubject &&
                                tenantSubject.next)) return [3 /*break*/, 3];
...
function copyFile(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _b, tenantMediaClient, config, collection, mediaStore, body, resolvedReplaceFileId, _c, params, destinationFile, tenantSubject, fileState, error_1, erroredFileId, errorState, cache, fileCache;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 7:
                    error_1 = _d.sent();
                    erroredFileId = resolvedReplaceFileId || file.id;
                    errorState = {
                        id: erroredFileId,
                        status: 'error',
                    ...
                    fileCache = cache.get(erroredFileId);
