...
export declare class BrowserLoader extends React.PureComponent<BrowserWithMediaClientConfigProps, State> {
    ...
    state: {
        Browser: React.ComponentClass<WithMediaClientConfigProps<Pick<BrowserProps, "ref" | "onError" | "createAnalyticsEvent" | "mediaClient" | "onUploadsStart" | "onPreviewUpdate" | "onStatusUpdate" | "onEnd" | "isOpen" | "onClose" | "onBrowseFn" | "onCancelFn"> & {
            config?: BrowserConfig | undefined;
        }>, any> | React.FunctionComponent<WithMediaClientConfigProps<Pick<BrowserProps, "ref" | "onError" | "createAnalyticsEvent" | "mediaClient" | "onUploadsStart" | "onPreviewUpdate" | "onStatusUpdate" | "onEnd" | "isOpen" | "onClose" | "onBrowseFn" | "onCancelFn"> & {
            config?: BrowserConfig | undefined;
        }>> | undefined;
    };
