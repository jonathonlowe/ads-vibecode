                ...
                var subscription = observable_1.subscribe({
                    next: function (state) {
                        if (state.status !== 'error') {
                            media_client_1.safeUnsubscribe(subscription);
                ...
                case 2:
                    ...
                    selectedUploadFiles.forEach(function (selectedUploadFile) {
                        ...
                        if (serviceName === 'upload') {
                            ...
                            exports.importFilesFromLocalUpload(selectedUploadFile, fileId, store, localUpload, fileId);
                        }
...
exports.importFilesFromLocalUpload = function (selectedUploadFile, uploadId, store, localUpload, replaceFileId) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var id, touchFileDescriptor;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = selectedUploadFile.file.id, touchFileDescriptor = selectedUploadFile.touchFileDescriptor;
                store.dispatch(setEventProxy_1.setEventProxy(id, uploadId));
...
exports.importFilesFromRecentFiles = function (selectedUploadFile, store) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
...
exports.importFilesFromRemoteService = function (selectedUploadFile, store, wsConnectionHolder) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                fileId = touchFileDescriptor.fileId;
                uploadActivity = new remoteUploadActivity_1.RemoteUploadActivity(fileId, serviceName, function (event, payload) {
