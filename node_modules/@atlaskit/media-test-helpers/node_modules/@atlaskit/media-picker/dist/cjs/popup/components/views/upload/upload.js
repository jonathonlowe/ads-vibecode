...
var StatelessUploadView = /** @class */ (function (_super) {
    ...
    StatelessUploadView.prototype.render = function () {
        ...
        return (React.createElement(media_ui_1.InfiniteScroll, { "data-testid": "media-picker-recents-infinite-scroll", height: "100%", onThresholdReached: this.onThresholdReachedListener },
    ...
    StatelessUploadView.prototype.renderCards = function () {
        ...
        return uploadingFilesCards.concat(recentFilesCards).map(function (_a) {
            ...
            return (React.createElement(styled_1.CardWrapper, { tabIndex: 0, key: key }, card));
        });
    };
    StatelessUploadView.prototype.uploadingFilesCards = function () {
        ...
        return itemsKeys.map(function (key) {
            ...
            return {
                isUploading: true,
                key: id,
                card: (React.createElement(media_card_1.Card, { mediaClientConfig: mediaClient.config, identifier: identifier, dimensions: cardDimension, selectable: true, selected: selected, onClick: onClick, actions: actions, testId: "media-picker-uploading-media-card" })),
            };
        });
    };
    StatelessUploadView.prototype.recentFilesCards = function () {
        ...
        return items.map(function (item) {
            ...
            return {
                ...
                card: (React.createElement(media_card_1.Card, { mediaClientConfig: mediaClient.config, identifier: {
                        id: id,
                        mediaItemType: 'file',
                        collectionName: recentsCollection,
                    }, dimensions: cardDimension, selectable: true, selected: selected, onClick: onClick, actions: actions, testId: "media-picker-recent-media-card" })),
            };
        });
    };
