...
export declare const isGetFilesInRecentsAction: (action: Action) => action is GetFilesInRecentsAction;
...
export declare const isGetFilesInRecentsFullfilledAction: (action: Action) => action is GetFilesInRecentsFullfilledAction;
...
export declare const isGetFilesInRecentsFailedAction: (action: Action) => action is GetFilesInRecentsFailedAction;
