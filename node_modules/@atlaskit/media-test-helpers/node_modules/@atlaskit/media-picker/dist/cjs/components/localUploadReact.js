...
var basePayload = function (_a, additionalAttributes) {
    var size = _a.size, type = _a.type;
    if (additionalAttributes === void 0) { additionalAttributes = {}; }
    return ({
        actionSubject: 'mediaUpload',
        actionSubjectId: 'localMedia',
        attributes: tslib_1.__assign({ packageName: version_json_1.name, sourceType: 'local', fileAttributes: {
                fileSize: size,
                fileMimetype: type,
...
var LocalUploadComponentReact = /** @class */ (function (_super) {
    ...
    function LocalUploadComponentReact(props) {
        ...
        _this.fireUploadFailed = function (payload) {
            var _a = payload.file, size = _a.size, type = _a.type, id = _a.id;
            var _b = perf_marks_1.end("MediaPicker.fireUpload." + id).duration, duration = _b === void 0 ? -1 : _b;
            _this.createAndFireAnalyticsEvent(tslib_1.__assign(tslib_1.__assign({}, basePayload({ size: size, type: type }, {
                status: 'fail',
        ...
        var _a = _this.props, mediaClient = _a.mediaClient, config = _a.config, onUploadsStart = _a.onUploadsStart, onPreviewUpdate = _a.onPreviewUpdate, onStatusUpdate = _a.onStatusUpdate, onEnd = _a.onEnd, onError = _a.onError;
