...
export default function withPseudoState<Props extends WithPseudoStateProps>(WrappedComponent: ComponentType<Props>): {
    new (props: Readonly<Props>): {
        ...
        render(): JSX.Element;
        context: any;
        setState<K extends "isActive" | "isHover" | "isFocus" | "isInteractive">(state: State | ((prevState: Readonly<State>, props: Readonly<Props>) => State | Pick<State, K> | null) | Pick<State, K> | null, callback?: (() => void) | undefined): void;
