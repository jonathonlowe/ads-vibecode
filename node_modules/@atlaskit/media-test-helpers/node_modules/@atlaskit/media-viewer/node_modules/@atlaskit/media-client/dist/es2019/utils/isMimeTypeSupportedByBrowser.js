...
export const isAudioMimeTypeSupportedByBrowser = (mimeType) => mimeType.indexOf('audio/') === 0;
/**
...
export const isMimeTypeSupportedByBrowser = (mimeType) => isDocumentMimeTypeSupportedByBrowser(mimeType) ||
