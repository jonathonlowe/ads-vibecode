...
var droplist_1 = tslib_1.__importStar(require("@atlaskit/droplist"));
var chevron_down_1 = tslib_1.__importDefault(require("@atlaskit/icon/glyph/chevron-down"));
var WidthConstrainer_1 = tslib_1.__importDefault(require("../styled/WidthConstrainer"));
var keys_1 = require("../util/keys");
var version_json_1 = require("../version.json");
var DropdownItemClickManager_1 = tslib_1.__importDefault(require("./context/DropdownItemClickManager"));
var DropdownItemFocusManager_1 = tslib_1.__importDefault(require("./context/DropdownItemFocusManager"));
var DropdownItemSelectionCache_1 = tslib_1.__importDefault(require("./context/DropdownItemSelectionCache"));
var DropdownMenuStateless = /** @class */ (function (_super) {
    tslib_1.__extends(DropdownMenuStateless, _super);
    function DropdownMenuStateless() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.dropdownListPositioned = false;
        _this.state = {
            id: react_uid_1.uid({ id: _this.constructor.name }),
        ...
        _this.isTargetChildItem = function (target) {
            ...
            var thisDom = react_dom_1.findDOMNode(_this);
        ...
        _this.handleKeyboardInteractionForClosed = function (event) {
            ...
            switch (event.key) {
                case keys_1.KEY_DOWN:
                case keys_1.KEY_SPACE:
                case keys_1.KEY_ENTER:
        ...
        _this.triggerContent = function () {
            ...
            if (!triggerProps.iconAfter && !triggerProps.iconBefore) {
                triggerProps.iconAfter = react_1.default.createElement(chevron_down_1.default, { size: "medium", label: "" });
            }
            return (react_1.default.createElement(button_1.default, tslib_1.__assign({}, defaultButtonProps, triggerProps, { testId: testId && testId + "--trigger" }), insideTriggerContent));
        };
        ...
        _this.renderTrigger = function () {
            ...
            return _this.isUsingDeprecatedAPI() ? (triggerContent) : (react_1.default.createElement("div", { ref: function (ref) {
                    _this.triggerContainer = ref;
                } }, triggerContent));
        };
        _this.renderItems = function (items) {
            return items.map(function (item, itemIndex) { return (react_1.default.createElement(droplist_1.Item, tslib_1.__assign({}, item, { key: itemIndex, onActivate: function (_a) {
                    var event = _a.event;
                    _this.props.onItemActivated({ item: item, event: event });
                } }), item.content)); });
        };
        _this.renderGroups = function (groups) {
            return groups.map(function (group, groupIndex) { return (react_1.default.createElement(droplist_1.Group, { heading: group.heading, elemAfter: group.elemAfter, key: groupIndex }, _this.renderItems(group.items))); });
        };
        _this.renderDeprecated = function () {
            var _a = _this.props, items = _a.items, shouldFitContainer = _a.shouldFitContainer;
            var id = _this.state.id;
            return (react_1.default.createElement("div", { id: id, ref: function (ref) {
        ...
        _this.renderDropdownItems = function () {
            if (_this.sourceOfIsOpen === 'keydown' && _this.dropdownListPositioned) {
                return (react_1.default.createElement(DropdownItemFocusManager_1.default, { autoFocus: _this.state.autoFocusDropdownItems, close: _this.close }, _this.props.children));
            }
            return react_1.default.createElement(react_1.Fragment, null, _this.props.children);
        };
        return _this;
    }
    ...
    DropdownMenuStateless.prototype.render = function () {
        ...
        return (react_1.default.createElement(DropdownItemSelectionCache_1.default, null,
            react_1.default.createElement(droplist_1.default, tslib_1.__assign({ appearance: appearance, boundariesElement: boundariesElement, isLoading: isLoading, isOpen: isOpen, onClick: function (e) { return _this.handleClick(e); }, onOpenChange: this.handleOpenChange, position: position, isMenuFixed: isMenuFixed, shouldFitContainer: shouldFitContainer, shouldFlip: shouldFlip, trigger: this.renderTrigger(), onPositioned: this.onDroplistPositioned }, deprecatedProps, { analyticsContext: {
                    componentName: 'dropdownMenu',
                    packageName: version_json_1.name,
                    packageVersion: version_json_1.version,
                }, testId: testId }), isDeprecated ? (this.renderDeprecated()) : (react_1.default.createElement(WidthConstrainer_1.default, { id: id, role: "menu", shouldFitContainer: shouldFitContainer },
                react_1.default.createElement(DropdownItemClickManager_1.default, { onItemClicked: function (event) {
...
exports.DropdownMenuStateless = DropdownMenuStateless;
