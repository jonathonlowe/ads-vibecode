...
var hashingFunction = function (blob) { return __awaiter(void 0, void 0, void 0, function () {
    var hasher;
...
var createProbingFunction = function (store, collection) { return function (chunks) { return __awaiter(void 0, void 0, void 0, function () {
...
export var uploadFile = function (file, store, uploadableFileUpfrontIds, callbacks) {
    ...
    Promise.all([deferredUploadId, response])
        .then(function (_a) {
        var _b = __read(_a, 1), uploadId = _b[0];
