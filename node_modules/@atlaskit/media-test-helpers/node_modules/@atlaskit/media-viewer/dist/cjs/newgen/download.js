...
var downloadIcon = react_1.default.createElement(download_2.default, { label: "Download" });
// TODO: MS-1556
...
exports.ErrorViewDownloadButton = function (props) {
    ...
    return (react_1.default.createElement(styled_1.DownloadButtonWrapper, null,
        react_1.default.createElement(exports.DownloadButton, { testId: "media-viewer-download-button", analyticspayload: downloadEvent, appearance: "primary", onClick: exports.createItemDownloader(props.state, props.mediaClient, props.collectionName) },
            react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.download)))));
};
exports.ToolbarDownloadButton = function (props) {
    ...
    return (react_1.default.createElement(exports.DownloadButton, { testId: "media-viewer-download-button", analyticspayload: downloadEvent, appearance: 'toolbar', onClick: exports.createItemDownloader(state, mediaClient, identifier.collectionName), iconBefore: downloadIcon }));
};
exports.DisabledToolbarDownloadButton = (react_1.default.createElement(media_ui_2.MediaButton, { appearance: 'toolbar', isDisabled: true, iconBefore: downloadIcon }));
