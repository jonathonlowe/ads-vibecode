...
var AsyncMediaViewer = /** @class */ (function (_super) {
    ...
    AsyncMediaViewer.prototype.render = function () {
        ...
        if (!MediaViewer || !MediaViewerErrorBoundary) {
            return (react_1.default.createElement(media_ui_1.ModalSpinner, { blankedColor: colors.DN30, invertSpinnerColor: true }));
        }
        return (react_1.default.createElement(MediaViewerErrorBoundary, null,
            react_1.default.createElement(MediaViewer, tslib_1.__assign({}, this.props))));
    };
