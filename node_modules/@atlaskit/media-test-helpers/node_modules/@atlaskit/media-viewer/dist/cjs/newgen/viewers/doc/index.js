...
var DocViewer = /** @class */ (function (_super) {
    ...
    DocViewer.prototype.init = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, item, mediaClient, collectionName, onError, src, err_1, src;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        _a = this.props, item = _a.item, mediaClient = _a.mediaClient, collectionName = _a.collectionName, onError = _a.onError;
    ...
    DocViewer.prototype.renderSuccessful = function (content) {
        var _a = this.props, onClose = _a.onClose, onSuccess = _a.onSuccess, onError = _a.onError, isSidebarVisible = _a.isSidebarVisible;
        var PDFComponent = DocViewer.PDFComponent;
        if (!PDFComponent) {
            return react_1.default.createElement(loading_1.Spinner, null);
        }
        return (react_1.default.createElement(PDFComponent, { src: content, onSuccess: onSuccess, onError: onError, onClose: onClose, isSidebarVisible: isSidebarVisible }));
    };
    return DocViewer;
