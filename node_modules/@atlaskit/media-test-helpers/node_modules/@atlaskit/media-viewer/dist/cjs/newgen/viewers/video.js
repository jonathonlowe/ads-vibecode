...
var VideoViewer = /** @class */ (function (_super) {
    ...
    VideoViewer.prototype.renderSuccessful = function (content) {
        ...
        return useCustomVideoPlayer ? (react_1.default.createElement(styled_1.CustomVideoPlayerWrapper, { "data-testid": "media-viewer-video-content" },
            react_1.default.createElement(media_ui_1.CustomMediaPlayer, { type: "video", isAutoPlay: isAutoPlay, onHDToggleClick: this.onHDChange, showControls: showControls, src: content, isHDActive: isHDActive, isHDAvailable: isHDAvailable(item), isShortcutEnabled: true, onCanPlay: onCanPlay, onFirstPlay: this.onFirstPlay, onError: onError }))) : (react_1.default.createElement(styled_1.Video, { autoPlay: isAutoPlay, controls: true, src: content }));
    };
...
function isHDAvailable(file) {
    ...
    return !!media_client_1.getArtifactUrl(file.artifacts, hdArtifact);
}
