...
var defaultCover = (react_1.default.createElement(styled_1.DefaultCoverWrapper, null,
    react_1.default.createElement(audio_1.default, { label: "cover", size: "xlarge", primaryColor: styled_1.blanketColor })));
...
var AudioViewer = /** @class */ (function (_super) {
    ...
    function AudioViewer() {
        ...
        _this.renderCover = function () {
            ...
            if (coverUrl && item.status !== 'error') {
                return react_1.default.createElement(styled_1.AudioCover, { src: coverUrl, alt: item.name });
            }
            else {
                return defaultCover;
            }
    ...
    AudioViewer.prototype.renderSuccessful = function (src) {
        ...
        return useCustomAudioPlayer ? (react_1.default.createElement(styled_1.AudioPlayer, { "data-testid": "media-viewer-audio-content" },
            this.renderCover(),
            react_1.default.createElement(styled_1.CustomAudioPlayerWrapper, null,
                react_1.default.createElement(media_ui_1.CustomMediaPlayer, { type: "audio", isAutoPlay: isAutoPlay, src: src, isShortcutEnabled: true, showControls: showControls, onCanPlay: onCanPlay, onFirstPlay: this.onFirstPlay, onError: onError })))) : (react_1.default.createElement(styled_1.AudioPlayer, null,
            this.renderCover(),
            react_1.default.createElement(styled_1.CustomAudioPlayerWrapper, null,
                react_1.default.createElement(styled_1.Audio, { autoPlay: isAutoPlay, controls: true, innerRef: this.saveAudioElement, src: src, preload: "metadata" }))));
    };
