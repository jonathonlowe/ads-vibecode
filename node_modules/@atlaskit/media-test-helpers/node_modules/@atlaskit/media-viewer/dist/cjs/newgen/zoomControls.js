...
var ZoomControlsBase = /** @class */ (function (_super) {
    ...
    ZoomControlsBase.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.ZoomWrapper, { className: media_ui_1.hideControlsClassName },
            react_1.default.createElement(styled_1.ZoomControlsWrapper, null,
                react_1.default.createElement(media_ui_1.MediaButton, { appearance: 'toolbar', isDisabled: !zoomLevel.canZoomOut, onClick: this.zoomOut, iconBefore: react_1.default.createElement(zoom_out_1.default, { label: formatMessage(media_ui_2.messages.zoom_out) }) }),
                react_1.default.createElement(media_ui_1.MediaButton, { appearance: 'toolbar', isDisabled: !zoomLevel.canZoomIn, onClick: this.zoomIn, iconBefore: react_1.default.createElement(zoom_in_1.default, { label: formatMessage(media_ui_2.messages.zoom_in) }) })),
            react_1.default.createElement(styled_1.ZoomLevelIndicator, null, zoomLevel.asPercentage)));
    };
