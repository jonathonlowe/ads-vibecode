...
declare const withToggleInteraction: (WrappedComponent: React.ComponentType<{}>, SelectionIcon: React.ComponentType<IconProps>, getAriaRole: () => Behaviors) => {
    new (props: Readonly<Props>): {
        ...
        handleItemActivated: (event: React.KeyboardEvent<HTMLElement> | React.MouseEvent<HTMLElement, MouseEvent>) => void;
