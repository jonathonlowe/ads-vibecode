...
exports.Ellipsify = function (_a) {
    var text = _a.text, lines = _a.lines, endLength = _a.endLength, inline = _a.inline, testId = _a.testId;
    return (react_1.default.createElement(Wrapper, { className: "ellipsed-text", innerRef: setEllipsis({ lines: lines, endLength: endLength }), "aria-label": text, inline: inline, "data-testid": testId }, text));
};
