...
var BlockCardResolvedView = /** @class */ (function (_super) {
    ...
    BlockCardResolvedView.prototype.renderIcon = function () {
        ...
        if (icon.url) {
            ...
            return (react_1.default.createElement(styled_1.IconWrapper, null,
                react_1.default.createElement(tooltip_1.default, { content: icon.tooltip },
                    react_1.default.createElement(ImageIcon_1.ImageIcon, { src: icon.url, size: 24 }))));
        }
        return icon;
    };
    BlockCardResolvedView.prototype.renderThumbnail = function () {
        ...
        // TODO: handle if there is an error loading the image -> show the placeholder
        return react_1.default.createElement(styled_1.Thumbnail, { src: thumbnail });
    };
    BlockCardResolvedView.prototype.renderUser = function () {
        ...
        return react_1.default.createElement(avatar_1.default, { size: "medium", src: user.icon, name: user.name });
    };
    BlockCardResolvedView.prototype.renderUsers = function () {
        ...
        return (react_1.default.createElement(styled_1.UsersWrapper, null,
            react_1.default.createElement(avatar_group_1.default, { maxCount: styled_1.maxAvatarCount, appearance: "stack", size: "small", data: users.map(function (user) { return ({
                    name: user.name,
                    src: user.icon,
                    size: 'small',
    ...
    BlockCardResolvedView.prototype.renderActions = function () {
        ...
        return (react_1.default.createElement(styled_1.ActionsWrapper, null, actions.slice(0, 3).map(function (action) {
            var id = action.id, text = action.text;
            var isPending = pendingActionsById[id];
            return (react_1.default.createElement(button_1.default, { key: id, spacing: "compact", isDisabled: isPending || isAnyActionFailed, isLoading: isPending, onClick: _this.createActionHandler(action) }, text));
        })));
    };
    BlockCardResolvedView.prototype.renderAlert = function () {
        var alert = this.state.alert;
        return (react_1.default.createElement(styled_1.AlertWrapper, null,
            react_1.default.createElement(Transition_1.default, { enter: ['fade', 'slide-up'], exit: ['fade', 'slide-down'], timeout: 300 }, alert ? (react_1.default.createElement(AlertView_1.default, { type: alert.type === 'success' ? 'success' : 'failure', text: alert.text, onRetry: this.handleActionRetry, onDismis: this.handleActionDismis })) : null)));
    };
    BlockCardResolvedView.prototype.renderWithToolTip = function (Elem, model) {
        if (model.tooltip) {
            return (react_1.default.createElement(tooltip_1.default, { content: model.tooltip },
                react_1.default.createElement(Elem, null, model.text)));
        }
        else {
            return react_1.default.createElement(Elem, null, model.text);
        }
    };
    BlockCardResolvedView.prototype.render = function () {
        ...
        return (react_1.default.createElement(ExpandedFrame_1.ExpandedFrame, { minWidth: dimensions_1.minWidth, maxWidth: dimensions_1.maxWidth, isSelected: isSelected, href: link, icon: react_1.default.createElement(ImageIcon_1.ImageIcon, { src: context && context.icon, default: react_1.default.createElement(link_1.default, { label: "icon", size: "small" }) }), text: context && context.text, onClick: onClick },
            preview && react_1.default.createElement(PreviewView_1.PreviewView, { url: preview }),
            react_1.default.createElement(styled_1.ContentWrapper, null,
                this.renderAlert(),
                (icon || user) && (react_1.default.createElement(styled_1.LeftWrapper, null,
                    this.renderIcon(),
                    !icon && this.renderUser())),
                react_1.default.createElement(styled_1.RightWrapper, null,
                    this.renderThumbnail(),
                    title && title.text && this.renderWithToolTip(styled_1.Title, title),
                    !byline ? null : !byline.text ? (react_1.default.createElement(styled_1.Byline, null, byline)) : (this.renderWithToolTip(styled_1.Byline, byline)),
                    description &&
                        description.text &&
                        this.renderWithToolTip(styled_1.Description, description),
                    react_1.default.createElement(Widgets_1.default, { details: details }),
                    this.renderUsers(),
                    this.renderActions()))));
    };
