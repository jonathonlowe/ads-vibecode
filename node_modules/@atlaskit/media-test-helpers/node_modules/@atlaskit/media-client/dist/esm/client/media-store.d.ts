import { AsapBasedAuth, AuthContext, ClientAltBasedAuth, MediaApiConfig } from '@atlaskit/media-core';
import { MediaFile, MediaCollectionItems, MediaUpload, MediaChunksProbe, MediaCollectionItemFullDetails, RequestMethod, RequestParams, RequestHeaders, MediaFileArtifacts } from '..';
export declare class MediaStore {
    ...
    getFileBinaryURL: (id: string, collectionName?: string | undefined) => Promise<string>;
    ...
    getImage: (id: string, params?: MediaStoreGetFileImageParams | undefined, controller?: AbortController | undefined, fetchMaxRes?: boolean | undefined) => Promise<Blob>;
