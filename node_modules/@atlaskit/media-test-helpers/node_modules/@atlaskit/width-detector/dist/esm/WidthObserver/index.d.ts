...
import { IframeWidthObserverFallbackWrapper, IframeWrapperConsumer } from './iframe-fallbacks';
/**
 ...
 * ```
 */
export declare const WidthObserver: React.MemoExoticComponent<(props: WidthObserverProps) => JSX.Element>;
