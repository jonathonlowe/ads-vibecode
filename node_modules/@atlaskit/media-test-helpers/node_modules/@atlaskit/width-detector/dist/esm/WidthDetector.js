...
var WidthDetector = /** @class */ (function (_super) {
    ...
    WidthDetector.prototype.render = function () {
        ...
        var _a = this.props, containerStyle = _a.containerStyle, onResize = _a.onResize, children = _a.children, props = __rest(_a, ["containerStyle", "onResize", "children"]);
        return (React.createElement("div", __assign({}, props, { style: __assign(__assign({}, containerDivStyle), containerStyle), ref: this.handleContainerRef }),
