...
function createTheme(defaultGetTokens) {
    ...
    /* Internally, Theme uses React Context, with internal providers and consumers.
       The React Context passes only a function that gets props, and turns them into tokens. This
          ...
          the theme. */
    var ThemeContext = react_1.createContext(defaultGetTokens);
    ...
    function Consumer(props) {
        var children = props.children, themeProps = tslib_1.__rest(props, ["children"]);
        var theme = react_1.useContext(ThemeContext);
        ...
        return react_1.default.createElement(react_1.default.Fragment, null, children(tokens));
    }
    ...
    */
    function Provider(props) {
        var themeFn = react_1.useContext(ThemeContext);
        var valueFn = props.value || emptyThemeFn;
        var mixedFn = react_1.useCallback(function (themeProps) { return valueFn(themeFn, themeProps); }, [themeFn, valueFn]);
        return (react_1.default.createElement(ThemeContext.Provider, { value: mixedFn }, props.children));
    }
