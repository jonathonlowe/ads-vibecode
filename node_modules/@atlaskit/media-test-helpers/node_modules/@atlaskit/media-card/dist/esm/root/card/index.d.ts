...
export declare class CardBase extends Component<CardWithAnalyticsEventsProps, CardState> {
    ...
    releaseStateDataURI: () => void;
    getResolvedId(): Promise<string>;
    updateStateForIdentifier(): void;
    private getDataURIOriginalDimensions;
    ...
    fireLoadingStatusAnalyticsEvent: ({ resolvedId, status, metadata, error, }: {
        resolvedId: string;
        status: CardStatus;
        metadata?: FileDetails | undefined;
        error?: Error | undefined;
    }) => void;
    fireCardCommencedAnalytics(): Promise<void>;
    fireFileCopiedAnalytics: () => Promise<void>;
