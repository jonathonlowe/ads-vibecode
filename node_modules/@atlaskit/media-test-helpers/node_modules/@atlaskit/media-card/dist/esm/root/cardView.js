...
var CardViewBase = /** @class */ (function (_super) {
    ...
    CardViewBase.prototype.render = function () {
        var _a = this.props, dimensions = _a.dimensions, appearance = _a.appearance, onClick = _a.onClick, onMouseEnter = _a.onMouseEnter, testId = _a.testId;
        var wrapperDimensions = dimensions
            ? dimensions
            : getDefaultCardDimensions(appearance);
        return (React.createElement(Wrapper, { "data-testid": testId || 'media-card-view', shouldUsePointerCursor: true, breakpointSize: breakpointSize(this.width), appearance: appearance, dimensions: wrapperDimensions, onClick: onClick, onMouseEnter: onMouseEnter, innerRef: this.divRef }, this.renderFile()));
    };
