...
var FileCardImageViewBase = /** @class */ (function (_super) {
    ...
    function FileCardImageViewBase() {
        ...
        _this.renderCardContents = function () {
            var _a = _this.props, status = _a.status, mediaType = _a.mediaType;
            if (status === 'error') {
            ...
            if (mediaType !== 'video' && _this.isImageNotReadyForDisplay) {
        ...
        _this.renderLoadingContents = function () {
            return (react_1.default.createElement("div", { className: "wrapper" },
                react_1.default.createElement("div", { className: "img-wrapper" },
                    react_1.default.createElement(cardLoading_1.CardLoading, null))));
        };
        _this.renderErrorContents = function () {
            var _a = _this.props, error = _a.error, alt = _a.alt, mediaName = _a.mediaName, mediaType = _a.mediaType, onRetry = _a.onRetry, actions = _a.actions, fileSize = _a.fileSize;
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { className: "wrapper" }),
                react_1.default.createElement(cardOverlay_1.CardOverlay, { persistent: true, mediaName: mediaName, mediaType: mediaType, error: error, alt: alt, onRetry: onRetry, actions: actions, subtitle: fileSize })));
        };
        _this.renderFailedContents = function () {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { className: "wrapper" }),
                react_1.default.createElement(cardOverlay_1.CardOverlay, { noHover: true, persistent: true, mediaName: mediaName, mediaType: mediaType, actions: actions, subtitle: fileSize })));
        };
        _this.renderUploadingCardOverlay = function () {
            ...
            return (react_1.default.createElement(cardOverlay_1.CardOverlay, { persistent: isPersistent, selectable: selectable, selected: selected }));
        };
        _this.renderPlayButton = function () {
            var _a = _this.props, mediaType = _a.mediaType, selectable = _a.selectable, dataURI = _a.dataURI;
            if (mediaType !== 'video') {
                return null;
            }
            if (selectable && !shouldDisplayImageThumbnail_1.shouldDisplayImageThumbnail(dataURI, mediaType)) {
                return null;
            }
            return (react_1.default.createElement(styled_1.PlayIconWrapper, null,
                react_1.default.createElement(vid_play_1.default, { label: "play", size: "large" })));
        };
        ...
        _this.renderMediaImage = function () {
            ...
            return (react_1.default.createElement(media_ui_1.MediaImage, { dataURI: dataURI, alt: alt, crop: _this.isCropped, stretch: _this.isStretched, previewOrientation: previewOrientation, onImageLoad: _this.onImageLoad, onImageError: _this.onImageError }));
        };
        ...
        _this.fireLoadingStatusAnalyticsEvent = function (action) {
            ...
            if (_this.shouldFireLoadingStatusAnalyticsEvent(action)) {
                ...
                if (action === 'failed') {
                    analytics_1.createAndFireCustomMediaEvent(analytics_1.getLoadingStatusAnalyticsPayload(action, undefined, undefined, {
                        error: 'unknown error',
                        failReason: 'file-uri-error',
                    }), createAnalyticsEvent);
                }
                else {
                    analytics_1.createAndFireCustomMediaEvent(analytics_1.getLoadingStatusAnalyticsPayload(action), createAnalyticsEvent);
                }
            }
        };
        _this.renderProgressBar = function () {
            ...
            return (react_1.default.createElement(styled_1.ProgressBarWrapper, null,
                react_1.default.createElement(styled_1.Overlay, null,
                    react_1.default.createElement(styled_1.Title, null,
                        react_1.default.createElement(media_ui_1.Ellipsify, { testId: "media-card-file-name", text: mediaName || '', lines: 2 })),
                    react_1.default.createElement(styled_1.Body, null,
                        react_1.default.createElement(styled_1.ProgressWrapper, null,
                            react_1.default.createElement(progressBar_1.ProgressBar, { progress: progress })),
                        react_1.default.createElement(styled_1.CardActionsWrapper, null, actions ? (react_1.default.createElement(cardActions_1.default, { actions: actions, triggerColor: "white" })) : null)))));
        };
        ...
        _this.renderSuccessCardOverlay = function () {
            ...
            var isPersistent = mediaType === 'doc' || !dataURI;
            return (react_1.default.createElement(cardOverlay_1.CardOverlay, { persistent: isPersistent, selectable: selectable, selected: selected, mediaName: mediaName, mediaType: mediaType, subtitle: fileSize, actions: actions }));
        };
        return _this;
    }
    FileCardImageViewBase.prototype.render = function () {
        var _a = this.props, disableOverlay = _a.disableOverlay, selectable = _a.selectable, selected = _a.selected, mediaType = _a.mediaType, progress = _a.progress, status = _a.status, mediaName = _a.mediaName;
        return (react_1.default.createElement(styled_1.Wrapper, { "data-testid": "media-file-card-view", "data-test-media-name": mediaName, "data-test-status": status, "data-test-progress": progress, "data-test-selected": selected ? true : undefined, disableOverlay: disableOverlay, selectable: selectable, selected: selected, mediaType: mediaType }, this.renderCardContents()));
    };
