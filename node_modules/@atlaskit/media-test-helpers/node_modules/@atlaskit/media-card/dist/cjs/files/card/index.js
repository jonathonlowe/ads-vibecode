...
var FileCard = /** @class */ (function (_super) {
    ...
    FileCard.prototype.renderFile = function () {
        ...
        var errorMessage = this.isError && (react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.failed_to_load)));
        var fileSize = size ? utils_1.toHumanReadableMediaSize(size) : '';
        return (react_1.default.createElement(cardImageView_1.FileCardImageView, { error: errorMessage, dimensions: dimensions, selectable: selectable, selected: selected, dataURI: dataURI, mediaName: name, mediaType: mediaType, fileSize: fileSize, status: status, progress: progress, resizeMode: resizeMode, onRetry: onRetry, onDisplayImage: onDisplayImage, actions: this.getActions(), disableOverlay: disableOverlay, previewOrientation: previewOrientation, alt: alt }));
    };
