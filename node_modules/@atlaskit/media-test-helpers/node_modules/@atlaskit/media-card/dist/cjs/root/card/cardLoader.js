...
var CardLoader = /** @class */ (function (_super) {
    ...
    CardLoader.prototype.render = function () {
        var _a = this.props, dimensions = _a.dimensions, testId = _a.testId;
        var _b = this.state, Card = _b.Card, MediaCardErrorBoundary = _b.MediaCardErrorBoundary;
        if (!Card || !MediaCardErrorBoundary) {
            return react_1.default.createElement(__1.CardLoading, { testId: testId, dimensions: dimensions });
        }
        return (react_1.default.createElement(MediaCardErrorBoundary, null,
            react_1.default.createElement(Card, tslib_1.__assign({}, this.props))));
    };
