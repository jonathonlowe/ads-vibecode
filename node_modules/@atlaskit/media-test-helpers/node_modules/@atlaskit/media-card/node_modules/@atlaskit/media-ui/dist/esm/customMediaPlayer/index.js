...
var CustomMediaPlayer = /** @class */ (function (_super) {
    ...
    function CustomMediaPlayer() {
        ...
        _this.renderFullScreenButton = function () {
            ...
            return (React.createElement(MediaButton, { "data-testid": "custom-media-player-fullscreen-button", appearance: toolbar, onClick: _this.onFullScreenClick, iconBefore: icon }));
        };
    ...
    CustomMediaPlayer.prototype.render = function () {
        ...
        return (React.createElement(CustomVideoWrapper, { innerRef: this.saveVideoWrapperRef, "data-testid": "custom-media-player" },
            React.createElement(MediaPlayer, { sourceType: type, src: src, autoPlay: isAutoPlay, onCanPlay: onCanPlay, onError: onError }, function (video, videoState, actions) {
                ...
                var button = (React.createElement(MediaButton, { testId: "custom-media-player-play-toggle-button", "data-test-is-playing": isPlaying, appearance: toolbar, iconBefore: toggleButtonIcon, onClick: toggleButtonAction }));
                ...
                return (React.createElement(VideoWrapper, null,
                    ...
                    shortcuts,
                    React.createElement(WidthObserver, { setWidth: _this.onResize }),
