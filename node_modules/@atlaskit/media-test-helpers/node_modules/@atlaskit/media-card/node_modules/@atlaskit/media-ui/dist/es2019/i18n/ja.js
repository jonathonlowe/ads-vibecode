...
export default {
    ...
    'fabric.media.connect_link_account_card_view_description': '{context} をご使用のアトラシアン製品に接続して、リンクのプレビューを強化します。',
    ...
    'fabric.media.couldnt_load_link': '何らかの理由によって、このリンクを読み込めませんでした。',
    ...
    'fabric.media.not_found_description': 'URL を確認して編集するか、もう一度貼り付けてください。',
