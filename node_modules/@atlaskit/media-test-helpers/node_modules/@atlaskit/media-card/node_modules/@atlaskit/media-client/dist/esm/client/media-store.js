...
var extendImageParams = function (params, fetchMaxRes) {
    ...
    return __assign(__assign(__assign({}, defaultImageOptions), params), (fetchMaxRes ? { width: MAX_RESOLUTION, height: MAX_RESOLUTION } : {}));
};
var jsonHeaders = {
...
var MediaStore = /** @class */ (function () {
    function MediaStore(config) {
        ...
        this.getFileImageURL = function (id, params) { return __awaiter(_this, void 0, void 0, function () {
            var auth;
        ...
        this.getArtifactURL = function (artifacts, artifactName, collectionName) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.getImage = function (id, params, controller, fetchMaxRes) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.request("/collection/" + collectionName + "/items", {
                            authContext: { collectionName: collectionName },
                            params: __assign(__assign({}, defaultGetCollectionItems), params),
                            headers: {
                                Accept: 'application/json',
                            },
                        })];
    ...
    MediaStore.prototype.getFileBinaryURL = function (id, collectionName) {
        return __awaiter(this, void 0, void 0, function () {
            var auth;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MediaStore.prototype.request = function (path, options, controller) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var authProvider, method, authContext, params, headers, body, auth, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        auth = _a.sent();
                        return [4 /*yield*/, request("" + auth.baseUrl + path, {
                                method: method,
                                auth: auth,
                                params: params,
                                headers: headers,
