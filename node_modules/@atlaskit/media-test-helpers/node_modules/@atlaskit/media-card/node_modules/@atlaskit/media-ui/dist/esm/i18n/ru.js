...
export default {
    ...
    'fabric.media.connect_link_account_card_view_description': 'Добавьте возможность предварительного просмотра ссылок, подключив {context} к своим продуктам Atlassian.',
    ...
    'fabric.media.couldnt_load_link': 'По какой-то причине не удалось загрузить эту ссылку.',
    ...
    'fabric.media.not_found_description': 'Проверьте URL-адрес и попробуйте изменить или вставить еще раз.',
