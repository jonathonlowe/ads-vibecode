...
var processFetchResponse = function (response) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var text;
...
exports.isAbortedRequestError = function (e) {
...
function promiseRetry(functionToRetry, overwriteOptions) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = tslib_1.__assign(tslib_1.__assign({}, DEFAULT_OPTIONS), overwriteOptions);
                    timeoutInMs = options.startTimeoutInMs;
                    waitAndBumpTimeout = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (exports.isAbortedRequestError(err_1)) {
                    ...
                    return [2 /*return*/, Promise.reject(new Error("The call did not succeed after " + i + " attempts. Last error is " + err_1.message))];
