...
var TimeRange = /** @class */ (function (_super) {
    ...
    TimeRange.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.TimeRangeWrapper, { showAsActive: isAlwaysActive, onMouseDown: this.onThumbMouseDown },
            react_1.default.createElement(styled_1.TimeLine, { innerRef: this.saveWrapperElement },
                react_1.default.createElement(styled_1.BufferedTime, { style: { width: bufferedTimePercentage + "%" } }),
                react_1.default.createElement(styled_1.CurrentTimeLine, { style: { width: currentPosition + "%" } },
                    react_1.default.createElement(styled_1.Thumb, { innerRef: this.saveThumbElement }, disableThumbTooltip ? null : (react_1.default.createElement(styled_1.CurrentTimeTooltip, { draggable: false, isDragging: isDragging, className: "current-time-tooltip" }, formatDuration_1.formatDuration(currentTime))))))));
    };
