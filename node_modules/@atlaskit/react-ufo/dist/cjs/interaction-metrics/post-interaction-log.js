...
var PostInteractionLog = exports.default = /*#__PURE__*/function () {
  function PostInteractionLog() {
    (0, _classCallCheck2.default)(this, PostInteractionLog);
    /**
     * Basic info about interaction that has just finished
     */
    (0, _defineProperty2.default)(this, "lastInteractionFinish", null);
    /**
     * Array of observed react render timings
     */
    (0, _defineProperty2.default)(this, "reactProfilerTimings", []);
    /**
    ...
    (0, _defineProperty2.default)(this, "vcObserverSSRConfig", null);
    /**
     * Handler function to process / send the observation data
     */
    (0, _defineProperty2.default)(this, "sinkHandlerFn", function () {});
    this.initializeVCObserver = (0, _selfMeasurements.withProfiling)(this.initializeVCObserver.bind(this));
    this.startVCObserver = (0, _selfMeasurements.withProfiling)(this.startVCObserver.bind(this));
    this.setVCObserverSSRConfig = (0, _selfMeasurements.withProfiling)(this.setVCObserverSSRConfig.bind(this));
    this.setLastInteractionFinishVCResult = (0, _selfMeasurements.withProfiling)(this.setLastInteractionFinishVCResult.bind(this));
    this.reset = (0, _selfMeasurements.withProfiling)(this.reset.bind(this));
    this.hasData = (0, _selfMeasurements.withProfiling)(this.hasData.bind(this));
    this.sendPostInteractionLog = (0, _selfMeasurements.withProfiling)(this.sendPostInteractionLog.bind(this));
    this.onInteractionComplete = (0, _selfMeasurements.withProfiling)(this.onInteractionComplete.bind(this));
    this.addProfilerTimings = (0, _selfMeasurements.withProfiling)(this.addProfilerTimings.bind(this));
  }
