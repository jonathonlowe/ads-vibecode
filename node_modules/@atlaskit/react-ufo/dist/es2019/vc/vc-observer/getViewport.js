...
export const getViewportWidth = withProfiling(function getViewportWidth(document = window.document) {
  let documentWidth;
  try {
...
export const getViewportHeight = withProfiling(function getViewportHeight(document = window.document) {
  let documentHeight;
  try {
