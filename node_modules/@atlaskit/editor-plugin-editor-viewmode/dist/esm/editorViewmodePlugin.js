...
var gracefulEditCreatePMPlugin = function gracefulEditCreatePMPlugin(_ref3) {
  ...
  var viewModeIntentToEdit = unstable_editorExperimentParam('live_pages_graceful_edit', 'view-mode-intent-to-edit', {
    defaultValue: false,
  ...
  return new SafePlugin({
    ...
    props: {
      ...
      handleClick: function handleClick(view, pos, event) {
        ...
        var delayMs = !editorExperiment('live_pages_graceful_edit', 'text-click-no-delay') && unstable_editorExperimentParam('live_pages_graceful_edit', 'delay', {
          defaultValue: 200,
          typeGuard: function typeGuard(value) {
...
function checkIntentToEdit(view, pos, event) {
  var viewModeIntentMode = unstable_editorExperimentParam('live_pages_graceful_edit', 'intent-mode', {
    defaultValue: 'text',
    typeGuard: function typeGuard(value) {
...
export var editorViewModeWithGracefulEditPlugin = function editorViewModeWithGracefulEditPlugin(_ref4) {
 ...
 */
export var editorViewModePlugin = function editorViewModePlugin(_ref7) {
