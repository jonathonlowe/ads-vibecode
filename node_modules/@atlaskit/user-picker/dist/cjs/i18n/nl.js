...
var _default = exports.default = {
  ...
  'fabric.elements.user-picker.email.select.to.add': 'Selecteer een e-mailadres',
  'fabric.elements.user-picker.error.message': 'Er is iets misgegaan',
  'fabric.elements.user-picker.external.sourced.error': 'We kunnen geen verbinding maken.',
  ...
  'fabric.elements.user-picker.placeholder.add-more': 'meer gebruikers toevoegen...',
  ...
  'fabric.elements.user-picker.source.other-atlassian': 'Andere Atlassian-producten',
  'fabric.elements.user-picker.team.member.50plus': 'Team • 50+ leden',
  'fabric.elements.user-picker.team.member.50plus.including.you': 'Team • 50+ leden, inclusief jezelf.',
  'fabric.elements.user-picker.team.member.count': '{count, plural, one {Team • {count} lid} other {Team • {count} leden}}',
  'fabric.elements.user-picker.team.member.count.including.you': '{count, plural, one {Team • {count} lid, inclusief jezelf} other {Team •{count} leden, inclusief jezelf}}'
};