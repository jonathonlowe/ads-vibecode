...
export default {
  ...
  'fabric.elements.user-picker.source.other-atlassian': 'Muut Atlassian-tuotteet',
  'fabric.elements.user-picker.team.member.50plus': 'Tiimi • 50+ jäsentä',
  'fabric.elements.user-picker.team.member.50plus.including.you': 'Tiimi • 50+ jäsentä sinä mukaan lukien',
  'fabric.elements.user-picker.team.member.count': '{count, plural, one {Tiimi • {count} jäsen} other {Tiimi • {count} jäsentä}}',
  'fabric.elements.user-picker.team.member.count.including.you': '{count, plural, one {Tiimi • {count} jäsen sinä mukaan lukien} other {Tiimi • {count} jäsentä sinä mukaan lukien}}'
};