...
export { isLoaderError, lazyForPaint, lazyAfterPaint, lazy, PRIORITY, } from './lazy';
export type { ClientLoader, LazyComponent, LazyOptions, Loader, ServerLoader, } from './lazy';
