...
<head>
    <title>Code coverage report for FundamentalType.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> FundamentalType.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        return this.typeKind;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    public get reference(): ReferenceKind {</span>
<span class="cstat-no" title="statement not covered" >        return this.referenceKind;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
&nbsp;</pre></td></tr></table></pre>
