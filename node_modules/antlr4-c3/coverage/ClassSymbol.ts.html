...
<head>
    <title>Code coverage report for ClassSymbol.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> ClassSymbol.ts</h1>
        <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >    public get kind(): TypeKind { return TypeKind.Class; }</span>
&nbsp;
    /**
