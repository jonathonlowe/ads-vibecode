...
<head>
    <title>Code coverage report for BaseSymbol.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> BaseSymbol.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">91.89% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>238/259</span>
            </div>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">76924x</span>
<span class="cline-any cline-yes">76924x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">22169x</span>
<span class="cline-any cline-yes">22169x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">96336x</span>
<span class="cline-any cline-yes">22616x</span>
<span class="cline-any cline-yes">22616x</span>
<span class="cline-any cline-yes">73720x</span>
<span class="cline-any cline-yes">73720x</span>
<span class="cline-any cline-yes">96336x</span>
<span class="cline-any cline-yes">95779x</span>
<span class="cline-any cline-yes">73720x</span>
<span class="cline-any cline-yes">73720x</span>
<span class="cline-any cline-yes">22059x</span>
<span class="cline-any cline-yes">22059x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">115754x</span>
<span class="cline-any cline-yes">115754x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">192118x</span>
<span class="cline-any cline-yes">192118x</span>
<span class="cline-any cline-yes">1x</span>
...
&nbsp;
        return this.#parent<span class="branch-0 cbranch-no" title="branch not covered" >?.f</span>irstChild;
    }
&nbsp;
    /**
...
&nbsp;
    ...
    public get nextSibling(): BaseSymbol | undefined {
        return this.#parent<span class="branch-0 cbranch-no" title="branch not covered" >?.n</span>extSiblingOf(this);
    }
&nbsp;
    public get lastSibling(): BaseSymbol | undefined {
        return this.#parent<span class="branch-0 cbranch-no" title="branch not covered" >?.l</span>astChild;
    }
&nbsp;
    /**
    ...
    public get next(): BaseSymbol | undefined {
        return this.#parent<span class="branch-0 cbranch-no" title="branch not covered" >?.n</span>extOf(this);
    }
&nbsp;
    /**
...
&nbsp;
     ...
     */
    public async <span class="fstat-no" title="function not covered" >resolve(name: string, localOnly = false): Promise&lt;BaseSymbol | undefined&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return this.#parent?.resolve(name, localOnly);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
    /**
     ...
     *          or any of the parent scopes (conditionally).
     */
    public <span class="fstat-no" title="function not covered" >resolveSync(name: string, localOnly = false): BaseSymbol | undefined {</span>
<span class="cstat-no" title="statement not covered" >        return this.#parent?.resolveSync(name, localOnly);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
    /**
...
&nbsp;
    ...
    public qualifiedName(separator = ".", full = false, includeAnonymous = false): string {
        if (!includeAnonymous &amp;&amp; this.name.length === 0) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            return "";</span>
<span class="cstat-no" title="statement not covered" >        }</span>
&nbsp;
        let result: string = this.name.length === 0 <span class="branch-0 cbranch-no" title="branch not covered" >? "&lt;anonymous&gt;" </span>: this.name;
        let run = this.#parent;
        while (run) {
            if (includeAnonymous || run.name.length &gt; 0) {
                result = (run.name.length === 0 <span class="branch-0 cbranch-no" title="branch not covered" >? "&lt;anonymous&gt;" </span>: run.name) + separator + result;
            }
&nbsp;
            if (!full || !run.parent) {
                break;
