...
<head>
    <title>Code coverage report for SymbolTable.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> SymbolTable.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">68.85% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>241/350</span>
            </div>
...
<a name='L351'></a><a href='#L351'>351</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">96338x</span>
<span class="cline-any cline-yes">96338x</span>
<span class="cline-any cline-yes">96338x</span>
<span class="cline-any cline-yes">96338x</span>
<span class="cline-any cline-yes">96338x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">76914x</span>
<span class="cline-any cline-yes">76914x</span>
<span class="cline-any cline-yes">76914x</span>
<span class="cline-any cline-yes">76914x</span>
<span class="cline-any cline-yes">76914x</span>
<span class="cline-any cline-yes">22615x</span>
<span class="cline-any cline-yes">76914x</span>
<span class="cline-any cline-yes">54299x</span>
<span class="cline-any cline-yes">54299x</span>
<span class="cline-any cline-yes">76913x</span>
<span class="cline-any cline-yes">76913x</span>
<span class="cline-any cline-yes">76913x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
...
&nbsp;
    public override <span class="fstat-no" title="function not covered" >clear(): void {</span>
<span class="cstat-no" title="statement not covered" >        super.clear();</span>
<span class="cstat-no" title="statement not covered" >        this.dependencies.clear();</span>
...
&nbsp;
    public <span class="fstat-no" title="function not covered" >removeDependency(table: SymbolTable): void {</span>
<span class="cstat-no" title="statement not covered" >        if (this.dependencies.has(table)) {</span>
<span class="cstat-no" title="statement not covered" >            this.dependencies.delete(table);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
&nbsp;
    public async addNewNamespaceFromPath(parent: ScopedSymbol | undefined, path: string,
        ...
        let i = 0;
        let currentParent = (parent === undefined) ? this <span class="branch-0 cbranch-no" title="branch not covered" >: parent;</span>
...
&nbsp;
    public <span class="fstat-no" title="function not covered" >addNewNamespaceFromPathSync(parent: ScopedSymbol | undefined, path: string,</span>
<span class="cstat-no" title="statement not covered" >        delimiter = "."): NamespaceSymbol {</span>
<span class="cstat-no" title="statement not covered" >        const parts = path.split(delimiter);</span>
<span class="cstat-no" title="statement not covered" >        let i = 0;</span>
<span class="cstat-no" title="statement not covered" >        let currentParent = (parent === undefined) ? this : parent;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        while (i &lt; parts.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >            let namespace = currentParent.resolveSync(parts[i], true) as NamespaceSymbol;</span>
<span class="cstat-no" title="statement not covered" >            if (namespace === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                namespace = this.addNewSymbolOfType(NamespaceSymbol, currentParent, parts[i]);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            currentParent = namespace;</span>
<span class="cstat-no" title="statement not covered" >            ++i;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        return this.addNewSymbolOfType(NamespaceSymbol, currentParent, parts[parts.length - 1]);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
&nbsp;
    public override <span class="fstat-no" title="function not covered" >getAllSymbolsSync&lt;T extends BaseSymbol&gt;(t: SymbolConstructor&lt;T&gt;, localOnly = false): T[] {</span>
<span class="cstat-no" title="statement not covered" >        const result: T[] = super.getAllSymbolsSync(t, localOnly);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        if (!localOnly) {</span>
<span class="cstat-no" title="statement not covered" >            this.dependencies.forEach((dependency) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                result.push(...dependency.getAllSymbolsSync(t, localOnly));</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" ></span>
...
<span class="cstat-no" title="statement not covered" >        for (const dependency of this.dependencies) {</span>
<span class="cstat-no" title="statement not covered" >            symbols = await dependency.getAllSymbols(BaseSymbol);</span>
<span class="cstat-no" title="statement not covered" >            for (const symbol of symbols) {</span>
<span class="cstat-no" title="statement not covered" >                const result = findRecursive(symbol);</span>
...
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
    public <span class="fstat-no" title="function not covered" >symbolWithContextSync(context: ParseTree): BaseSymbol | undefined {</span>
<span class="cstat-no" title="statement not covered" >        /**</span>
<span class="cstat-no" title="statement not covered" >         * Local function to find a symbol recursively.</span>
<span class="cstat-no" title="statement not covered" >         *</span>
<span class="cstat-no" title="statement not covered" >         * @param symbol The symbol to search through.</span>
<span class="cstat-no" title="statement not covered" >         *</span>
<span class="cstat-no" title="statement not covered" >         * @returns The symbol with the given context, if found.</span>
<span class="cstat-no" title="statement not covered" >         */</span>
<span class="cstat-no" title="statement not covered" >        const findRecursive = (symbol: BaseSymbol): BaseSymbol | undefined =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (symbol.context === context) {</span>
<span class="cstat-no" title="statement not covered" >                return symbol;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            if (symbol instanceof ScopedSymbol) {</span>
<span class="cstat-no" title="statement not covered" >                for (const child of symbol.children) {</span>
<span class="cstat-no" title="statement not covered" >                    const result = findRecursive(child);</span>
<span class="cstat-no" title="statement not covered" >                    if (result) {</span>
<span class="cstat-no" title="statement not covered" >                        return result;</span>
<span class="cstat-no" title="statement not covered" >                    }</span>
<span class="cstat-no" title="statement not covered" >                }</span>
...
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        let symbols = this.getAllSymbolsSync(BaseSymbol);</span>
<span class="cstat-no" title="statement not covered" >        for (const symbol of symbols) {</span>
<span class="cstat-no" title="statement not covered" >            const result = findRecursive(symbol);</span>
<span class="cstat-no" title="statement not covered" >            if (result) {</span>
<span class="cstat-no" title="statement not covered" >                return result;</span>
...
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        for (const dependency of this.dependencies) {</span>
<span class="cstat-no" title="statement not covered" >            symbols = dependency.getAllSymbolsSync(BaseSymbol);</span>
<span class="cstat-no" title="statement not covered" >            for (const symbol of symbols) {</span>
<span class="cstat-no" title="statement not covered" >                const result = findRecursive(symbol);</span>
<span class="cstat-no" title="statement not covered" >                if (result) {</span>
<span class="cstat-no" title="statement not covered" >                    return result;</span>
...
&nbsp;
    public override async resolve(name: string, localOnly = false): Promise&lt;BaseSymbol | undefined&gt; {
        ...
        if (!result<span class="branch-0 cbranch-no" title="branch not covered" > &amp;&amp; !localOnly)</span> <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            for (const dependency of this.dependencies) {</span>
<span class="cstat-no" title="statement not covered" >                result = await dependency.resolve(name, false);</span>
<span class="cstat-no" title="statement not covered" >                if (result) {</span>
<span class="cstat-no" title="statement not covered" >                    return result;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
...
<span class="cstat-no" title="statement not covered" >        let result = super.resolveSync(name, localOnly);</span>
<span class="cstat-no" title="statement not covered" >        if (!result &amp;&amp; !localOnly) {</span>
<span class="cstat-no" title="statement not covered" >            for (const dependency of this.dependencies) {</span>
<span class="cstat-no" title="statement not covered" >                result = dependency.resolveSync(name, false);</span>
<span class="cstat-no" title="statement not covered" >                if (result) {</span>
<span class="cstat-no" title="statement not covered" >                    return result;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
