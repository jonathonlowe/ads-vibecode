        ...
        _this.renderTracks = function (kind) {
            ...
            if (textTracks && Array.isArray((_a = textTracks[kind]) === null || _a === void 0 ? void 0 : _a.tracks)) {
                ...
                return (React.createElement(React.Fragment, null, tracks === null || tracks === void 0 ? void 0 : tracks.map(function (_a, index) {
                    ...
                    return (React.createElement("track", { key: index, id: text_1.getVideoTextTrackId(kind, lang), kind: kind, src: src, srcLang: lang, label: label, default: index === selectedIndex_1 }));
                })));
            }
            return null;
        };
    ...
    Object.defineProperty(Video.prototype, "videoState", {
        get: function () {
            ...
            return {
                ...
                currentActiveCues: function (kind, lang) { var _a, _b; return (_b = (_a = _this.videoRef.current) === null || _a === void 0 ? void 0 : _a.textTracks.getTrackById(text_1.getVideoTextTrackId(kind, lang))) === null || _b === void 0 ? void 0 : _b.activeCues; },
                volume: volume,
                status: status,
                duration: duration,
                buffered: buffered,
