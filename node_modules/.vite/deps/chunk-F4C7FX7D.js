...
var padding = {
  // 10px gutter
  default: "0 ".concat(gridSize2 + gridSize2 / 4, "px"),
  compact: "0 ".concat(gridSize2 + gridSize2 / 4, "px"),
  none: "0"
};
var singleIconPadding = {
  // 2px gutter
  compact: "0 ".concat(gridSize2 / 4, "px"),
  default: "0 ".concat(gridSize2 / 4, "px"),
  none: "0"
};
var verticalAlign = {
  default: "middle",
...
var innerMargin = {
  content: "0 ".concat(gridSize2 / 4, "px"),
  icon: "0 ".concat(gridSize2 / 4, "px")
};
...
var getIfVisuallyHiddenChildren = function getIfVisuallyHiddenChildren2(children) {
  return children && (0, import_react3.isValidElement)(children) && children.type === visually_hidden_default;
};
...
var ButtonBase = import_react4.default.forwardRef(function ButtonBase2(props, ref) {
  ...
  var ourRef = (0, import_react4.useRef)();
  var setRef = (0, import_react4.useCallback)(function(node) {
    ourRef.current = node;
    if (ref == null) {
      return;
    }
  ...
  var interactionContext = (0, import_react4.useContext)(esm_default);
  var handleClick = (0, import_react4.useCallback)(function(e, analyticsEvent) {
...
//# sourceMappingURL=chunk-F4C7FX7D.js.map
